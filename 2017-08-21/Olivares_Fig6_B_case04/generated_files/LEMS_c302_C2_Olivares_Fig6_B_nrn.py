...
Components:
    ...
    AS4_to_VD4_inh_syn (Type: gradedSynapse:  conductance=5.000000000000001E-11 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    VD4_to_VA4_exc_syn (Type: gradedSynapse:  conductance=8.000000000000001E-10 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_VD4_VB3_GABA_neuron_to_neuron_exc_syn_post[1]")
        ...
        h("a_VB3[0].soma { syn_NC_VD4_VB3_GABA_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_VD4[0].soma { syn_NC_VD4_VB3_GABA_silent_pre[0].weight = 2.0 }")
        h("a_VB3[0].soma { syn_NC_VD4_VB3_GABA_neuron_to_neuron_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_VD4_VB3_GABA_silent_pre[0].vpeer, a_VB3[0].soma.v(0.500000)")
        h("setpointer syn_NC_VD4_VB3_GABA_neuron_to_neuron_exc_syn_post[0].vpeer, a_VD4[0].soma.v(0.500000)")
