...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("a_AVBR[0].soma { syn_NC_AVBR_VB3_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 7.0 }")
        h("a_VB3[0].soma { syn_NC_AVBR_VB3_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 7.0 }")
        ...
        h("a_VB3[0].soma { syn_NC_VB3_AVBR_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 7.0 }")
        h("a_AVBR[0].soma { syn_NC_VB3_AVBR_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 7.0 }")
