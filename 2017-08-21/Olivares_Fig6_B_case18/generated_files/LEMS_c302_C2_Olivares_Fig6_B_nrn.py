...
Components:
    ...
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=1.6000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    ...
    AS4_to_VD4_inh_syn (Type: gradedSynapse:  conductance=9.0E-11 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
