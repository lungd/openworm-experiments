...
Components:
    ...
    VD4_to_VA4_exc_syn (Type: gradedSynapse:  conductance=1.005E-7 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
