...
Components:
    ...
    VD4_to_VB3_exc_syn (Type: gradedSynapse:  conductance=6.0E-10 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
