...
Components:
    ...
    neuron_to_neuron_inh_syn (Type: gradedSynapse:  conductance=2.9E-10 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_AS4_VD4_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_VD4[0].soma { syn_NC_AS4_VD4_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AS4_VD4_Acetylcholine_silent_pre[0].weight = 21.0 }")
        h("a_VD4[0].soma { syn_NC_AS4_VD4_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 21.0 }")
        h("setpointer syn_NC_AS4_VD4_Acetylcholine_silent_pre[0].vpeer, a_VD4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AS4_VD4_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_AS4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_VD4_VA4_GABA_neuron_to_neuron_exc_syn_post[1]")
        ...
        h("a_VA4[0].soma { syn_NC_VD4_VA4_GABA_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("setpointer syn_NC_VD4_VA4_GABA_silent_pre[0].vpeer, a_VA4[0].soma.v(0.500000)")
        h("setpointer syn_NC_VD4_VA4_GABA_neuron_to_neuron_exc_syn_post[0].vpeer, a_VD4[0].soma.v(0.500000)")
