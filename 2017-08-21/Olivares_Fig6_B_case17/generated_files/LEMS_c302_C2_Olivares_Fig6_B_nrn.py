...
Components:
    ...
    AVAL_to_DA3_elec_syn (Type: gapJunction:  conductance=3.5200000000000003E-12 (SI conductance))
    AVAL_to_VA4_elec_syn (Type: gapJunction:  conductance=3.5200000000000003E-12 (SI conductance))
    AVAR_to_DA3_elec_syn (Type: gapJunction:  conductance=3.5200000000000003E-12 (SI conductance))
    AVAR_to_VA4_elec_syn (Type: gapJunction:  conductance=3.5200000000000003E-12 (SI conductance))
    ...
    AVBR_to_VB3_elec_syn (Type: gapJunction:  conductance=3.0200000000000005E-12 (SI conductance))
    DA3_to_AVAL_elec_syn (Type: gapJunction:  conductance=3.5200000000000003E-12 (SI conductance))
    DA3_to_AVAR_elec_syn (Type: gapJunction:  conductance=3.5200000000000003E-12 (SI conductance))
    ...
    VA4_to_AVAL_elec_syn (Type: gapJunction:  conductance=3.5200000000000003E-12 (SI conductance))
    VA4_to_AVAR_elec_syn (Type: gapJunction:  conductance=3.5200000000000003E-12 (SI conductance))
    VB3_to_AVBR_elec_syn (Type: gapJunction:  conductance=3.0200000000000005E-12 (SI conductance))
    ...
    AVAL_to_VA4_exc_syn (Type: gradedSynapse:  conductance=1.0000000000000001E-11 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    AVAR_to_VA4_exc_syn (Type: gradedSynapse:  conductance=1.0000000000000001E-11 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    DA3_to_DB3_exc_syn (Type: gradedSynapse:  conductance=2.0E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=1.6000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.002 (SI voltage) erev=-0.07 (SI voltage))
    ...
    AS4_to_VD4_inh_syn (Type: gradedSynapse:  conductance=9.0E-11 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.04 (SI voltage))
    VD4_to_VA4_exc_syn (Type: gradedSynapse:  conductance=4.0000000000000007E-10 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    VD4_to_VB3_exc_syn (Type: gradedSynapse:  conductance=1.5000000000000002E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    stim_VD4_1 (Type: pulseGenerator:  delay=0.0 (SI time) duration=2.9 (SI time) amplitude=5.0E-12 (SI current))
    c302_C2_Olivares_Fig6_B (Type: network)
    sim_c302_C2_Olivares_Fig6_B (Type: Simulation:  length=3.0 (SI time) step=5.0E-5 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        '''
        Adding simulation Component(id=sim_c302_C2_Olivares_Fig6_B type=Simulation) of network/component: c302_C2_Olivares_Fig6_B (Type: network)
        ...
        # ######################   Population: VA4
        print("Population VA4 contains 1 instance(s) of component: GenericNeuronCell of type: cell")
        ...
        for i in range(int(h.n_VA4)):
            h("a_VA4[%i] = new GenericNeuronCell()"%i)
            h("access a_VA4[%i].soma"%i)

            self.next_global_id+=1

        h("{ a_VA4[0].position(-1.85, -119.500010000000003, -58.700000000000003) }")
        ...
        # ######################   Population: VB3
        print("Population VB3 contains 1 instance(s) of component: GenericNeuronCell of type: cell")
        ...
        for i in range(int(h.n_VB3)):
            h("a_VB3[%i] = new GenericNeuronCell()"%i)
            h("access a_VB3[%i].soma"%i)

            self.next_global_id+=1

        h("{ a_VB3[0].position(-1.85, -210.224999999999994, -8.725) }")
        ...
        # ######################   Population: VD4
        print("Population VD4 contains 1 instance(s) of component: GenericNeuronCell of type: cell")
        ...
        for i in range(int(h.n_VD4)):
            h("a_VD4[%i] = new GenericNeuronCell()"%i)
            h("access a_VD4[%i].soma"%i)

            self.next_global_id+=1

        h("{ a_VD4[0].position(-0.8, -137.199999999999989, -52.700000000000003) }")
        ...
        h("objectvar syn_NC_AVAL_VA4_Generic_GJ_AVAL_to_VA4_elec_syn_A[1]")
        h("objectvar syn_NC_AVAL_VA4_Generic_GJ_AVAL_to_VA4_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAL[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_VA4[0].soma], weight: 6.0
        h("a_AVAL[0].soma { syn_NC_AVAL_VA4_Generic_GJ_AVAL_to_VA4_elec_syn_A[0] = new AVAL_to_VA4_elec_syn(0.5) }")
        h("a_VA4[0].soma { syn_NC_AVAL_VA4_Generic_GJ_AVAL_to_VA4_elec_syn_B[0] = new AVAL_to_VA4_elec_syn(0.5) }")
        h("a_AVAL[0].soma { syn_NC_AVAL_VA4_Generic_GJ_AVAL_to_VA4_elec_syn_A[0].weight = 6.0 }")
        h("a_VA4[0].soma { syn_NC_AVAL_VA4_Generic_GJ_AVAL_to_VA4_elec_syn_B[0].weight = 6.0 }")
        h("setpointer syn_NC_AVAL_VA4_Generic_GJ_AVAL_to_VA4_elec_syn_A[0].vpeer, a_VA4[0].soma.v(0.5)")
        h("setpointer syn_NC_AVAL_VA4_Generic_GJ_AVAL_to_VA4_elec_syn_B[0].vpeer, a_AVAL[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_AVAR_VA4_Generic_GJ_AVAR_to_VA4_elec_syn_A[1]")
        h("objectvar syn_NC_AVAR_VA4_Generic_GJ_AVAR_to_VA4_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_VA4[0].soma], weight: 3.0
        h("a_AVAR[0].soma { syn_NC_AVAR_VA4_Generic_GJ_AVAR_to_VA4_elec_syn_A[0] = new AVAR_to_VA4_elec_syn(0.5) }")
        h("a_VA4[0].soma { syn_NC_AVAR_VA4_Generic_GJ_AVAR_to_VA4_elec_syn_B[0] = new AVAR_to_VA4_elec_syn(0.5) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_VA4_Generic_GJ_AVAR_to_VA4_elec_syn_A[0].weight = 3.0 }")
        h("a_VA4[0].soma { syn_NC_AVAR_VA4_Generic_GJ_AVAR_to_VA4_elec_syn_B[0].weight = 3.0 }")
        h("setpointer syn_NC_AVAR_VA4_Generic_GJ_AVAR_to_VA4_elec_syn_A[0].vpeer, a_VA4[0].soma.v(0.5)")
        h("setpointer syn_NC_AVAR_VA4_Generic_GJ_AVAR_to_VA4_elec_syn_B[0].vpeer, a_AVAR[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_AVBR_VB3_Generic_GJ_AVBR_to_VB3_elec_syn_A[1]")
        h("objectvar syn_NC_AVBR_VB3_Generic_GJ_AVBR_to_VB3_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVBR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_VB3[0].soma], weight: 7.0
        h("a_AVBR[0].soma { syn_NC_AVBR_VB3_Generic_GJ_AVBR_to_VB3_elec_syn_A[0] = new AVBR_to_VB3_elec_syn(0.5) }")
        h("a_VB3[0].soma { syn_NC_AVBR_VB3_Generic_GJ_AVBR_to_VB3_elec_syn_B[0] = new AVBR_to_VB3_elec_syn(0.5) }")
        h("a_AVBR[0].soma { syn_NC_AVBR_VB3_Generic_GJ_AVBR_to_VB3_elec_syn_A[0].weight = 7.0 }")
        h("a_VB3[0].soma { syn_NC_AVBR_VB3_Generic_GJ_AVBR_to_VB3_elec_syn_B[0].weight = 7.0 }")
        h("setpointer syn_NC_AVBR_VB3_Generic_GJ_AVBR_to_VB3_elec_syn_A[0].vpeer, a_VB3[0].soma.v(0.5)")
        h("setpointer syn_NC_AVBR_VB3_Generic_GJ_AVBR_to_VB3_elec_syn_B[0].vpeer, a_AVBR[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_VA4_AVAL_Generic_GJ_VA4_to_AVAL_elec_syn_A[1]")
        h("objectvar syn_NC_VA4_AVAL_Generic_GJ_VA4_to_AVAL_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_VA4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AVAL[0].soma], weight: 6.0
        h("a_VA4[0].soma { syn_NC_VA4_AVAL_Generic_GJ_VA4_to_AVAL_elec_syn_A[0] = new VA4_to_AVAL_elec_syn(0.5) }")
        h("a_AVAL[0].soma { syn_NC_VA4_AVAL_Generic_GJ_VA4_to_AVAL_elec_syn_B[0] = new VA4_to_AVAL_elec_syn(0.5) }")
        h("a_VA4[0].soma { syn_NC_VA4_AVAL_Generic_GJ_VA4_to_AVAL_elec_syn_A[0].weight = 6.0 }")
        h("a_AVAL[0].soma { syn_NC_VA4_AVAL_Generic_GJ_VA4_to_AVAL_elec_syn_B[0].weight = 6.0 }")
        h("setpointer syn_NC_VA4_AVAL_Generic_GJ_VA4_to_AVAL_elec_syn_A[0].vpeer, a_AVAL[0].soma.v(0.5)")
        h("setpointer syn_NC_VA4_AVAL_Generic_GJ_VA4_to_AVAL_elec_syn_B[0].vpeer, a_VA4[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_VA4_AVAR_Generic_GJ_VA4_to_AVAR_elec_syn_A[1]")
        h("objectvar syn_NC_VA4_AVAR_Generic_GJ_VA4_to_AVAR_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_VA4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AVAR[0].soma], weight: 3.0
        h("a_VA4[0].soma { syn_NC_VA4_AVAR_Generic_GJ_VA4_to_AVAR_elec_syn_A[0] = new VA4_to_AVAR_elec_syn(0.5) }")
        h("a_AVAR[0].soma { syn_NC_VA4_AVAR_Generic_GJ_VA4_to_AVAR_elec_syn_B[0] = new VA4_to_AVAR_elec_syn(0.5) }")
        h("a_VA4[0].soma { syn_NC_VA4_AVAR_Generic_GJ_VA4_to_AVAR_elec_syn_A[0].weight = 3.0 }")
        h("a_AVAR[0].soma { syn_NC_VA4_AVAR_Generic_GJ_VA4_to_AVAR_elec_syn_B[0].weight = 3.0 }")
        h("setpointer syn_NC_VA4_AVAR_Generic_GJ_VA4_to_AVAR_elec_syn_A[0].vpeer, a_AVAR[0].soma.v(0.5)")
        h("setpointer syn_NC_VA4_AVAR_Generic_GJ_VA4_to_AVAR_elec_syn_B[0].vpeer, a_VA4[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_VB3_AVBR_Generic_GJ_VB3_to_AVBR_elec_syn_A[1]")
        h("objectvar syn_NC_VB3_AVBR_Generic_GJ_VB3_to_AVBR_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_VB3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AVBR[0].soma], weight: 7.0
        h("a_VB3[0].soma { syn_NC_VB3_AVBR_Generic_GJ_VB3_to_AVBR_elec_syn_A[0] = new VB3_to_AVBR_elec_syn(0.5) }")
        h("a_AVBR[0].soma { syn_NC_VB3_AVBR_Generic_GJ_VB3_to_AVBR_elec_syn_B[0] = new VB3_to_AVBR_elec_syn(0.5) }")
        h("a_VB3[0].soma { syn_NC_VB3_AVBR_Generic_GJ_VB3_to_AVBR_elec_syn_A[0].weight = 7.0 }")
        h("a_AVBR[0].soma { syn_NC_VB3_AVBR_Generic_GJ_VB3_to_AVBR_elec_syn_B[0].weight = 7.0 }")
        h("setpointer syn_NC_VB3_AVBR_Generic_GJ_VB3_to_AVBR_elec_syn_A[0].vpeer, a_AVBR[0].soma.v(0.5)")
        h("setpointer syn_NC_VB3_AVBR_Generic_GJ_VB3_to_AVBR_elec_syn_B[0].vpeer, a_VB3[0].soma.v(0.5)")
        ...
        # ######################   Continuous Projection: NC_AVAL_VA4_Acetylcholine
        print("Adding continuous projection: NC_AVAL_VA4_Acetylcholine from AVAL to VA4, with 1 connection(s)")

        h("objectvar syn_NC_AVAL_VA4_Acetylcholine_silent_pre[1]")
        h("objectvar syn_NC_AVAL_VA4_Acetylcholine_AVAL_to_VA4_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAL[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_VA4[0].soma], weight: 7.0
        h("a_AVAL[0].soma { syn_NC_AVAL_VA4_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_VA4[0].soma { syn_NC_AVAL_VA4_Acetylcholine_AVAL_to_VA4_exc_syn_post[0] = new AVAL_to_VA4_exc_syn(0.500000) }")
        h("a_AVAL[0].soma { syn_NC_AVAL_VA4_Acetylcholine_silent_pre[0].weight = 7.0 }")
        h("a_VA4[0].soma { syn_NC_AVAL_VA4_Acetylcholine_AVAL_to_VA4_exc_syn_post[0].weight = 7.0 }")
        h("setpointer syn_NC_AVAL_VA4_Acetylcholine_silent_pre[0].vpeer, a_VA4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAL_VA4_Acetylcholine_AVAL_to_VA4_exc_syn_post[0].vpeer, a_AVAL[0].soma.v(0.500000)")
        ...
        # ######################   Continuous Projection: NC_AVAR_VA4_Acetylcholine
        print("Adding continuous projection: NC_AVAR_VA4_Acetylcholine from AVAR to VA4, with 1 connection(s)")

        h("objectvar syn_NC_AVAR_VA4_Acetylcholine_silent_pre[1]")
        h("objectvar syn_NC_AVAR_VA4_Acetylcholine_AVAR_to_VA4_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_VA4[0].soma], weight: 6.0
        h("a_AVAR[0].soma { syn_NC_AVAR_VA4_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_VA4[0].soma { syn_NC_AVAR_VA4_Acetylcholine_AVAR_to_VA4_exc_syn_post[0] = new AVAR_to_VA4_exc_syn(0.500000) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_VA4_Acetylcholine_silent_pre[0].weight = 6.0 }")
        h("a_VA4[0].soma { syn_NC_AVAR_VA4_Acetylcholine_AVAR_to_VA4_exc_syn_post[0].weight = 6.0 }")
        h("setpointer syn_NC_AVAR_VA4_Acetylcholine_silent_pre[0].vpeer, a_VA4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAR_VA4_Acetylcholine_AVAR_to_VA4_exc_syn_post[0].vpeer, a_AVAR[0].soma.v(0.500000)")
        ...
        # ######################   Continuous Projection: NC_AS4_VD4_Acetylcholine
        print("Adding continuous projection: NC_AS4_VD4_Acetylcholine from AS4 to VD4, with 1 connection(s)")

        h("objectvar syn_NC_AS4_VD4_Acetylcholine_silent_pre[1]")
        h("objectvar syn_NC_AS4_VD4_Acetylcholine_AS4_to_VD4_inh_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_VD4[0].soma], weight: 21.0
        h("a_AS4[0].soma { syn_NC_AS4_VD4_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_VD4[0].soma { syn_NC_AS4_VD4_Acetylcholine_AS4_to_VD4_inh_syn_post[0] = new AS4_to_VD4_inh_syn(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AS4_VD4_Acetylcholine_silent_pre[0].weight = 21.0 }")
        h("a_VD4[0].soma { syn_NC_AS4_VD4_Acetylcholine_AS4_to_VD4_inh_syn_post[0].weight = 21.0 }")
        h("setpointer syn_NC_AS4_VD4_Acetylcholine_silent_pre[0].vpeer, a_VD4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AS4_VD4_Acetylcholine_AS4_to_VD4_inh_syn_post[0].vpeer, a_AS4[0].soma.v(0.500000)")

        # ######################   Continuous Projection: NC_VD4_VA4_GABA
        print("Adding continuous projection: NC_VD4_VA4_GABA from VD4 to VA4, with 1 connection(s)")

        h("objectvar syn_NC_VD4_VA4_GABA_silent_pre[1]")
        h("objectvar syn_NC_VD4_VA4_GABA_VD4_to_VA4_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_VD4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_VA4[0].soma], weight: 1.0
        h("a_VD4[0].soma { syn_NC_VD4_VA4_GABA_silent_pre[0] = new silent(0.500000) }")
        h("a_VA4[0].soma { syn_NC_VD4_VA4_GABA_VD4_to_VA4_exc_syn_post[0] = new VD4_to_VA4_exc_syn(0.500000) }")
        h("setpointer syn_NC_VD4_VA4_GABA_silent_pre[0].vpeer, a_VA4[0].soma.v(0.500000)")
        h("setpointer syn_NC_VD4_VA4_GABA_VD4_to_VA4_exc_syn_post[0].vpeer, a_VD4[0].soma.v(0.500000)")

        # ######################   Continuous Projection: NC_VD4_VB3_GABA
        print("Adding continuous projection: NC_VD4_VB3_GABA from VD4 to VB3, with 1 connection(s)")

        h("objectvar syn_NC_VD4_VB3_GABA_silent_pre[1]")
        h("objectvar syn_NC_VD4_VB3_GABA_VD4_to_VB3_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_VD4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_VB3[0].soma], weight: 2.0
        h("a_VD4[0].soma { syn_NC_VD4_VB3_GABA_silent_pre[0] = new silent(0.500000) }")
        h("a_VB3[0].soma { syn_NC_VD4_VB3_GABA_VD4_to_VB3_exc_syn_post[0] = new VD4_to_VB3_exc_syn(0.500000) }")
        h("a_VD4[0].soma { syn_NC_VD4_VB3_GABA_silent_pre[0].weight = 2.0 }")
        h("a_VB3[0].soma { syn_NC_VD4_VB3_GABA_VD4_to_VB3_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_VD4_VB3_GABA_silent_pre[0].vpeer, a_VB3[0].soma.v(0.500000)")
        h("setpointer syn_NC_VD4_VB3_GABA_VD4_to_VB3_exc_syn_post[0].vpeer, a_VD4[0].soma.v(0.500000)")
        ...
        # ######################   Input List: Input_VD4_stim_VD4_1
        print("Adding input list: Input_VD4_stim_VD4_1 to VD4, with 1 inputs of type stim_VD4_1")

        # Adding single input: Component(id=0 type=input)
        h("objref Input_VD4_stim_VD4_1_0")
        h("a_VD4[0].soma { Input_VD4_stim_VD4_1_0 = new stim_VD4_1(0.5) } ")
        ...
        # ######################   File to save: c302_C2_Olivares_Fig6_B.activity.dat (neurons_activity)
        ...
        # Column: VA4/0/GenericNeuronCell/caConc
        ...
        # Column: VB3/0/GenericNeuronCell/caConc
        ...
        # Column: VD4/0/GenericNeuronCell/caConc
        ...
        # ######################   File to save: c302_C2_Olivares_Fig6_B.dat (neurons_v)
        ...
        # Column: VA4/0/GenericNeuronCell/v
        ...
        # Column: VB3/0/GenericNeuronCell/v
        ...
        # Column: VD4/0/GenericNeuronCell/v
    ...
    def save_results(self):
        ...
        f_neurons_activity_f2 = open('c302_C2_Olivares_Fig6_B.activity.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...

        for i in range(num_points):
            f_neurons_activity_f2.write('%e\t'% py_v_time[i]  + '%e\t'%(py_v_AS4_v_neurons_activity[i])  + '%e\t'%(py_v_AVAL_v_neurons_activity[i])  + '%e\t'%(py_v_AVAR_v_neurons_activity[i])  + '%e\t'%(py_v_AVBL_v_neurons_activity[i])  + '%e\t'%(py_v_AVBR_v_neurons_activity[i])  + '%e\t'%(py_v_DA3_v_neurons_activity[i])  + '%e\t'%(py_v_DB3_v_neurons_activity[i])  + '%e\t'%(py_v_VA4_v_neurons_activity[i])  + '%e\t'%(py_v_VB3_v_neurons_activity[i])  + '%e\t'%(py_v_VD4_v_neurons_activity[i]) + '\n')
        f_neurons_activity_f2.close()
        print("Saved data to: c302_C2_Olivares_Fig6_B.activity.dat")
        ...
        f_neurons_v_f2 = open('c302_C2_Olivares_Fig6_B.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...

        for i in range(num_points):
            f_neurons_v_f2.write('%e\t'% py_v_time[i]  + '%e\t'%(py_v_AS4_v_neurons_v[i])  + '%e\t'%(py_v_AVAL_v_neurons_v[i])  + '%e\t'%(py_v_AVAR_v_neurons_v[i])  + '%e\t'%(py_v_AVBL_v_neurons_v[i])  + '%e\t'%(py_v_AVBR_v_neurons_v[i])  + '%e\t'%(py_v_DA3_v_neurons_v[i])  + '%e\t'%(py_v_DB3_v_neurons_v[i])  + '%e\t'%(py_v_VA4_v_neurons_v[i])  + '%e\t'%(py_v_VB3_v_neurons_v[i])  + '%e\t'%(py_v_VD4_v_neurons_v[i]) + '\n')
        f_neurons_v_f2.close()
        print("Saved data to: c302_C2_Olivares_Fig6_B.dat")
