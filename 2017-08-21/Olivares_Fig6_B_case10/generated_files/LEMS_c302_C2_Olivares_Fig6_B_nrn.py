...
Components:
    ...
    AVAL_to_VA4_elec_syn (Type: gapJunction:  conductance=5.2E-13 (SI conductance))
    AVAR_to_DA3_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    AVAR_to_VA4_elec_syn (Type: gapJunction:  conductance=5.2E-13 (SI conductance))
    ...
    VA4_to_AVAL_elec_syn (Type: gapJunction:  conductance=5.2E-13 (SI conductance))
    VA4_to_AVAR_elec_syn (Type: gapJunction:  conductance=5.2E-13 (SI conductance))
