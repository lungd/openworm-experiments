...
Components:
    ...
    AVAL_to_VA4_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    AVAR_to_DA3_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    AVAR_to_VA4_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    ...
    VA4_to_AVAL_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    VA4_to_AVAR_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    ...
    VD4_to_VA4_exc_syn (Type: gradedSynapse:  conductance=2.04E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
