...
Components:
    ...
    neuron_to_neuron_inh_syn_2conns (Type: gradedSynapse:  conductance=1.6399999999999998E-8 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
