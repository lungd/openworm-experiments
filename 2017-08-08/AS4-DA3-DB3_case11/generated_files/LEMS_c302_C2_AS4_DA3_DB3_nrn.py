...
Components:
    ...
    neuron_to_neuron_exc_syn_3conns (Type: gradedSynapse:  conductance=1.26E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_exc_syn_4conns (Type: gradedSynapse:  conductance=1.68E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    neuron_to_neuron_exc_syn_9conns (Type: gradedSynapse:  conductance=3.78E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_exc_syn_14conns (Type: gradedSynapse:  conductance=5.8800000000000004E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    neuron_to_neuron_exc_syn_10conns (Type: gradedSynapse:  conductance=4.2000000000000006E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    sim_c302_C2_AS4_DA3_DB3 (Type: Simulation:  length=0.5 (SI time) step=5.0E-5 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_DB3_AS4_Acetylcholine_neuron_to_neuron_exc_syn_2conns_post[1]")
        ...
        h("a_AS4[0].soma { syn_NC_DB3_AS4_Acetylcholine_neuron_to_neuron_exc_syn_2conns_post[0] = new neuron_to_neuron_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB3_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_AS4_Acetylcholine_neuron_to_neuron_exc_syn_2conns_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=500, dt=0.05, seed=123456789)
