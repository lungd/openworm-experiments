...
Components:
    ...
    neuron_to_neuron_elec_syn_0conns (Type: gapJunction:  conductance=0.0 (SI conductance))
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=1.9000000000000001 (SI time) amplitude=1.0E-11 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=1.9000000000000001 (SI time) amplitude=1.0E-11 (SI current))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_A[1]")
        h("objectvar syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAL[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma], weight: 1.0
        h("a_AVAL[0].soma { syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_A[0] = new neuron_to_neuron_elec_syn_0conns(0.5) }")
        h("a_DA3[0].soma { syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_B[0] = new neuron_to_neuron_elec_syn_0conns(0.5) }")
        h("setpointer syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_A[0].vpeer, a_DA3[0].soma.v(0.5)")
        h("setpointer syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_B[0].vpeer, a_AVAL[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_AVAR_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_A[1]")
        h("objectvar syn_NC_AVAR_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma], weight: 1.0
        h("a_AVAR[0].soma { syn_NC_AVAR_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_A[0] = new neuron_to_neuron_elec_syn_0conns(0.5) }")
        h("a_DA3[0].soma { syn_NC_AVAR_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_B[0] = new neuron_to_neuron_elec_syn_0conns(0.5) }")
        h("setpointer syn_NC_AVAR_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_A[0].vpeer, a_DA3[0].soma.v(0.5)")
        h("setpointer syn_NC_AVAR_DA3_Generic_GJ_neuron_to_neuron_elec_syn_0conns_B[0].vpeer, a_AVAR[0].soma.v(0.5)")
