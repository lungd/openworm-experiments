...
Components:
    ...
    DB2_to_MDL12_exc_syn (Type: gradedSynapse:  conductance=8.000000000000001E-11 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    stim_DB2_1 (Type: pulseGenerator:  delay=3.0 (SI time) duration=3.0 (SI time) amplitude=1.0E-12 (SI current))
    stim_DD2_1 (Type: pulseGenerator:  delay=6.5 (SI time) duration=3.0 (SI time) amplitude=2.0E-12 (SI current))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        # ######################   Input List: Input_DB2_stim_DB2_1
        print("Adding input list: Input_DB2_stim_DB2_1 to DB2, with 1 inputs of type stim_DB2_1")

        # Adding single input: Component(id=0 type=input)
        h("objref Input_DB2_stim_DB2_1_0")
        h("a_DB2[0].soma { Input_DB2_stim_DB2_1_0 = new stim_DB2_1(0.5) } ")

        # ######################   Input List: Input_DD2_stim_DD2_1
        print("Adding input list: Input_DD2_stim_DD2_1 to DD2, with 1 inputs of type stim_DD2_1")

        # Adding single input: Component(id=0 type=input)
        h("objref Input_DD2_stim_DD2_1_0")
        h("a_DD2[0].soma { Input_DD2_stim_DD2_1_0 = new stim_DD2_1(0.5) } ")
