...
Components:
    ...
    DB2_to_MDL12_exc_syn (Type: gradedSynapse2:  conductance=5.0E-9 (SI conductance) ar=0.5 (SI per_time) ad=50.0 (SI per_time) beta=1125.0 (SI per_voltage) vth=-0.025 (SI voltage) erev=0.01 (SI voltage))
    ...
    stim_DB2_1 (Type: pulseGenerator:  delay=3.0 (SI time) duration=3.0 (SI time) amplitude=5.0E-12 (SI current))
    c302_C2_BWM_Model (Type: network)
    sim_c302_C2_BWM_Model (Type: Simulation:  length=7.0 (SI time) step=5.0E-5 (SI time))
