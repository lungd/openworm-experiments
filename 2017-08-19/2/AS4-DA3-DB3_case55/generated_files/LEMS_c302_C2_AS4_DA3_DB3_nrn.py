...
Components:
    ...
    AVAL_to_DA3_exc_syn (Type: gradedSynapse:  conductance=7.000000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    AVAR_to_DA3_exc_syn (Type: gradedSynapse:  conductance=7.000000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
