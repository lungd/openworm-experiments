...
Components:
    ...
    AVAL_to_AS4_exc_syn (Type: gradedSynapse:  conductance=4.2E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    AVAR_to_AS4_exc_syn (Type: gradedSynapse:  conductance=4.2E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    AVBL_to_AVAL_inh_syn (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBL_to_AVAR_inh_syn (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBR_to_AVAL_inh_syn (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBR_to_AVAR_inh_syn (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    DA3_to_DB3_exc_syn (Type: gradedSynapse:  conductance=1.6000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    stim_AS4_1 (Type: pulseGenerator:  delay=0.0 (SI time) duration=2.9 (SI time) amplitude=6.0E-12 (SI current))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_AVAL_AS4_Acetylcholine_AVAL_to_AS4_exc_syn_post[1]")
        ...
        h("a_AS4[0].soma { syn_NC_AVAL_AS4_Acetylcholine_AVAL_to_AS4_exc_syn_post[0] = new AVAL_to_AS4_exc_syn(0.500000) }")
        h("a_AVAL[0].soma { syn_NC_AVAL_AS4_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_AS4[0].soma { syn_NC_AVAL_AS4_Acetylcholine_AVAL_to_AS4_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_AVAL_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAL_AS4_Acetylcholine_AVAL_to_AS4_exc_syn_post[0].vpeer, a_AVAL[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVAR_AS4_Acetylcholine_AVAR_to_AS4_exc_syn_post[1]")
        ...
        h("a_AS4[0].soma { syn_NC_AVAR_AS4_Acetylcholine_AVAR_to_AS4_exc_syn_post[0] = new AVAR_to_AS4_exc_syn(0.500000) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_AS4_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_AS4[0].soma { syn_NC_AVAR_AS4_Acetylcholine_AVAR_to_AS4_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_AVAR_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAR_AS4_Acetylcholine_AVAR_to_AS4_exc_syn_post[0].vpeer, a_AVAR[0].soma.v(0.500000)")
