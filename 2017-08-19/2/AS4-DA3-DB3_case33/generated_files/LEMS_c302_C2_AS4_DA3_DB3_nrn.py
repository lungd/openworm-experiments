...
Components:
    ...
    AVBL_to_AS4_inh_syn (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    ...
    AVBR_to_AS4_inh_syn (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_AVBL_AS4_Acetylcholine_AVBL_to_AS4_inh_syn_post[1]")
        ...
        h("a_AS4[0].soma { syn_NC_AVBL_AS4_Acetylcholine_AVBL_to_AS4_inh_syn_post[0] = new AVBL_to_AS4_inh_syn(0.500000) }")
        h("setpointer syn_NC_AVBL_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBL_AS4_Acetylcholine_AVBL_to_AS4_inh_syn_post[0].vpeer, a_AVBL[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBR_AS4_Acetylcholine_AVBR_to_AS4_inh_syn_post[1]")
        ...
        h("a_AS4[0].soma { syn_NC_AVBR_AS4_Acetylcholine_AVBR_to_AS4_inh_syn_post[0] = new AVBR_to_AS4_inh_syn(0.500000) }")
        h("setpointer syn_NC_AVBR_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBR_AS4_Acetylcholine_AVBR_to_AS4_inh_syn_post[0].vpeer, a_AVBR[0].soma.v(0.500000)")
