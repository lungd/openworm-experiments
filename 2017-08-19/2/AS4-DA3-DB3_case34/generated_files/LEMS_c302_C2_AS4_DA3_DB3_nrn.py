...
Components:
    ...
    AVAR_to_AVBL_elec_syn (Type: gapJunction:  conductance=5.2E-13 (SI conductance))
    AVAR_to_DA3_elec_syn (Type: gapJunction:  conductance=5.2E-13 (SI conductance))
    AVBL_to_AVAR_elec_syn (Type: gapJunction:  conductance=5.2E-13 (SI conductance))
    neuron_to_neuron_elec_syn (Type: gapJunction:  conductance=1.252E-11 (SI conductance))
    AS4_to_DA3_elec_syn (Type: gapJunction:  conductance=1.0520000000000001E-11 (SI conductance))
    muscle_to_muscle_elec_syn (Type: gapJunction:  conductance=0.0 (SI conductance))
    silent (Type: silentSynapse)
    AVAL_to_AVBL_inh_syn (Type: gradedSynapse:  conductance=4.700000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_exc_syn (Type: gradedSynapse:  conductance=5.2E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    AVAR_to_AVBL_inh_syn (Type: gradedSynapse:  conductance=4.700000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVAR_to_AVBR_inh_syn (Type: gradedSynapse:  conductance=4.700000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBL_to_AVAL_inh_syn (Type: gradedSynapse:  conductance=3.2000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBL_to_AVAR_inh_syn (Type: gradedSynapse:  conductance=3.2000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBL_to_AS4_exc_syn (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    AVBR_to_AVAL_inh_syn (Type: gradedSynapse:  conductance=3.2000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBR_to_AVAR_inh_syn (Type: gradedSynapse:  conductance=3.2000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBR_to_AS4_exc_syn (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    neuron_to_neuron_inh_syn (Type: gradedSynapse:  conductance=7.200000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AS4_to_DA3_exc_syn (Type: gradedSynapse:  conductance=3.0000000000000004E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    stim_AVAL_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=1.5E-12 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=1.5E-12 (SI current))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_AVAR_AVBL_Generic_GJ_AVAR_to_AVBL_elec_syn_A[1]")
        h("objectvar syn_NC_AVAR_AVBL_Generic_GJ_AVAR_to_AVBL_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AVBL[0].soma], weight: 3.0
        h("a_AVAR[0].soma { syn_NC_AVAR_AVBL_Generic_GJ_AVAR_to_AVBL_elec_syn_A[0] = new AVAR_to_AVBL_elec_syn(0.5) }")
        h("a_AVBL[0].soma { syn_NC_AVAR_AVBL_Generic_GJ_AVAR_to_AVBL_elec_syn_B[0] = new AVAR_to_AVBL_elec_syn(0.5) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_AVBL_Generic_GJ_AVAR_to_AVBL_elec_syn_A[0].weight = 3.0 }")
        h("a_AVBL[0].soma { syn_NC_AVAR_AVBL_Generic_GJ_AVAR_to_AVBL_elec_syn_B[0].weight = 3.0 }")
        h("setpointer syn_NC_AVAR_AVBL_Generic_GJ_AVAR_to_AVBL_elec_syn_A[0].vpeer, a_AVBL[0].soma.v(0.5)")
        h("setpointer syn_NC_AVAR_AVBL_Generic_GJ_AVAR_to_AVBL_elec_syn_B[0].vpeer, a_AVAR[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_AVBL_AVAR_Generic_GJ_AVBL_to_AVAR_elec_syn_A[1]")
        h("objectvar syn_NC_AVBL_AVAR_Generic_GJ_AVBL_to_AVAR_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVBL[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AVAR[0].soma], weight: 3.0
        h("a_AVBL[0].soma { syn_NC_AVBL_AVAR_Generic_GJ_AVBL_to_AVAR_elec_syn_A[0] = new AVBL_to_AVAR_elec_syn(0.5) }")
        h("a_AVAR[0].soma { syn_NC_AVBL_AVAR_Generic_GJ_AVBL_to_AVAR_elec_syn_B[0] = new AVBL_to_AVAR_elec_syn(0.5) }")
        h("a_AVBL[0].soma { syn_NC_AVBL_AVAR_Generic_GJ_AVBL_to_AVAR_elec_syn_A[0].weight = 3.0 }")
        h("a_AVAR[0].soma { syn_NC_AVBL_AVAR_Generic_GJ_AVBL_to_AVAR_elec_syn_B[0].weight = 3.0 }")
        h("setpointer syn_NC_AVBL_AVAR_Generic_GJ_AVBL_to_AVAR_elec_syn_A[0].vpeer, a_AVAR[0].soma.v(0.5)")
        h("setpointer syn_NC_AVBL_AVAR_Generic_GJ_AVBL_to_AVAR_elec_syn_B[0].vpeer, a_AVBL[0].soma.v(0.5)")
        ...
        h("a_AVBL[0].soma { syn_NC_AVBL_DB3_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 9.0 }")
        h("a_DB3[0].soma { syn_NC_AVBL_DB3_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 9.0 }")
        ...
        h("a_AVBR[0].soma { syn_NC_AVBR_DB3_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 2.0 }")
        h("a_DB3[0].soma { syn_NC_AVBR_DB3_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 2.0 }")
        ...
        h("objectvar syn_NC_DA3_AVAL_Generic_GJ_neuron_to_neuron_elec_syn_A[1]")
        h("objectvar syn_NC_DA3_AVAL_Generic_GJ_neuron_to_neuron_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AVAL[0].soma], weight: 6.0
        h("a_DA3[0].soma { syn_NC_DA3_AVAL_Generic_GJ_neuron_to_neuron_elec_syn_A[0] = new neuron_to_neuron_elec_syn(0.5) }")
        h("a_AVAL[0].soma { syn_NC_DA3_AVAL_Generic_GJ_neuron_to_neuron_elec_syn_B[0] = new neuron_to_neuron_elec_syn(0.5) }")
        h("a_DA3[0].soma { syn_NC_DA3_AVAL_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 6.0 }")
        h("a_AVAL[0].soma { syn_NC_DA3_AVAL_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 6.0 }")
        h("setpointer syn_NC_DA3_AVAL_Generic_GJ_neuron_to_neuron_elec_syn_A[0].vpeer, a_AVAL[0].soma.v(0.5)")
        h("setpointer syn_NC_DA3_AVAL_Generic_GJ_neuron_to_neuron_elec_syn_B[0].vpeer, a_DA3[0].soma.v(0.5)")
        ...
        h("a_DA3[0].soma { syn_NC_DA3_AVAR_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 7.0 }")
        h("a_AVAR[0].soma { syn_NC_DA3_AVAR_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 7.0 }")
        ...
        h("a_DB3[0].soma { syn_NC_DB3_AVBL_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 9.0 }")
        h("a_AVBL[0].soma { syn_NC_DB3_AVBL_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 9.0 }")
        ...
        h("a_DB3[0].soma { syn_NC_DB3_AVBR_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 2.0 }")
        h("a_AVBR[0].soma { syn_NC_DB3_AVBR_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 2.0 }")
        ...
        h("objectvar syn_NC_AS4_DA3_Generic_GJ_AS4_to_DA3_elec_syn_A[1]")
        h("objectvar syn_NC_AS4_DA3_Generic_GJ_AS4_to_DA3_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma], weight: 4.0
        h("a_AS4[0].soma { syn_NC_AS4_DA3_Generic_GJ_AS4_to_DA3_elec_syn_A[0] = new AS4_to_DA3_elec_syn(0.5) }")
        h("a_DA3[0].soma { syn_NC_AS4_DA3_Generic_GJ_AS4_to_DA3_elec_syn_B[0] = new AS4_to_DA3_elec_syn(0.5) }")
        h("a_AS4[0].soma { syn_NC_AS4_DA3_Generic_GJ_AS4_to_DA3_elec_syn_A[0].weight = 4.0 }")
        h("a_DA3[0].soma { syn_NC_AS4_DA3_Generic_GJ_AS4_to_DA3_elec_syn_B[0].weight = 4.0 }")
        h("setpointer syn_NC_AS4_DA3_Generic_GJ_AS4_to_DA3_elec_syn_A[0].vpeer, a_DA3[0].soma.v(0.5)")
        h("setpointer syn_NC_AS4_DA3_Generic_GJ_AS4_to_DA3_elec_syn_B[0].vpeer, a_AS4[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL01_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL01_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL01[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL02[0].soma], weight: 15.0
        h("a_MDL01[0].soma { syn_NC_MDL01_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL02[0].soma { syn_NC_MDL01_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL01[0].soma { syn_NC_MDL01_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL02[0].soma { syn_NC_MDL01_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL01_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL02[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL01_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL01[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL01_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL01_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL01[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL03[0].soma], weight: 15.0
        h("a_MDL01[0].soma { syn_NC_MDL01_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL03[0].soma { syn_NC_MDL01_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL01[0].soma { syn_NC_MDL01_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL03[0].soma { syn_NC_MDL01_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL01_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL03[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL01_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL01[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL02_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL02_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL02[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL01[0].soma], weight: 15.0
        h("a_MDL02[0].soma { syn_NC_MDL02_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL01[0].soma { syn_NC_MDL02_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL02[0].soma { syn_NC_MDL02_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL01[0].soma { syn_NC_MDL02_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL02_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL01[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL02_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL02[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL02_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL02_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL02[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL03[0].soma], weight: 15.0
        h("a_MDL02[0].soma { syn_NC_MDL02_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL03[0].soma { syn_NC_MDL02_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL02[0].soma { syn_NC_MDL02_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL03[0].soma { syn_NC_MDL02_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL02_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL03[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL02_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL02[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL03_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL03_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL01[0].soma], weight: 15.0
        h("a_MDL03[0].soma { syn_NC_MDL03_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL01[0].soma { syn_NC_MDL03_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL03[0].soma { syn_NC_MDL03_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL01[0].soma { syn_NC_MDL03_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL03_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL01[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL03_MDL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL03_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL03_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL02[0].soma], weight: 15.0
        h("a_MDL03[0].soma { syn_NC_MDL03_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL02[0].soma { syn_NC_MDL03_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL03[0].soma { syn_NC_MDL03_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL02[0].soma { syn_NC_MDL03_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL03_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL02[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL03_MDL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL03_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL03_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL04[0].soma], weight: 15.0
        h("a_MDL03[0].soma { syn_NC_MDL03_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL04[0].soma { syn_NC_MDL03_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL03[0].soma { syn_NC_MDL03_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL04[0].soma { syn_NC_MDL03_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL03_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL04[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL03_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL04_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL04_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL04[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL03[0].soma], weight: 15.0
        h("a_MDL04[0].soma { syn_NC_MDL04_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL03[0].soma { syn_NC_MDL04_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL04[0].soma { syn_NC_MDL04_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL03[0].soma { syn_NC_MDL04_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL04_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL03[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL04_MDL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL04[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL04_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL04_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL04[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL05[0].soma], weight: 15.0
        h("a_MDL04[0].soma { syn_NC_MDL04_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL05[0].soma { syn_NC_MDL04_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL04[0].soma { syn_NC_MDL04_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL05[0].soma { syn_NC_MDL04_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL04_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL05[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL04_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL04[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL05_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL05_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL05[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL04[0].soma], weight: 15.0
        h("a_MDL05[0].soma { syn_NC_MDL05_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL04[0].soma { syn_NC_MDL05_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL05[0].soma { syn_NC_MDL05_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL04[0].soma { syn_NC_MDL05_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL05_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL04[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL05_MDL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL05[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL05_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL05_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL05[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL06[0].soma], weight: 15.0
        h("a_MDL05[0].soma { syn_NC_MDL05_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL06[0].soma { syn_NC_MDL05_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL05[0].soma { syn_NC_MDL05_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL06[0].soma { syn_NC_MDL05_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL05_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL06[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL05_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL05[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL06_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL06_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL05[0].soma], weight: 15.0
        h("a_MDL06[0].soma { syn_NC_MDL06_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL05[0].soma { syn_NC_MDL06_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL06[0].soma { syn_NC_MDL06_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL05[0].soma { syn_NC_MDL06_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL06_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL05[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL06_MDL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL06_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL06_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL07[0].soma], weight: 15.0
        h("a_MDL06[0].soma { syn_NC_MDL06_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL07[0].soma { syn_NC_MDL06_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL06[0].soma { syn_NC_MDL06_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL07[0].soma { syn_NC_MDL06_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL06_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL07[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL06_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL07_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL07_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL06[0].soma], weight: 15.0
        h("a_MDL07[0].soma { syn_NC_MDL07_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL06[0].soma { syn_NC_MDL07_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL07[0].soma { syn_NC_MDL07_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL06[0].soma { syn_NC_MDL07_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL07_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL06[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL07_MDL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL07_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL07_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL08[0].soma], weight: 15.0
        h("a_MDL07[0].soma { syn_NC_MDL07_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL08[0].soma { syn_NC_MDL07_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL07[0].soma { syn_NC_MDL07_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL08[0].soma { syn_NC_MDL07_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL07_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL08[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL07_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL08_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL08_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL07[0].soma], weight: 15.0
        h("a_MDL08[0].soma { syn_NC_MDL08_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL07[0].soma { syn_NC_MDL08_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL08[0].soma { syn_NC_MDL08_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL07[0].soma { syn_NC_MDL08_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL08_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL07[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL08_MDL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL08_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL08_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL09[0].soma], weight: 15.0
        h("a_MDL08[0].soma { syn_NC_MDL08_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL09[0].soma { syn_NC_MDL08_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL08[0].soma { syn_NC_MDL08_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL09[0].soma { syn_NC_MDL08_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL08_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL09[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL08_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL09_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL09_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL08[0].soma], weight: 15.0
        h("a_MDL09[0].soma { syn_NC_MDL09_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL08[0].soma { syn_NC_MDL09_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL09[0].soma { syn_NC_MDL09_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL08[0].soma { syn_NC_MDL09_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL09_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL08[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL09_MDL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL09_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL09_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL10[0].soma], weight: 15.0
        h("a_MDL09[0].soma { syn_NC_MDL09_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL10[0].soma { syn_NC_MDL09_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL09[0].soma { syn_NC_MDL09_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL10[0].soma { syn_NC_MDL09_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL09_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL10[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL09_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL10_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL10_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL09[0].soma], weight: 15.0
        h("a_MDL10[0].soma { syn_NC_MDL10_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL09[0].soma { syn_NC_MDL10_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL10[0].soma { syn_NC_MDL10_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL09[0].soma { syn_NC_MDL10_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL10_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL09[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL10_MDL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL10_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL10_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma], weight: 15.0
        h("a_MDL10[0].soma { syn_NC_MDL10_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL11[0].soma { syn_NC_MDL10_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL10[0].soma { syn_NC_MDL10_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL11[0].soma { syn_NC_MDL10_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL10_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL11[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL10_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL11_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL11_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL10[0].soma], weight: 15.0
        h("a_MDL11[0].soma { syn_NC_MDL11_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL10[0].soma { syn_NC_MDL11_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL11[0].soma { syn_NC_MDL11_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL10[0].soma { syn_NC_MDL11_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL11_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL10[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL11_MDL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL11_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL11_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma], weight: 15.0
        h("a_MDL11[0].soma { syn_NC_MDL11_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL12[0].soma { syn_NC_MDL11_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL11[0].soma { syn_NC_MDL11_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL12[0].soma { syn_NC_MDL11_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL11_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL12[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL11_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL12_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL12_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma], weight: 15.0
        h("a_MDL12[0].soma { syn_NC_MDL12_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL11[0].soma { syn_NC_MDL12_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL12[0].soma { syn_NC_MDL12_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL11[0].soma { syn_NC_MDL12_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL12_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL11[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL12_MDL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL12_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL12_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma], weight: 15.0
        h("a_MDL12[0].soma { syn_NC_MDL12_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL13[0].soma { syn_NC_MDL12_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL12[0].soma { syn_NC_MDL12_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL13[0].soma { syn_NC_MDL12_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL12_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL13[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL12_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL13_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL13_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma], weight: 15.0
        h("a_MDL13[0].soma { syn_NC_MDL13_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL12[0].soma { syn_NC_MDL13_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL13[0].soma { syn_NC_MDL13_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL12[0].soma { syn_NC_MDL13_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL13_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL12[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL13_MDL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL13_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL13_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL14[0].soma], weight: 15.0
        h("a_MDL13[0].soma { syn_NC_MDL13_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL14[0].soma { syn_NC_MDL13_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL13[0].soma { syn_NC_MDL13_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL14[0].soma { syn_NC_MDL13_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL13_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL14[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL13_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL14_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL14_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma], weight: 15.0
        h("a_MDL14[0].soma { syn_NC_MDL14_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL13[0].soma { syn_NC_MDL14_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL14[0].soma { syn_NC_MDL14_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL13[0].soma { syn_NC_MDL14_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL14_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL13[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL14_MDL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL14_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL14_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL15[0].soma], weight: 15.0
        h("a_MDL14[0].soma { syn_NC_MDL14_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL15[0].soma { syn_NC_MDL14_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL14[0].soma { syn_NC_MDL14_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL15[0].soma { syn_NC_MDL14_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL14_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL15[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL14_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL15_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL15_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL14[0].soma], weight: 15.0
        h("a_MDL15[0].soma { syn_NC_MDL15_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL14[0].soma { syn_NC_MDL15_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL15[0].soma { syn_NC_MDL15_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL14[0].soma { syn_NC_MDL15_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL15_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL14[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL15_MDL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL15_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL15_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL16[0].soma], weight: 15.0
        h("a_MDL15[0].soma { syn_NC_MDL15_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL16[0].soma { syn_NC_MDL15_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL15[0].soma { syn_NC_MDL15_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL16[0].soma { syn_NC_MDL15_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL15_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL16[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL15_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL16_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL16_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL15[0].soma], weight: 15.0
        h("a_MDL16[0].soma { syn_NC_MDL16_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL15[0].soma { syn_NC_MDL16_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL16[0].soma { syn_NC_MDL16_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL15[0].soma { syn_NC_MDL16_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL16_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL15[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL16_MDL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL16_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL16_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL17[0].soma], weight: 15.0
        h("a_MDL16[0].soma { syn_NC_MDL16_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL17[0].soma { syn_NC_MDL16_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL16[0].soma { syn_NC_MDL16_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL17[0].soma { syn_NC_MDL16_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL16_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL17[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL16_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL17_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL17_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL16[0].soma], weight: 15.0
        h("a_MDL17[0].soma { syn_NC_MDL17_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL16[0].soma { syn_NC_MDL17_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL17[0].soma { syn_NC_MDL17_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL16[0].soma { syn_NC_MDL17_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL17_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL16[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL17_MDL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL17_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL17_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL18[0].soma], weight: 15.0
        h("a_MDL17[0].soma { syn_NC_MDL17_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL18[0].soma { syn_NC_MDL17_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL17[0].soma { syn_NC_MDL17_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL18[0].soma { syn_NC_MDL17_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL17_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL18[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL17_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL18_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL18_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL17[0].soma], weight: 15.0
        h("a_MDL18[0].soma { syn_NC_MDL18_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL17[0].soma { syn_NC_MDL18_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL18[0].soma { syn_NC_MDL18_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL17[0].soma { syn_NC_MDL18_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL18_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL17[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL18_MDL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL18_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL18_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL19[0].soma], weight: 15.0
        h("a_MDL18[0].soma { syn_NC_MDL18_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL19[0].soma { syn_NC_MDL18_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL18[0].soma { syn_NC_MDL18_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL19[0].soma { syn_NC_MDL18_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL18_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL19[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL18_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL19_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL19_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL18[0].soma], weight: 15.0
        h("a_MDL19[0].soma { syn_NC_MDL19_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL18[0].soma { syn_NC_MDL19_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL19[0].soma { syn_NC_MDL19_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL18[0].soma { syn_NC_MDL19_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL19_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL18[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL19_MDL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL19_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL19_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL20[0].soma], weight: 15.0
        h("a_MDL19[0].soma { syn_NC_MDL19_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL20[0].soma { syn_NC_MDL19_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL19[0].soma { syn_NC_MDL19_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL20[0].soma { syn_NC_MDL19_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL19_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL20[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL19_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL20_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL20_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL19[0].soma], weight: 15.0
        h("a_MDL20[0].soma { syn_NC_MDL20_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL19[0].soma { syn_NC_MDL20_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL20[0].soma { syn_NC_MDL20_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL19[0].soma { syn_NC_MDL20_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL20_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL19[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL20_MDL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL20_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL20_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL21[0].soma], weight: 15.0
        h("a_MDL20[0].soma { syn_NC_MDL20_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL21[0].soma { syn_NC_MDL20_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL20[0].soma { syn_NC_MDL20_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL21[0].soma { syn_NC_MDL20_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL20_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL21[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL20_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL21_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL21_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL20[0].soma], weight: 15.0
        h("a_MDL21[0].soma { syn_NC_MDL21_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL20[0].soma { syn_NC_MDL21_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL21[0].soma { syn_NC_MDL21_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL20[0].soma { syn_NC_MDL21_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL21_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL20[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL21_MDL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL21_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL21_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL22[0].soma], weight: 15.0
        h("a_MDL21[0].soma { syn_NC_MDL21_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL22[0].soma { syn_NC_MDL21_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL21[0].soma { syn_NC_MDL21_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL22[0].soma { syn_NC_MDL21_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL21_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL22[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL21_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL22_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL22_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL21[0].soma], weight: 15.0
        h("a_MDL22[0].soma { syn_NC_MDL22_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL21[0].soma { syn_NC_MDL22_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL22[0].soma { syn_NC_MDL22_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL21[0].soma { syn_NC_MDL22_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL22_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL21[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL22_MDL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL22_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL22_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL23[0].soma], weight: 15.0
        h("a_MDL22[0].soma { syn_NC_MDL22_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL23[0].soma { syn_NC_MDL22_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL22[0].soma { syn_NC_MDL22_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL23[0].soma { syn_NC_MDL22_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL22_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL23[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL22_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL23_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL23_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL23[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL22[0].soma], weight: 15.0
        h("a_MDL23[0].soma { syn_NC_MDL23_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL22[0].soma { syn_NC_MDL23_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL23[0].soma { syn_NC_MDL23_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL22[0].soma { syn_NC_MDL23_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL23_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL22[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL23_MDL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL23[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL23_MDL24_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL23_MDL24_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL23[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL24[0].soma], weight: 15.0
        h("a_MDL23[0].soma { syn_NC_MDL23_MDL24_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL24[0].soma { syn_NC_MDL23_MDL24_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL23[0].soma { syn_NC_MDL23_MDL24_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL24[0].soma { syn_NC_MDL23_MDL24_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL23_MDL24_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL24[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL23_MDL24_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL23[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL24_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDL24_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL24[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL23[0].soma], weight: 15.0
        h("a_MDL24[0].soma { syn_NC_MDL24_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL23[0].soma { syn_NC_MDL24_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDL24[0].soma { syn_NC_MDL24_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDL23[0].soma { syn_NC_MDL24_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDL24_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDL23[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL24_MDL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDL24[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR01_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR01_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR01[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR02[0].soma], weight: 15.0
        h("a_MDR01[0].soma { syn_NC_MDR01_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR02[0].soma { syn_NC_MDR01_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR01[0].soma { syn_NC_MDR01_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR02[0].soma { syn_NC_MDR01_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR01_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR02[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR01_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR01[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR01_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR01_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR01[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR03[0].soma], weight: 15.0
        h("a_MDR01[0].soma { syn_NC_MDR01_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR03[0].soma { syn_NC_MDR01_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR01[0].soma { syn_NC_MDR01_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR03[0].soma { syn_NC_MDR01_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR01_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR03[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR01_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR01[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR02_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR02_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR02[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR01[0].soma], weight: 15.0
        h("a_MDR02[0].soma { syn_NC_MDR02_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR01[0].soma { syn_NC_MDR02_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR02[0].soma { syn_NC_MDR02_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR01[0].soma { syn_NC_MDR02_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR02_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR01[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR02_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR02[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR02_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR02_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR02[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR03[0].soma], weight: 15.0
        h("a_MDR02[0].soma { syn_NC_MDR02_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR03[0].soma { syn_NC_MDR02_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR02[0].soma { syn_NC_MDR02_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR03[0].soma { syn_NC_MDR02_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR02_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR03[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR02_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR02[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR03_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR03_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR01[0].soma], weight: 15.0
        h("a_MDR03[0].soma { syn_NC_MDR03_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR01[0].soma { syn_NC_MDR03_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR03[0].soma { syn_NC_MDR03_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR01[0].soma { syn_NC_MDR03_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR03_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR01[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR03_MDR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR03_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR03_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR02[0].soma], weight: 15.0
        h("a_MDR03[0].soma { syn_NC_MDR03_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR02[0].soma { syn_NC_MDR03_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR03[0].soma { syn_NC_MDR03_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR02[0].soma { syn_NC_MDR03_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR03_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR02[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR03_MDR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR03_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR03_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR04[0].soma], weight: 15.0
        h("a_MDR03[0].soma { syn_NC_MDR03_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR04[0].soma { syn_NC_MDR03_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR03[0].soma { syn_NC_MDR03_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR04[0].soma { syn_NC_MDR03_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR03_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR04[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR03_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR04_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR04_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR04[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR03[0].soma], weight: 15.0
        h("a_MDR04[0].soma { syn_NC_MDR04_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR03[0].soma { syn_NC_MDR04_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR04[0].soma { syn_NC_MDR04_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR03[0].soma { syn_NC_MDR04_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR04_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR03[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR04_MDR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR04[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR04_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR04_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR04[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR05[0].soma], weight: 15.0
        h("a_MDR04[0].soma { syn_NC_MDR04_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR05[0].soma { syn_NC_MDR04_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR04[0].soma { syn_NC_MDR04_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR05[0].soma { syn_NC_MDR04_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR04_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR05[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR04_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR04[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR05_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR05_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR05[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR04[0].soma], weight: 15.0
        h("a_MDR05[0].soma { syn_NC_MDR05_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR04[0].soma { syn_NC_MDR05_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR05[0].soma { syn_NC_MDR05_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR04[0].soma { syn_NC_MDR05_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR05_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR04[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR05_MDR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR05[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR05_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR05_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR05[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR06[0].soma], weight: 15.0
        h("a_MDR05[0].soma { syn_NC_MDR05_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR06[0].soma { syn_NC_MDR05_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR05[0].soma { syn_NC_MDR05_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR06[0].soma { syn_NC_MDR05_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR05_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR06[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR05_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR05[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR06_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR06_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR05[0].soma], weight: 15.0
        h("a_MDR06[0].soma { syn_NC_MDR06_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR05[0].soma { syn_NC_MDR06_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR06[0].soma { syn_NC_MDR06_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR05[0].soma { syn_NC_MDR06_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR06_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR05[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR06_MDR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR06_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR06_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR07[0].soma], weight: 15.0
        h("a_MDR06[0].soma { syn_NC_MDR06_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR07[0].soma { syn_NC_MDR06_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR06[0].soma { syn_NC_MDR06_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR07[0].soma { syn_NC_MDR06_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR06_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR07[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR06_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR07_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR07_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR06[0].soma], weight: 15.0
        h("a_MDR07[0].soma { syn_NC_MDR07_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR06[0].soma { syn_NC_MDR07_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR07[0].soma { syn_NC_MDR07_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR06[0].soma { syn_NC_MDR07_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR07_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR06[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR07_MDR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR07_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR07_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR08[0].soma], weight: 15.0
        h("a_MDR07[0].soma { syn_NC_MDR07_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR08[0].soma { syn_NC_MDR07_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR07[0].soma { syn_NC_MDR07_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR08[0].soma { syn_NC_MDR07_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR07_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR08[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR07_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR08_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR08_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR07[0].soma], weight: 15.0
        h("a_MDR08[0].soma { syn_NC_MDR08_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR07[0].soma { syn_NC_MDR08_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR08[0].soma { syn_NC_MDR08_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR07[0].soma { syn_NC_MDR08_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR08_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR07[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR08_MDR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR08_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR08_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR09[0].soma], weight: 15.0
        h("a_MDR08[0].soma { syn_NC_MDR08_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR09[0].soma { syn_NC_MDR08_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR08[0].soma { syn_NC_MDR08_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR09[0].soma { syn_NC_MDR08_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR08_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR09[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR08_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR09_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR09_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR08[0].soma], weight: 15.0
        h("a_MDR09[0].soma { syn_NC_MDR09_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR08[0].soma { syn_NC_MDR09_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR09[0].soma { syn_NC_MDR09_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR08[0].soma { syn_NC_MDR09_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR09_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR08[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR09_MDR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR09_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR09_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR10[0].soma], weight: 15.0
        h("a_MDR09[0].soma { syn_NC_MDR09_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR10[0].soma { syn_NC_MDR09_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR09[0].soma { syn_NC_MDR09_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR10[0].soma { syn_NC_MDR09_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR09_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR10[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR09_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR10_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR10_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR09[0].soma], weight: 15.0
        h("a_MDR10[0].soma { syn_NC_MDR10_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR09[0].soma { syn_NC_MDR10_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR10[0].soma { syn_NC_MDR10_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR09[0].soma { syn_NC_MDR10_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR10_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR09[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR10_MDR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR10_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR10_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma], weight: 15.0
        h("a_MDR10[0].soma { syn_NC_MDR10_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR11[0].soma { syn_NC_MDR10_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR10[0].soma { syn_NC_MDR10_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR11[0].soma { syn_NC_MDR10_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR10_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR11[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR10_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR11_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR11_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR10[0].soma], weight: 15.0
        h("a_MDR11[0].soma { syn_NC_MDR11_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR10[0].soma { syn_NC_MDR11_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR11[0].soma { syn_NC_MDR11_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR10[0].soma { syn_NC_MDR11_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR11_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR10[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR11_MDR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR11_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR11_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma], weight: 15.0
        h("a_MDR11[0].soma { syn_NC_MDR11_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR12[0].soma { syn_NC_MDR11_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR11[0].soma { syn_NC_MDR11_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR12[0].soma { syn_NC_MDR11_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR11_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR12[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR11_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR12_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR12_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma], weight: 15.0
        h("a_MDR12[0].soma { syn_NC_MDR12_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR11[0].soma { syn_NC_MDR12_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR12[0].soma { syn_NC_MDR12_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR11[0].soma { syn_NC_MDR12_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR12_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR11[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR12_MDR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR12_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR12_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR13[0].soma], weight: 15.0
        h("a_MDR12[0].soma { syn_NC_MDR12_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR13[0].soma { syn_NC_MDR12_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR12[0].soma { syn_NC_MDR12_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR13[0].soma { syn_NC_MDR12_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR12_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR13[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR12_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR13_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR13_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma], weight: 15.0
        h("a_MDR13[0].soma { syn_NC_MDR13_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR12[0].soma { syn_NC_MDR13_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR13[0].soma { syn_NC_MDR13_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR12[0].soma { syn_NC_MDR13_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR13_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR12[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR13_MDR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR13_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR13_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR14[0].soma], weight: 15.0
        h("a_MDR13[0].soma { syn_NC_MDR13_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR14[0].soma { syn_NC_MDR13_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR13[0].soma { syn_NC_MDR13_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR14[0].soma { syn_NC_MDR13_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR13_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR14[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR13_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR14_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR14_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR13[0].soma], weight: 15.0
        h("a_MDR14[0].soma { syn_NC_MDR14_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR13[0].soma { syn_NC_MDR14_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR14[0].soma { syn_NC_MDR14_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR13[0].soma { syn_NC_MDR14_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR14_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR13[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR14_MDR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR14_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR14_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR15[0].soma], weight: 15.0
        h("a_MDR14[0].soma { syn_NC_MDR14_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR15[0].soma { syn_NC_MDR14_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR14[0].soma { syn_NC_MDR14_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR15[0].soma { syn_NC_MDR14_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR14_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR15[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR14_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR15_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR15_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR14[0].soma], weight: 15.0
        h("a_MDR15[0].soma { syn_NC_MDR15_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR14[0].soma { syn_NC_MDR15_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR15[0].soma { syn_NC_MDR15_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR14[0].soma { syn_NC_MDR15_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR15_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR14[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR15_MDR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR15_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR15_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR16[0].soma], weight: 15.0
        h("a_MDR15[0].soma { syn_NC_MDR15_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR16[0].soma { syn_NC_MDR15_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR15[0].soma { syn_NC_MDR15_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR16[0].soma { syn_NC_MDR15_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR15_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR16[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR15_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR16_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR16_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR15[0].soma], weight: 15.0
        h("a_MDR16[0].soma { syn_NC_MDR16_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR15[0].soma { syn_NC_MDR16_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR16[0].soma { syn_NC_MDR16_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR15[0].soma { syn_NC_MDR16_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR16_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR15[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR16_MDR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR16_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR16_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR17[0].soma], weight: 15.0
        h("a_MDR16[0].soma { syn_NC_MDR16_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR17[0].soma { syn_NC_MDR16_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR16[0].soma { syn_NC_MDR16_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR17[0].soma { syn_NC_MDR16_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR16_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR17[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR16_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR17_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR17_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR16[0].soma], weight: 15.0
        h("a_MDR17[0].soma { syn_NC_MDR17_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR16[0].soma { syn_NC_MDR17_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR17[0].soma { syn_NC_MDR17_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR16[0].soma { syn_NC_MDR17_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR17_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR16[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR17_MDR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR17_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR17_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR18[0].soma], weight: 15.0
        h("a_MDR17[0].soma { syn_NC_MDR17_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR18[0].soma { syn_NC_MDR17_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR17[0].soma { syn_NC_MDR17_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR18[0].soma { syn_NC_MDR17_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR17_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR18[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR17_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR18_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR18_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR17[0].soma], weight: 15.0
        h("a_MDR18[0].soma { syn_NC_MDR18_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR17[0].soma { syn_NC_MDR18_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR18[0].soma { syn_NC_MDR18_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR17[0].soma { syn_NC_MDR18_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR18_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR17[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR18_MDR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR18_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR18_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR19[0].soma], weight: 15.0
        h("a_MDR18[0].soma { syn_NC_MDR18_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR19[0].soma { syn_NC_MDR18_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR18[0].soma { syn_NC_MDR18_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR19[0].soma { syn_NC_MDR18_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR18_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR19[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR18_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR19_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR19_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR18[0].soma], weight: 15.0
        h("a_MDR19[0].soma { syn_NC_MDR19_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR18[0].soma { syn_NC_MDR19_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR19[0].soma { syn_NC_MDR19_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR18[0].soma { syn_NC_MDR19_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR19_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR18[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR19_MDR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR19_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR19_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR20[0].soma], weight: 15.0
        h("a_MDR19[0].soma { syn_NC_MDR19_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR20[0].soma { syn_NC_MDR19_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR19[0].soma { syn_NC_MDR19_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR20[0].soma { syn_NC_MDR19_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR19_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR20[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR19_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR20_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR20_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR19[0].soma], weight: 15.0
        h("a_MDR20[0].soma { syn_NC_MDR20_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR19[0].soma { syn_NC_MDR20_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR20[0].soma { syn_NC_MDR20_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR19[0].soma { syn_NC_MDR20_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR20_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR19[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR20_MDR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR20_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR20_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR21[0].soma], weight: 15.0
        h("a_MDR20[0].soma { syn_NC_MDR20_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR21[0].soma { syn_NC_MDR20_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR20[0].soma { syn_NC_MDR20_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR21[0].soma { syn_NC_MDR20_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR20_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR21[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR20_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR21_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR21_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR20[0].soma], weight: 15.0
        h("a_MDR21[0].soma { syn_NC_MDR21_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR20[0].soma { syn_NC_MDR21_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR21[0].soma { syn_NC_MDR21_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR20[0].soma { syn_NC_MDR21_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR21_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR20[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR21_MDR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR21_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR21_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR22[0].soma], weight: 15.0
        h("a_MDR21[0].soma { syn_NC_MDR21_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR22[0].soma { syn_NC_MDR21_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR21[0].soma { syn_NC_MDR21_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR22[0].soma { syn_NC_MDR21_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR21_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR22[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR21_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR22_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR22_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR21[0].soma], weight: 15.0
        h("a_MDR22[0].soma { syn_NC_MDR22_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR21[0].soma { syn_NC_MDR22_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR22[0].soma { syn_NC_MDR22_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR21[0].soma { syn_NC_MDR22_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR22_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR21[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR22_MDR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR22_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR22_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR23[0].soma], weight: 15.0
        h("a_MDR22[0].soma { syn_NC_MDR22_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR23[0].soma { syn_NC_MDR22_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR22[0].soma { syn_NC_MDR22_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR23[0].soma { syn_NC_MDR22_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR22_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR23[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR22_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR23_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR23_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR23[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR22[0].soma], weight: 15.0
        h("a_MDR23[0].soma { syn_NC_MDR23_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR22[0].soma { syn_NC_MDR23_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR23[0].soma { syn_NC_MDR23_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR22[0].soma { syn_NC_MDR23_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR23_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR22[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR23_MDR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR23[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR23_MDR24_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR23_MDR24_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR23[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR24[0].soma], weight: 15.0
        h("a_MDR23[0].soma { syn_NC_MDR23_MDR24_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR24[0].soma { syn_NC_MDR23_MDR24_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR23[0].soma { syn_NC_MDR23_MDR24_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR24[0].soma { syn_NC_MDR23_MDR24_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR23_MDR24_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR24[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR23_MDR24_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR23[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR24_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MDR24_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR24[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR23[0].soma], weight: 15.0
        h("a_MDR24[0].soma { syn_NC_MDR24_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR23[0].soma { syn_NC_MDR24_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MDR24[0].soma { syn_NC_MDR24_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MDR23[0].soma { syn_NC_MDR24_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MDR24_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MDR23[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR24_MDR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MDR24[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL01_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL01_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL01[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL02[0].soma], weight: 15.0
        h("a_MVL01[0].soma { syn_NC_MVL01_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL02[0].soma { syn_NC_MVL01_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL01[0].soma { syn_NC_MVL01_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL02[0].soma { syn_NC_MVL01_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL01_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL02[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL01_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL01[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL01_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL01_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL01[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL03[0].soma], weight: 15.0
        h("a_MVL01[0].soma { syn_NC_MVL01_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL03[0].soma { syn_NC_MVL01_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL01[0].soma { syn_NC_MVL01_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL03[0].soma { syn_NC_MVL01_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL01_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL03[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL01_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL01[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL02_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL02_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL02[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL01[0].soma], weight: 15.0
        h("a_MVL02[0].soma { syn_NC_MVL02_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL01[0].soma { syn_NC_MVL02_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL02[0].soma { syn_NC_MVL02_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL01[0].soma { syn_NC_MVL02_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL02_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL01[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL02_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL02[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL02_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL02_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL02[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL03[0].soma], weight: 15.0
        h("a_MVL02[0].soma { syn_NC_MVL02_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL03[0].soma { syn_NC_MVL02_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL02[0].soma { syn_NC_MVL02_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL03[0].soma { syn_NC_MVL02_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL02_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL03[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL02_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL02[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL03_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL03_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL01[0].soma], weight: 15.0
        h("a_MVL03[0].soma { syn_NC_MVL03_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL01[0].soma { syn_NC_MVL03_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL03[0].soma { syn_NC_MVL03_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL01[0].soma { syn_NC_MVL03_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL03_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL01[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL03_MVL01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL03_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL03_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL02[0].soma], weight: 15.0
        h("a_MVL03[0].soma { syn_NC_MVL03_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL02[0].soma { syn_NC_MVL03_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL03[0].soma { syn_NC_MVL03_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL02[0].soma { syn_NC_MVL03_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL03_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL02[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL03_MVL02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL03_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL03_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL04[0].soma], weight: 15.0
        h("a_MVL03[0].soma { syn_NC_MVL03_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL04[0].soma { syn_NC_MVL03_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL03[0].soma { syn_NC_MVL03_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL04[0].soma { syn_NC_MVL03_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL03_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL04[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL03_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL04_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL04_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL04[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL03[0].soma], weight: 15.0
        h("a_MVL04[0].soma { syn_NC_MVL04_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL03[0].soma { syn_NC_MVL04_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL04[0].soma { syn_NC_MVL04_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL03[0].soma { syn_NC_MVL04_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL04_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL03[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL04_MVL03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL04[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL04_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL04_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL04[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL05[0].soma], weight: 15.0
        h("a_MVL04[0].soma { syn_NC_MVL04_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL05[0].soma { syn_NC_MVL04_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL04[0].soma { syn_NC_MVL04_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL05[0].soma { syn_NC_MVL04_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL04_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL05[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL04_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL04[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL05_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL05_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL05[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL04[0].soma], weight: 15.0
        h("a_MVL05[0].soma { syn_NC_MVL05_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL04[0].soma { syn_NC_MVL05_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL05[0].soma { syn_NC_MVL05_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL04[0].soma { syn_NC_MVL05_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL05_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL04[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL05_MVL04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL05[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL05_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL05_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL05[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL06[0].soma], weight: 15.0
        h("a_MVL05[0].soma { syn_NC_MVL05_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL06[0].soma { syn_NC_MVL05_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL05[0].soma { syn_NC_MVL05_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL06[0].soma { syn_NC_MVL05_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL05_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL06[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL05_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL05[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL06_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL06_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL05[0].soma], weight: 15.0
        h("a_MVL06[0].soma { syn_NC_MVL06_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL05[0].soma { syn_NC_MVL06_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL06[0].soma { syn_NC_MVL06_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL05[0].soma { syn_NC_MVL06_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL06_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL05[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL06_MVL05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL06_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL06_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL07[0].soma], weight: 15.0
        h("a_MVL06[0].soma { syn_NC_MVL06_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL07[0].soma { syn_NC_MVL06_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL06[0].soma { syn_NC_MVL06_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL07[0].soma { syn_NC_MVL06_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL06_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL07[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL06_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL07_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL07_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL06[0].soma], weight: 15.0
        h("a_MVL07[0].soma { syn_NC_MVL07_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL06[0].soma { syn_NC_MVL07_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL07[0].soma { syn_NC_MVL07_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL06[0].soma { syn_NC_MVL07_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL07_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL06[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL07_MVL06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL07_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL07_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL08[0].soma], weight: 15.0
        h("a_MVL07[0].soma { syn_NC_MVL07_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL08[0].soma { syn_NC_MVL07_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL07[0].soma { syn_NC_MVL07_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL08[0].soma { syn_NC_MVL07_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL07_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL08[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL07_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL08_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL08_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL07[0].soma], weight: 15.0
        h("a_MVL08[0].soma { syn_NC_MVL08_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL07[0].soma { syn_NC_MVL08_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL08[0].soma { syn_NC_MVL08_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL07[0].soma { syn_NC_MVL08_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL08_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL07[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL08_MVL07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL09[0].soma], weight: 15.0
        h("a_MVL08[0].soma { syn_NC_MVL08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL09[0].soma { syn_NC_MVL08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL08[0].soma { syn_NC_MVL08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL09[0].soma { syn_NC_MVL08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL09[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL09_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL09_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL08[0].soma], weight: 15.0
        h("a_MVL09[0].soma { syn_NC_MVL09_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL08[0].soma { syn_NC_MVL09_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL09[0].soma { syn_NC_MVL09_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL08[0].soma { syn_NC_MVL09_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL09_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL08[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL09_MVL08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL09_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL09_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL10[0].soma], weight: 15.0
        h("a_MVL09[0].soma { syn_NC_MVL09_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL10[0].soma { syn_NC_MVL09_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL09[0].soma { syn_NC_MVL09_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL10[0].soma { syn_NC_MVL09_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL09_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL10[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL09_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR08[0].soma], weight: 2.0
        h("a_MVL09[0].soma { syn_NC_MVL09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR08[0].soma { syn_NC_MVL09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL09[0].soma { syn_NC_MVL09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 2.0 }")
        h("a_MVR08[0].soma { syn_NC_MVL09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 2.0 }")
        h("setpointer syn_NC_MVL09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR08[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL10_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL10_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL09[0].soma], weight: 15.0
        h("a_MVL10[0].soma { syn_NC_MVL10_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL09[0].soma { syn_NC_MVL10_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL10[0].soma { syn_NC_MVL10_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL09[0].soma { syn_NC_MVL10_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL10_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL09[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL10_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL10_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL10_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL11[0].soma], weight: 15.0
        h("a_MVL10[0].soma { syn_NC_MVL10_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL11[0].soma { syn_NC_MVL10_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL10[0].soma { syn_NC_MVL10_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL11[0].soma { syn_NC_MVL10_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL10_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL11[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL10_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL11_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL11_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL10[0].soma], weight: 15.0
        h("a_MVL11[0].soma { syn_NC_MVL11_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL10[0].soma { syn_NC_MVL11_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL11[0].soma { syn_NC_MVL11_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL10[0].soma { syn_NC_MVL11_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL11_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL10[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL11_MVL10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL11_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL11_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL12[0].soma], weight: 15.0
        h("a_MVL11[0].soma { syn_NC_MVL11_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL12[0].soma { syn_NC_MVL11_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL11[0].soma { syn_NC_MVL11_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL12[0].soma { syn_NC_MVL11_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL11_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL12[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL11_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL12_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL12_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL11[0].soma], weight: 15.0
        h("a_MVL12[0].soma { syn_NC_MVL12_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL11[0].soma { syn_NC_MVL12_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL12[0].soma { syn_NC_MVL12_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL11[0].soma { syn_NC_MVL12_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL12_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL11[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL12_MVL11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL12_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL12_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL13[0].soma], weight: 15.0
        h("a_MVL12[0].soma { syn_NC_MVL12_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL13[0].soma { syn_NC_MVL12_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL12[0].soma { syn_NC_MVL12_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL13[0].soma { syn_NC_MVL12_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL12_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL13[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL12_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL13_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL13_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL12[0].soma], weight: 15.0
        h("a_MVL13[0].soma { syn_NC_MVL13_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL12[0].soma { syn_NC_MVL13_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL13[0].soma { syn_NC_MVL13_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL12[0].soma { syn_NC_MVL13_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL13_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL12[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL13_MVL12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL13_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL13_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL14[0].soma], weight: 15.0
        h("a_MVL13[0].soma { syn_NC_MVL13_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL14[0].soma { syn_NC_MVL13_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL13[0].soma { syn_NC_MVL13_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL14[0].soma { syn_NC_MVL13_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL13_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL14[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL13_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL14_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL14_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL13[0].soma], weight: 15.0
        h("a_MVL14[0].soma { syn_NC_MVL14_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL13[0].soma { syn_NC_MVL14_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL14[0].soma { syn_NC_MVL14_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL13[0].soma { syn_NC_MVL14_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL14_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL13[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL14_MVL13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL14_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL14_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL15[0].soma], weight: 15.0
        h("a_MVL14[0].soma { syn_NC_MVL14_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL15[0].soma { syn_NC_MVL14_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL14[0].soma { syn_NC_MVL14_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL15[0].soma { syn_NC_MVL14_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL14_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL15[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL14_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL15_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL15_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL14[0].soma], weight: 15.0
        h("a_MVL15[0].soma { syn_NC_MVL15_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL14[0].soma { syn_NC_MVL15_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL15[0].soma { syn_NC_MVL15_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL14[0].soma { syn_NC_MVL15_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL15_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL14[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL15_MVL14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL15_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL15_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL16[0].soma], weight: 15.0
        h("a_MVL15[0].soma { syn_NC_MVL15_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL16[0].soma { syn_NC_MVL15_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL15[0].soma { syn_NC_MVL15_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL16[0].soma { syn_NC_MVL15_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL15_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL16[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL15_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL16_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL16_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL15[0].soma], weight: 15.0
        h("a_MVL16[0].soma { syn_NC_MVL16_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL15[0].soma { syn_NC_MVL16_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL16[0].soma { syn_NC_MVL16_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL15[0].soma { syn_NC_MVL16_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL16_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL15[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL16_MVL15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL16_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL16_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL17[0].soma], weight: 15.0
        h("a_MVL16[0].soma { syn_NC_MVL16_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL17[0].soma { syn_NC_MVL16_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL16[0].soma { syn_NC_MVL16_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL17[0].soma { syn_NC_MVL16_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL16_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL17[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL16_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL17_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL17_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL16[0].soma], weight: 15.0
        h("a_MVL17[0].soma { syn_NC_MVL17_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL16[0].soma { syn_NC_MVL17_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL17[0].soma { syn_NC_MVL17_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL16[0].soma { syn_NC_MVL17_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL17_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL16[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL17_MVL16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL17_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL17_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL18[0].soma], weight: 15.0
        h("a_MVL17[0].soma { syn_NC_MVL17_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL18[0].soma { syn_NC_MVL17_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL17[0].soma { syn_NC_MVL17_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL18[0].soma { syn_NC_MVL17_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL17_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL18[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL17_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL18_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL18_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL17[0].soma], weight: 15.0
        h("a_MVL18[0].soma { syn_NC_MVL18_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL17[0].soma { syn_NC_MVL18_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL18[0].soma { syn_NC_MVL18_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL17[0].soma { syn_NC_MVL18_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL18_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL17[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL18_MVL17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL18_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL18_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL19[0].soma], weight: 15.0
        h("a_MVL18[0].soma { syn_NC_MVL18_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL19[0].soma { syn_NC_MVL18_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL18[0].soma { syn_NC_MVL18_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL19[0].soma { syn_NC_MVL18_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL18_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL19[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL18_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL19_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL19_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL18[0].soma], weight: 15.0
        h("a_MVL19[0].soma { syn_NC_MVL19_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL18[0].soma { syn_NC_MVL19_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL19[0].soma { syn_NC_MVL19_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL18[0].soma { syn_NC_MVL19_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL19_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL18[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL19_MVL18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL19_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL19_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL20[0].soma], weight: 15.0
        h("a_MVL19[0].soma { syn_NC_MVL19_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL20[0].soma { syn_NC_MVL19_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL19[0].soma { syn_NC_MVL19_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL20[0].soma { syn_NC_MVL19_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL19_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL20[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL19_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL20_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL20_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL19[0].soma], weight: 15.0
        h("a_MVL20[0].soma { syn_NC_MVL20_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL19[0].soma { syn_NC_MVL20_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL20[0].soma { syn_NC_MVL20_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL19[0].soma { syn_NC_MVL20_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL20_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL19[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL20_MVL19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL20_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL20_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL21[0].soma], weight: 15.0
        h("a_MVL20[0].soma { syn_NC_MVL20_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL21[0].soma { syn_NC_MVL20_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL20[0].soma { syn_NC_MVL20_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL21[0].soma { syn_NC_MVL20_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL20_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL21[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL20_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL21_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL21_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL20[0].soma], weight: 15.0
        h("a_MVL21[0].soma { syn_NC_MVL21_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL20[0].soma { syn_NC_MVL21_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL21[0].soma { syn_NC_MVL21_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL20[0].soma { syn_NC_MVL21_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL21_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL20[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL21_MVL20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL21_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL21_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL22[0].soma], weight: 15.0
        h("a_MVL21[0].soma { syn_NC_MVL21_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL22[0].soma { syn_NC_MVL21_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL21[0].soma { syn_NC_MVL21_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL22[0].soma { syn_NC_MVL21_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL21_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL22[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL21_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL22_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL22_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL21[0].soma], weight: 15.0
        h("a_MVL22[0].soma { syn_NC_MVL22_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL21[0].soma { syn_NC_MVL22_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL22[0].soma { syn_NC_MVL22_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL21[0].soma { syn_NC_MVL22_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL22_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL21[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL22_MVL21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL22_MVL23_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL22_MVL23_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL23[0].soma], weight: 15.0
        h("a_MVL22[0].soma { syn_NC_MVL22_MVL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL23[0].soma { syn_NC_MVL22_MVL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL22[0].soma { syn_NC_MVL22_MVL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL23[0].soma { syn_NC_MVL22_MVL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL22_MVL23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL23[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL22_MVL23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVL23_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVL23_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVL23[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL22[0].soma], weight: 15.0
        h("a_MVL23[0].soma { syn_NC_MVL23_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL22[0].soma { syn_NC_MVL23_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL23[0].soma { syn_NC_MVL23_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVL22[0].soma { syn_NC_MVL23_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVL23_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL22[0].soma.v(0.5)")
        h("setpointer syn_NC_MVL23_MVL22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVL23[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR01_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR01_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR01[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR02[0].soma], weight: 15.0
        h("a_MVR01[0].soma { syn_NC_MVR01_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR02[0].soma { syn_NC_MVR01_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR01[0].soma { syn_NC_MVR01_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR02[0].soma { syn_NC_MVR01_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR01_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR02[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR01_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR01[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR01_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR01_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR01[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR03[0].soma], weight: 15.0
        h("a_MVR01[0].soma { syn_NC_MVR01_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR03[0].soma { syn_NC_MVR01_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR01[0].soma { syn_NC_MVR01_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR03[0].soma { syn_NC_MVR01_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR01_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR03[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR01_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR01[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR02_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR02_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR02[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR01[0].soma], weight: 15.0
        h("a_MVR02[0].soma { syn_NC_MVR02_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR01[0].soma { syn_NC_MVR02_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR02[0].soma { syn_NC_MVR02_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR01[0].soma { syn_NC_MVR02_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR02_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR01[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR02_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR02[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR02_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR02_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR02[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR03[0].soma], weight: 15.0
        h("a_MVR02[0].soma { syn_NC_MVR02_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR03[0].soma { syn_NC_MVR02_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR02[0].soma { syn_NC_MVR02_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR03[0].soma { syn_NC_MVR02_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR02_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR03[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR02_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR02[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR03_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR03_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR01[0].soma], weight: 15.0
        h("a_MVR03[0].soma { syn_NC_MVR03_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR01[0].soma { syn_NC_MVR03_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR03[0].soma { syn_NC_MVR03_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR01[0].soma { syn_NC_MVR03_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR03_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR01[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR03_MVR01_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR03_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR03_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR02[0].soma], weight: 15.0
        h("a_MVR03[0].soma { syn_NC_MVR03_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR02[0].soma { syn_NC_MVR03_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR03[0].soma { syn_NC_MVR03_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR02[0].soma { syn_NC_MVR03_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR03_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR02[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR03_MVR02_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR03_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR03_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR03[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR04[0].soma], weight: 15.0
        h("a_MVR03[0].soma { syn_NC_MVR03_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR04[0].soma { syn_NC_MVR03_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR03[0].soma { syn_NC_MVR03_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR04[0].soma { syn_NC_MVR03_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR03_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR04[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR03_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR03[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR04_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR04_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR04[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR03[0].soma], weight: 15.0
        h("a_MVR04[0].soma { syn_NC_MVR04_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR03[0].soma { syn_NC_MVR04_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR04[0].soma { syn_NC_MVR04_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR03[0].soma { syn_NC_MVR04_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR04_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR03[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR04_MVR03_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR04[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR04_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR04_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR04[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR05[0].soma], weight: 15.0
        h("a_MVR04[0].soma { syn_NC_MVR04_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR05[0].soma { syn_NC_MVR04_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR04[0].soma { syn_NC_MVR04_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR05[0].soma { syn_NC_MVR04_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR04_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR05[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR04_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR04[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR05_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR05_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR05[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR04[0].soma], weight: 15.0
        h("a_MVR05[0].soma { syn_NC_MVR05_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR04[0].soma { syn_NC_MVR05_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR05[0].soma { syn_NC_MVR05_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR04[0].soma { syn_NC_MVR05_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR05_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR04[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR05_MVR04_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR05[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR05_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR05_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR05[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR06[0].soma], weight: 15.0
        h("a_MVR05[0].soma { syn_NC_MVR05_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR06[0].soma { syn_NC_MVR05_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR05[0].soma { syn_NC_MVR05_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR06[0].soma { syn_NC_MVR05_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR05_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR06[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR05_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR05[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR06_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR06_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR05[0].soma], weight: 15.0
        h("a_MVR06[0].soma { syn_NC_MVR06_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR05[0].soma { syn_NC_MVR06_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR06[0].soma { syn_NC_MVR06_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR05[0].soma { syn_NC_MVR06_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR06_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR05[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR06_MVR05_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR06_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR06_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR07[0].soma], weight: 15.0
        h("a_MVR06[0].soma { syn_NC_MVR06_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR07[0].soma { syn_NC_MVR06_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR06[0].soma { syn_NC_MVR06_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR07[0].soma { syn_NC_MVR06_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR06_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR07[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR06_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR07_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR07_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR06[0].soma], weight: 15.0
        h("a_MVR07[0].soma { syn_NC_MVR07_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR06[0].soma { syn_NC_MVR07_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR07[0].soma { syn_NC_MVR07_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR06[0].soma { syn_NC_MVR07_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR07_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR06[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR07_MVR06_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR07_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR07_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR08[0].soma], weight: 15.0
        h("a_MVR07[0].soma { syn_NC_MVR07_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR08[0].soma { syn_NC_MVR07_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR07[0].soma { syn_NC_MVR07_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR08[0].soma { syn_NC_MVR07_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR07_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR08[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR07_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVL09[0].soma], weight: 2.0
        h("a_MVR08[0].soma { syn_NC_MVR08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVL09[0].soma { syn_NC_MVR08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR08[0].soma { syn_NC_MVR08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 2.0 }")
        h("a_MVL09[0].soma { syn_NC_MVR08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 2.0 }")
        h("setpointer syn_NC_MVR08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVL09[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR08_MVL09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR08_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR08_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR07[0].soma], weight: 15.0
        h("a_MVR08[0].soma { syn_NC_MVR08_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR07[0].soma { syn_NC_MVR08_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR08[0].soma { syn_NC_MVR08_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR07[0].soma { syn_NC_MVR08_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR08_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR07[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR08_MVR07_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR08_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR08_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR09[0].soma], weight: 15.0
        h("a_MVR08[0].soma { syn_NC_MVR08_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR09[0].soma { syn_NC_MVR08_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR08[0].soma { syn_NC_MVR08_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR09[0].soma { syn_NC_MVR08_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR08_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR09[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR08_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR08[0].soma], weight: 15.0
        h("a_MVR09[0].soma { syn_NC_MVR09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR08[0].soma { syn_NC_MVR09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR09[0].soma { syn_NC_MVR09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR08[0].soma { syn_NC_MVR09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR08[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR09_MVR08_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR09_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR09_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR10[0].soma], weight: 15.0
        h("a_MVR09[0].soma { syn_NC_MVR09_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR10[0].soma { syn_NC_MVR09_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR09[0].soma { syn_NC_MVR09_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR10[0].soma { syn_NC_MVR09_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR09_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR10[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR09_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR10_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR10_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR09[0].soma], weight: 15.0
        h("a_MVR10[0].soma { syn_NC_MVR10_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR09[0].soma { syn_NC_MVR10_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR10[0].soma { syn_NC_MVR10_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR09[0].soma { syn_NC_MVR10_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR10_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR09[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR10_MVR09_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR10_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR10_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR11[0].soma], weight: 15.0
        h("a_MVR10[0].soma { syn_NC_MVR10_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR11[0].soma { syn_NC_MVR10_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR10[0].soma { syn_NC_MVR10_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR11[0].soma { syn_NC_MVR10_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR10_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR11[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR10_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR11_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR11_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR10[0].soma], weight: 15.0
        h("a_MVR11[0].soma { syn_NC_MVR11_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR10[0].soma { syn_NC_MVR11_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR11[0].soma { syn_NC_MVR11_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR10[0].soma { syn_NC_MVR11_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR11_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR10[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR11_MVR10_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR11_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR11_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR12[0].soma], weight: 15.0
        h("a_MVR11[0].soma { syn_NC_MVR11_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR12[0].soma { syn_NC_MVR11_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR11[0].soma { syn_NC_MVR11_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR12[0].soma { syn_NC_MVR11_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR11_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR12[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR11_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR12_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR12_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR11[0].soma], weight: 15.0
        h("a_MVR12[0].soma { syn_NC_MVR12_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR11[0].soma { syn_NC_MVR12_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR12[0].soma { syn_NC_MVR12_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR11[0].soma { syn_NC_MVR12_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR12_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR11[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR12_MVR11_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR12_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR12_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR13[0].soma], weight: 15.0
        h("a_MVR12[0].soma { syn_NC_MVR12_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR13[0].soma { syn_NC_MVR12_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR12[0].soma { syn_NC_MVR12_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR13[0].soma { syn_NC_MVR12_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR12_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR13[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR12_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR13_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR13_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR12[0].soma], weight: 15.0
        h("a_MVR13[0].soma { syn_NC_MVR13_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR12[0].soma { syn_NC_MVR13_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR13[0].soma { syn_NC_MVR13_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR12[0].soma { syn_NC_MVR13_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR13_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR12[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR13_MVR12_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR13_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR13_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR14[0].soma], weight: 15.0
        h("a_MVR13[0].soma { syn_NC_MVR13_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR14[0].soma { syn_NC_MVR13_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR13[0].soma { syn_NC_MVR13_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR14[0].soma { syn_NC_MVR13_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR13_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR14[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR13_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR14_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR14_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR13[0].soma], weight: 15.0
        h("a_MVR14[0].soma { syn_NC_MVR14_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR13[0].soma { syn_NC_MVR14_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR14[0].soma { syn_NC_MVR14_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR13[0].soma { syn_NC_MVR14_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR14_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR13[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR14_MVR13_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR14_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR14_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR15[0].soma], weight: 15.0
        h("a_MVR14[0].soma { syn_NC_MVR14_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR15[0].soma { syn_NC_MVR14_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR14[0].soma { syn_NC_MVR14_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR15[0].soma { syn_NC_MVR14_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR14_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR15[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR14_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR15_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR15_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR14[0].soma], weight: 15.0
        h("a_MVR15[0].soma { syn_NC_MVR15_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR14[0].soma { syn_NC_MVR15_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR15[0].soma { syn_NC_MVR15_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR14[0].soma { syn_NC_MVR15_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR15_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR14[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR15_MVR14_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR15_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR15_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR16[0].soma], weight: 15.0
        h("a_MVR15[0].soma { syn_NC_MVR15_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR16[0].soma { syn_NC_MVR15_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR15[0].soma { syn_NC_MVR15_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR16[0].soma { syn_NC_MVR15_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR15_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR16[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR15_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR16_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR16_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR15[0].soma], weight: 15.0
        h("a_MVR16[0].soma { syn_NC_MVR16_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR15[0].soma { syn_NC_MVR16_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR16[0].soma { syn_NC_MVR16_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR15[0].soma { syn_NC_MVR16_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR16_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR15[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR16_MVR15_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR16_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR16_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR17[0].soma], weight: 15.0
        h("a_MVR16[0].soma { syn_NC_MVR16_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR17[0].soma { syn_NC_MVR16_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR16[0].soma { syn_NC_MVR16_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR17[0].soma { syn_NC_MVR16_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR16_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR17[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR16_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR17_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR17_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR16[0].soma], weight: 15.0
        h("a_MVR17[0].soma { syn_NC_MVR17_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR16[0].soma { syn_NC_MVR17_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR17[0].soma { syn_NC_MVR17_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR16[0].soma { syn_NC_MVR17_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR17_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR16[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR17_MVR16_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR17_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR17_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR18[0].soma], weight: 15.0
        h("a_MVR17[0].soma { syn_NC_MVR17_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR18[0].soma { syn_NC_MVR17_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR17[0].soma { syn_NC_MVR17_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR18[0].soma { syn_NC_MVR17_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR17_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR18[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR17_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR18_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR18_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR17[0].soma], weight: 15.0
        h("a_MVR18[0].soma { syn_NC_MVR18_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR17[0].soma { syn_NC_MVR18_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR18[0].soma { syn_NC_MVR18_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR17[0].soma { syn_NC_MVR18_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR18_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR17[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR18_MVR17_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR18_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR18_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR19[0].soma], weight: 15.0
        h("a_MVR18[0].soma { syn_NC_MVR18_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR19[0].soma { syn_NC_MVR18_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR18[0].soma { syn_NC_MVR18_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR19[0].soma { syn_NC_MVR18_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR18_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR19[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR18_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR19_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR19_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR18[0].soma], weight: 15.0
        h("a_MVR19[0].soma { syn_NC_MVR19_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR18[0].soma { syn_NC_MVR19_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR19[0].soma { syn_NC_MVR19_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR18[0].soma { syn_NC_MVR19_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR19_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR18[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR19_MVR18_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR19_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR19_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR20[0].soma], weight: 15.0
        h("a_MVR19[0].soma { syn_NC_MVR19_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR20[0].soma { syn_NC_MVR19_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR19[0].soma { syn_NC_MVR19_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR20[0].soma { syn_NC_MVR19_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR19_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR20[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR19_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR20_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR20_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR19[0].soma], weight: 15.0
        h("a_MVR20[0].soma { syn_NC_MVR20_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR19[0].soma { syn_NC_MVR20_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR20[0].soma { syn_NC_MVR20_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR19[0].soma { syn_NC_MVR20_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR20_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR19[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR20_MVR19_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR20_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR20_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR21[0].soma], weight: 15.0
        h("a_MVR20[0].soma { syn_NC_MVR20_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR21[0].soma { syn_NC_MVR20_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR20[0].soma { syn_NC_MVR20_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR21[0].soma { syn_NC_MVR20_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR20_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR21[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR20_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR21_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR21_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR20[0].soma], weight: 15.0
        h("a_MVR21[0].soma { syn_NC_MVR21_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR20[0].soma { syn_NC_MVR21_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR21[0].soma { syn_NC_MVR21_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR20[0].soma { syn_NC_MVR21_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR21_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR20[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR21_MVR20_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR21_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR21_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR22[0].soma], weight: 15.0
        h("a_MVR21[0].soma { syn_NC_MVR21_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR22[0].soma { syn_NC_MVR21_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR21[0].soma { syn_NC_MVR21_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR22[0].soma { syn_NC_MVR21_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR21_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR22[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR21_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR22_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR22_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR21[0].soma], weight: 15.0
        h("a_MVR22[0].soma { syn_NC_MVR22_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR21[0].soma { syn_NC_MVR22_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR22[0].soma { syn_NC_MVR22_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR21[0].soma { syn_NC_MVR22_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR22_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR21[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR22_MVR21_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR22_MVR23_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR22_MVR23_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR23[0].soma], weight: 15.0
        h("a_MVR22[0].soma { syn_NC_MVR22_MVR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR23[0].soma { syn_NC_MVR22_MVR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR22[0].soma { syn_NC_MVR22_MVR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR23[0].soma { syn_NC_MVR22_MVR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR22_MVR23_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR23[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR22_MVR23_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MVR23_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_A[1]")
        h("objectvar syn_NC_MVR23_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MVR23[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MVR22[0].soma], weight: 15.0
        h("a_MVR23[0].soma { syn_NC_MVR23_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR22[0].soma { syn_NC_MVR23_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0] = new muscle_to_muscle_elec_syn(0.5) }")
        h("a_MVR23[0].soma { syn_NC_MVR23_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].weight = 15.0 }")
        h("a_MVR22[0].soma { syn_NC_MVR23_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].weight = 15.0 }")
        h("setpointer syn_NC_MVR23_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_A[0].vpeer, a_MVR22[0].soma.v(0.5)")
        h("setpointer syn_NC_MVR23_MVR22_Generic_GJ_muscle_to_muscle_elec_syn_B[0].vpeer, a_MVR23[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_AVAL_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")
        ...
        h("a_DA3[0].soma { syn_NC_AVAL_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_AVAL[0].soma { syn_NC_AVAL_DA3_Acetylcholine_silent_pre[0].weight = 12.0 }")
        h("a_DA3[0].soma { syn_NC_AVAL_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 12.0 }")
        h("setpointer syn_NC_AVAL_DA3_Acetylcholine_silent_pre[0].vpeer, a_DA3[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAL_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AVAL[0].soma.v(0.500000)")

        # ######################   Continuous Projection: NC_AVAL_AS4_Acetylcholine
        print("Adding continuous projection: NC_AVAL_AS4_Acetylcholine from AVAL to AS4, with 1 connection(s)")

        h("objectvar syn_NC_AVAL_AS4_Acetylcholine_silent_pre[1]")
        h("objectvar syn_NC_AVAL_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAL[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma], weight: 2.0
        h("a_AVAL[0].soma { syn_NC_AVAL_AS4_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AVAL_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_AVAL[0].soma { syn_NC_AVAL_AS4_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_AS4[0].soma { syn_NC_AVAL_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_AVAL_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAL_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AVAL[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVAR_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")
        ...
        h("a_DA3[0].soma { syn_NC_AVAR_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_DA3_Acetylcholine_silent_pre[0].weight = 8.0 }")
        h("a_DA3[0].soma { syn_NC_AVAR_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 8.0 }")
        h("setpointer syn_NC_AVAR_DA3_Acetylcholine_silent_pre[0].vpeer, a_DA3[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAR_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AVAR[0].soma.v(0.500000)")

        # ######################   Continuous Projection: NC_AVAR_AS4_Acetylcholine
        print("Adding continuous projection: NC_AVAR_AS4_Acetylcholine from AVAR to AS4, with 1 connection(s)")

        h("objectvar syn_NC_AVAR_AS4_Acetylcholine_silent_pre[1]")
        h("objectvar syn_NC_AVAR_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma], weight: 2.0
        h("a_AVAR[0].soma { syn_NC_AVAR_AS4_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AVAR_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_AS4_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_AS4[0].soma { syn_NC_AVAR_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_AVAR_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAR_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AVAR[0].soma.v(0.500000)")
        ...
        # ######################   Continuous Projection: NC_AVBL_AS4_Acetylcholine
        print("Adding continuous projection: NC_AVBL_AS4_Acetylcholine from AVBL to AS4, with 1 connection(s)")

        h("objectvar syn_NC_AVBL_AS4_Acetylcholine_silent_pre[1]")
        h("objectvar syn_NC_AVBL_AS4_Acetylcholine_AVBL_to_AS4_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVBL[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma], weight: 1.0
        h("a_AVBL[0].soma { syn_NC_AVBL_AS4_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AVBL_AS4_Acetylcholine_AVBL_to_AS4_exc_syn_post[0] = new AVBL_to_AS4_exc_syn(0.500000) }")
        h("setpointer syn_NC_AVBL_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBL_AS4_Acetylcholine_AVBL_to_AS4_exc_syn_post[0].vpeer, a_AVBL[0].soma.v(0.500000)")
        ...
        # ######################   Continuous Projection: NC_AVBR_AS4_Acetylcholine
        print("Adding continuous projection: NC_AVBR_AS4_Acetylcholine from AVBR to AS4, with 1 connection(s)")

        h("objectvar syn_NC_AVBR_AS4_Acetylcholine_silent_pre[1]")
        h("objectvar syn_NC_AVBR_AS4_Acetylcholine_AVBR_to_AS4_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVBR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma], weight: 1.0
        h("a_AVBR[0].soma { syn_NC_AVBR_AS4_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AVBR_AS4_Acetylcholine_AVBR_to_AS4_exc_syn_post[0] = new AVBR_to_AS4_exc_syn(0.500000) }")
        h("setpointer syn_NC_AVBR_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBR_AS4_Acetylcholine_AVBR_to_AS4_exc_syn_post[0].vpeer, a_AVBR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_AS4_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_AS4[0].soma { syn_NC_DB3_AS4_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_DB3[0].soma { syn_NC_DB3_AS4_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_AS4[0].soma { syn_NC_DB3_AS4_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_DB3_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_AS4_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DA3_MDL09_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL09[0].soma], weight: 3.0
        h("a_DA3[0].soma { syn_NC_DA3_MDL09_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDL09[0].soma { syn_NC_DA3_MDL09_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_MDL09_Acetylcholine_silent_pre[0].weight = 3.0 }")
        h("a_MDL09[0].soma { syn_NC_DA3_MDL09_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 3.0 }")
        h("setpointer syn_NC_DA3_MDL09_Acetylcholine_silent_pre[0].vpeer, a_MDL09[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_MDL09_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DA3_MDL10_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL10[0].soma], weight: 17.0
        h("a_DA3[0].soma { syn_NC_DA3_MDL10_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDL10[0].soma { syn_NC_DA3_MDL10_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_MDL10_Acetylcholine_silent_pre[0].weight = 17.0 }")
        h("a_MDL10[0].soma { syn_NC_DA3_MDL10_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 17.0 }")
        h("setpointer syn_NC_DA3_MDL10_Acetylcholine_silent_pre[0].vpeer, a_MDL10[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_MDL10_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DA3_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma], weight: 12.0
        h("a_DA3[0].soma { syn_NC_DA3_MDL11_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDL11[0].soma { syn_NC_DA3_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_MDL11_Acetylcholine_silent_pre[0].weight = 12.0 }")
        h("a_MDL11[0].soma { syn_NC_DA3_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 12.0 }")
        h("setpointer syn_NC_DA3_MDL11_Acetylcholine_silent_pre[0].vpeer, a_MDL11[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DA3_MDR09_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR09[0].soma], weight: 3.0
        h("a_DA3[0].soma { syn_NC_DA3_MDR09_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDR09[0].soma { syn_NC_DA3_MDR09_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_MDR09_Acetylcholine_silent_pre[0].weight = 3.0 }")
        h("a_MDR09[0].soma { syn_NC_DA3_MDR09_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 3.0 }")
        h("setpointer syn_NC_DA3_MDR09_Acetylcholine_silent_pre[0].vpeer, a_MDR09[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_MDR09_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DA3_MDR10_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR10[0].soma], weight: 14.0
        h("a_DA3[0].soma { syn_NC_DA3_MDR10_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDR10[0].soma { syn_NC_DA3_MDR10_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_MDR10_Acetylcholine_silent_pre[0].weight = 14.0 }")
        h("a_MDR10[0].soma { syn_NC_DA3_MDR10_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 14.0 }")
        h("setpointer syn_NC_DA3_MDR10_Acetylcholine_silent_pre[0].vpeer, a_MDR10[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_MDR10_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DA3_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma], weight: 4.0
        h("a_DA3[0].soma { syn_NC_DA3_MDR11_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDR11[0].soma { syn_NC_DA3_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_MDR11_Acetylcholine_silent_pre[0].weight = 4.0 }")
        h("a_MDR11[0].soma { syn_NC_DA3_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 4.0 }")
        h("setpointer syn_NC_DA3_MDR11_Acetylcholine_silent_pre[0].vpeer, a_MDR11[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DA3_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma], weight: 2.0
        h("a_DA3[0].soma { syn_NC_DA3_MDR12_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDR12[0].soma { syn_NC_DA3_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_MDR12_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_MDR12[0].soma { syn_NC_DA3_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_DA3_MDR12_Acetylcholine_silent_pre[0].vpeer, a_MDR12[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DB3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma], weight: 6.0
        h("a_DB3[0].soma { syn_NC_DB3_MDL11_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDL11[0].soma { syn_NC_DB3_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DB3[0].soma { syn_NC_DB3_MDL11_Acetylcholine_silent_pre[0].weight = 6.0 }")
        h("a_MDL11[0].soma { syn_NC_DB3_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 6.0 }")
        h("setpointer syn_NC_DB3_MDL11_Acetylcholine_silent_pre[0].vpeer, a_MDL11[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDL12_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")
        ...
        h("a_MDL12[0].soma { syn_NC_DB3_MDL12_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("setpointer syn_NC_DB3_MDL12_Acetylcholine_silent_pre[0].vpeer, a_MDL12[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDL12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDL13_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DB3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma], weight: 3.0
        h("a_DB3[0].soma { syn_NC_DB3_MDL13_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDL13[0].soma { syn_NC_DB3_MDL13_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DB3[0].soma { syn_NC_DB3_MDL13_Acetylcholine_silent_pre[0].weight = 3.0 }")
        h("a_MDL13[0].soma { syn_NC_DB3_MDL13_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 3.0 }")
        h("setpointer syn_NC_DB3_MDL13_Acetylcholine_silent_pre[0].vpeer, a_MDL13[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDL13_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDL14_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")
        ...
        h("a_MDL14[0].soma { syn_NC_DB3_MDL14_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("setpointer syn_NC_DB3_MDL14_Acetylcholine_silent_pre[0].vpeer, a_MDL14[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDL14_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DB3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma], weight: 2.0
        h("a_DB3[0].soma { syn_NC_DB3_MDR11_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDR11[0].soma { syn_NC_DB3_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DB3[0].soma { syn_NC_DB3_MDR11_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_MDR11[0].soma { syn_NC_DB3_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_DB3_MDR11_Acetylcholine_silent_pre[0].vpeer, a_MDR11[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DB3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma], weight: 13.0
        h("a_DB3[0].soma { syn_NC_DB3_MDR12_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDR12[0].soma { syn_NC_DB3_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_DB3[0].soma { syn_NC_DB3_MDR12_Acetylcholine_silent_pre[0].weight = 13.0 }")
        h("a_MDR12[0].soma { syn_NC_DB3_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 13.0 }")
        h("setpointer syn_NC_DB3_MDR12_Acetylcholine_silent_pre[0].vpeer, a_MDR12[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDR13_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")
        ...
        h("a_MDR13[0].soma { syn_NC_DB3_MDR13_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("setpointer syn_NC_DB3_MDR13_Acetylcholine_silent_pre[0].vpeer, a_MDR13[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDR13_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        # ######################   File to save: c302_C2_AS4_DA3_DB3.muscles.dat (muscles_v)
        ...
        # ######################   File to save: c302_C2_AS4_DA3_DB3.muscles.activity.dat (muscles_activity)
    ...
    def save_results(self):
        ...
        f_muscles_v_f2 = open('c302_C2_AS4_DA3_DB3.muscles.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: c302_C2_AS4_DA3_DB3.muscles.dat")
        ...
        f_muscles_activity_f2 = open('c302_C2_AS4_DA3_DB3.muscles.activity.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: c302_C2_AS4_DA3_DB3.muscles.activity.dat")
