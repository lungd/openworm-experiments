...
Components:
    ...
    AVAL_to_AS4_exc_syn (Type: gradedSynapse:  conductance=3.2000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    AVAR_to_AS4_exc_syn (Type: gradedSynapse:  conductance=3.2000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
