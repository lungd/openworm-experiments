...
Components:
    ...
    AVBL_to_DB3_elec_syn (Type: gapJunction:  conductance=1.0520000000000001E-11 (SI conductance))
    AVBR_to_DB3_elec_syn (Type: gapJunction:  conductance=1.0520000000000001E-11 (SI conductance))
    neuron_to_neuron_elec_syn (Type: gapJunction:  conductance=1.252E-11 (SI conductance))
    AS4_to_DA3_elec_syn (Type: gapJunction:  conductance=1.2000000000000002E-13 (SI conductance))
