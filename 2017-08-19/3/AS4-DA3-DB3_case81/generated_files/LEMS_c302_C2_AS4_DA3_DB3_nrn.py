...
Components:
    ...
    AVBL_to_DB3_elec_syn (Type: gapJunction:  conductance=2.0200000000000003E-12 (SI conductance))
    AVBR_to_DB3_elec_syn (Type: gapJunction:  conductance=2.0200000000000003E-12 (SI conductance))
    ...
    DB3_to_AVBL_elec_syn (Type: gapJunction:  conductance=2.0200000000000003E-12 (SI conductance))
    DB3_to_AVBR_elec_syn (Type: gapJunction:  conductance=2.0200000000000003E-12 (SI conductance))
    silent (Type: silentSynapse)
    AVAL_to_DA3_exc_syn (Type: gradedSynapse:  conductance=1.0000000000000002E-13 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    AVAR_to_DA3_exc_syn (Type: gradedSynapse:  conductance=1.0000000000000002E-13 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=2.7E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AS4_to_DA3_exc_syn (Type: gradedSynapse:  conductance=3.5000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    stim_AVAL_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=2.0E-12 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=2.0E-12 (SI current))
