...
Components:
    ...
    AVAL_to_DA3_exc_syn (Type: gradedSynapse:  conductance=1.0E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    AVAR_to_DA3_exc_syn (Type: gradedSynapse:  conductance=1.0E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=1.7000000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AS4_to_DA3_exc_syn (Type: gradedSynapse:  conductance=3.1000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
