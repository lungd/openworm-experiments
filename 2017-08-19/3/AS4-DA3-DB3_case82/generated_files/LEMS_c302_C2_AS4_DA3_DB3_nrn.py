...
Components:
    ...
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=7.0E-10 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
