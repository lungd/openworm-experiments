...
Components:
    ...
    neuron_to_neuron_exc_syn (Type: gradedSynapse:  conductance=4.2E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    DA3_to_DB3_exc_syn (Type: gradedSynapse:  conductance=3.0000000000000004E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    stim_AVAL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=1.9000000000000001 (SI time) amplitude=2.0E-12 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=1.9000000000000001 (SI time) amplitude=2.0E-12 (SI current))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_A[1]")
        h("objectvar syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAL[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma], weight: 6.0
        h("a_AVAL[0].soma { syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_A[0] = new neuron_to_neuron_elec_syn(0.5) }")
        h("a_DA3[0].soma { syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_B[0] = new neuron_to_neuron_elec_syn(0.5) }")
        h("a_AVAL[0].soma { syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 6.0 }")
        h("a_DA3[0].soma { syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 6.0 }")
        h("setpointer syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_A[0].vpeer, a_DA3[0].soma.v(0.5)")
        h("setpointer syn_NC_AVAL_DA3_Generic_GJ_neuron_to_neuron_elec_syn_B[0].vpeer, a_AVAL[0].soma.v(0.5)")
        ...
        h("a_AVAR[0].soma { syn_NC_AVAR_DA3_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 7.0 }")
        h("a_DA3[0].soma { syn_NC_AVAR_DA3_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 7.0 }")
        ...
        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma], weight: 4.0
        ...
        h("a_DA3[0].soma { syn_NC_DA3_AS4_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 4.0 }")
        h("a_AS4[0].soma { syn_NC_DA3_AS4_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 4.0 }")
        ...
        h("a_AS4[0].soma { syn_NC_AS4_DA3_Generic_GJ_neuron_to_neuron_elec_syn_A[0].weight = 4.0 }")
        h("a_DA3[0].soma { syn_NC_AS4_DA3_Generic_GJ_neuron_to_neuron_elec_syn_B[0].weight = 4.0 }")
        ...
        h("objectvar syn_NC_AVAL_AVBL_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_AVBL[0].soma { syn_NC_AVAL_AVBL_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_AVAL[0].soma { syn_NC_AVAL_AVBL_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_AVBL[0].soma { syn_NC_AVAL_AVBL_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_AVAL_AVBL_Acetylcholine_silent_pre[0].vpeer, a_AVBL[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAL_AVBL_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_AVAL[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVAR_AVBL_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_AVBL[0].soma { syn_NC_AVAR_AVBL_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_AVBL_Acetylcholine_silent_pre[0].weight = 3.0 }")
        h("a_AVBL[0].soma { syn_NC_AVAR_AVBL_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 3.0 }")
        h("setpointer syn_NC_AVAR_AVBL_Acetylcholine_silent_pre[0].vpeer, a_AVBL[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAR_AVBL_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_AVAR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVAR_AVBR_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_AVBR[0].soma { syn_NC_AVAR_AVBR_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_AVBR_Acetylcholine_silent_pre[0].weight = 4.0 }")
        h("a_AVBR[0].soma { syn_NC_AVAR_AVBR_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 4.0 }")
        h("setpointer syn_NC_AVAR_AVBR_Acetylcholine_silent_pre[0].vpeer, a_AVBR[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAR_AVBR_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_AVAR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVAR_DB3_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVAR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_DB3[0].soma], weight: 2.0
        h("a_AVAR[0].soma { syn_NC_AVAR_DB3_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_DB3[0].soma { syn_NC_AVAR_DB3_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_AVAR[0].soma { syn_NC_AVAR_DB3_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_DB3[0].soma { syn_NC_AVAR_DB3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_AVAR_DB3_Acetylcholine_silent_pre[0].vpeer, a_DB3[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVAR_DB3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AVAR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBL_AVAL_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_AVAL[0].soma { syn_NC_AVBL_AVAL_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_AVBL[0].soma { syn_NC_AVBL_AVAL_Acetylcholine_silent_pre[0].weight = 9.0 }")
        h("a_AVAL[0].soma { syn_NC_AVBL_AVAL_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 9.0 }")
        h("setpointer syn_NC_AVBL_AVAL_Acetylcholine_silent_pre[0].vpeer, a_AVAL[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBL_AVAL_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_AVBL[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBL_AVAR_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_AVAR[0].soma { syn_NC_AVBL_AVAR_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_AVBL[0].soma { syn_NC_AVBL_AVAR_Acetylcholine_silent_pre[0].weight = 14.0 }")
        h("a_AVAR[0].soma { syn_NC_AVBL_AVAR_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 14.0 }")
        h("setpointer syn_NC_AVBL_AVAR_Acetylcholine_silent_pre[0].vpeer, a_AVAR[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBL_AVAR_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_AVBL[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBL_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")
        ...
        h("a_AS4[0].soma { syn_NC_AVBL_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("setpointer syn_NC_AVBL_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBL_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AVBL[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBR_AVAL_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_AVAL[0].soma { syn_NC_AVBR_AVAL_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_AVBR[0].soma { syn_NC_AVBR_AVAL_Acetylcholine_silent_pre[0].weight = 10.0 }")
        h("a_AVAL[0].soma { syn_NC_AVBR_AVAL_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 10.0 }")
        h("setpointer syn_NC_AVBR_AVAL_Acetylcholine_silent_pre[0].vpeer, a_AVAL[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBR_AVAL_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_AVBR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBR_AVAR_Acetylcholine_neuron_to_neuron_inh_syn_post[1]")
        ...
        h("a_AVAR[0].soma { syn_NC_AVBR_AVAR_Acetylcholine_neuron_to_neuron_inh_syn_post[0] = new neuron_to_neuron_inh_syn(0.500000) }")
        h("a_AVBR[0].soma { syn_NC_AVBR_AVAR_Acetylcholine_silent_pre[0].weight = 14.0 }")
        h("a_AVAR[0].soma { syn_NC_AVBR_AVAR_Acetylcholine_neuron_to_neuron_inh_syn_post[0].weight = 14.0 }")
        h("setpointer syn_NC_AVBR_AVAR_Acetylcholine_silent_pre[0].vpeer, a_AVAR[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBR_AVAR_Acetylcholine_neuron_to_neuron_inh_syn_post[0].vpeer, a_AVBR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBR_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AVBR[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma], weight: 3.0
        h("a_AVBR[0].soma { syn_NC_AVBR_DA3_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_DA3[0].soma { syn_NC_AVBR_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_AVBR[0].soma { syn_NC_AVBR_DA3_Acetylcholine_silent_pre[0].weight = 3.0 }")
        h("a_DA3[0].soma { syn_NC_AVBR_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 3.0 }")
        h("setpointer syn_NC_AVBR_DA3_Acetylcholine_silent_pre[0].vpeer, a_DA3[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBR_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AVBR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBR_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")
        ...
        h("a_AS4[0].soma { syn_NC_AVBR_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("setpointer syn_NC_AVBR_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBR_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AVBR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DA3_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_DA3[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma], weight: 2.0
        h("a_DA3[0].soma { syn_NC_DA3_AS4_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_AS4[0].soma { syn_NC_DA3_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_AS4_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_AS4[0].soma { syn_NC_DA3_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_DA3_AS4_Acetylcholine_silent_pre[0].vpeer, a_AS4[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_AS4_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AS4_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")
        ...
        h("a_DA3[0].soma { syn_NC_AS4_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AS4_DA3_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_DA3[0].soma { syn_NC_AS4_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_AS4_DA3_Acetylcholine_silent_pre[0].vpeer, a_DA3[0].soma.v(0.500000)")
        h("setpointer syn_NC_AS4_DA3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_AS4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AVBR_MVL16_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")
        ...
        h("a_MVL16[0].soma { syn_NC_AVBR_MVL16_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("setpointer syn_NC_AVBR_MVL16_Acetylcholine_silent_pre[0].vpeer, a_MVL16[0].soma.v(0.500000)")
        h("setpointer syn_NC_AVBR_MVL16_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_AVBR[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AS4_MDL10_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL10[0].soma], weight: 5.0
        h("a_AS4[0].soma { syn_NC_AS4_MDL10_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDL10[0].soma { syn_NC_AS4_MDL10_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AS4_MDL10_Acetylcholine_silent_pre[0].weight = 5.0 }")
        h("a_MDL10[0].soma { syn_NC_AS4_MDL10_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 5.0 }")
        h("setpointer syn_NC_AS4_MDL10_Acetylcholine_silent_pre[0].vpeer, a_MDL10[0].soma.v(0.500000)")
        h("setpointer syn_NC_AS4_MDL10_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_AS4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AS4_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma], weight: 5.0
        h("a_AS4[0].soma { syn_NC_AS4_MDL11_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDL11[0].soma { syn_NC_AS4_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AS4_MDL11_Acetylcholine_silent_pre[0].weight = 5.0 }")
        h("a_MDL11[0].soma { syn_NC_AS4_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 5.0 }")
        h("setpointer syn_NC_AS4_MDL11_Acetylcholine_silent_pre[0].vpeer, a_MDL11[0].soma.v(0.500000)")
        h("setpointer syn_NC_AS4_MDL11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_AS4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AS4_MDL12_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma], weight: 2.0
        h("a_AS4[0].soma { syn_NC_AS4_MDL12_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDL12[0].soma { syn_NC_AS4_MDL12_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AS4_MDL12_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_MDL12[0].soma { syn_NC_AS4_MDL12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_AS4_MDL12_Acetylcholine_silent_pre[0].vpeer, a_MDL12[0].soma.v(0.500000)")
        h("setpointer syn_NC_AS4_MDL12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_AS4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AS4_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma], weight: 4.0
        h("a_AS4[0].soma { syn_NC_AS4_MDR11_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDR11[0].soma { syn_NC_AS4_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AS4_MDR11_Acetylcholine_silent_pre[0].weight = 4.0 }")
        h("a_MDR11[0].soma { syn_NC_AS4_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 4.0 }")
        h("setpointer syn_NC_AS4_MDR11_Acetylcholine_silent_pre[0].vpeer, a_MDR11[0].soma.v(0.500000)")
        h("setpointer syn_NC_AS4_MDR11_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_AS4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_AS4_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[1]")

        # Continuous Connection 0: cell 0, seg 0 (0.5) [0.5 on a_AS4[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma], weight: 5.0
        h("a_AS4[0].soma { syn_NC_AS4_MDR12_Acetylcholine_silent_pre[0] = new silent(0.500000) }")
        h("a_MDR12[0].soma { syn_NC_AS4_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0] = new neuron_to_muscle_exc_syn(0.500000) }")
        h("a_AS4[0].soma { syn_NC_AS4_MDR12_Acetylcholine_silent_pre[0].weight = 5.0 }")
        h("a_MDR12[0].soma { syn_NC_AS4_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].weight = 5.0 }")
        h("setpointer syn_NC_AS4_MDR12_Acetylcholine_silent_pre[0].vpeer, a_MDR12[0].soma.v(0.500000)")
        h("setpointer syn_NC_AS4_MDR12_Acetylcholine_neuron_to_muscle_exc_syn_post[0].vpeer, a_AS4[0].soma.v(0.500000)")
