...
Components:
    ...
    stim_AVAL_1 (Type: pulseGenerator:  delay=0.7000000000000001 (SI time) duration=1.5 (SI time) amplitude=2.5E-12 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=0.7000000000000001 (SI time) duration=1.5 (SI time) amplitude=2.5E-12 (SI current))
