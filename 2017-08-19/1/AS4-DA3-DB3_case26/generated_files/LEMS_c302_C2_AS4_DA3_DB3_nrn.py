...
Components:
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.0 (SI time) duration=1.0 (SI time) amplitude=2.0E-12 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.0 (SI time) duration=1.0 (SI time) amplitude=2.0E-12 (SI current))
    stim_AVAL_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=2.5E-12 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=2.5E-12 (SI current))
    stim_AVBL_2 (Type: pulseGenerator:  delay=2.0 (SI time) duration=0.9 (SI time) amplitude=2.0E-12 (SI current))
    stim_AVBR_2 (Type: pulseGenerator:  delay=2.0 (SI time) duration=0.9 (SI time) amplitude=2.0E-12 (SI current))
