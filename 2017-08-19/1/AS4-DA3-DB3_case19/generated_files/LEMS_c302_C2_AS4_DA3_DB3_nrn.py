...
Components:
    ...
    AVAL_to_AVBL_inh_syn (Type: gradedSynapse:  conductance=5.7000000000000006E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    ...
    AVAR_to_AVBL_inh_syn (Type: gradedSynapse:  conductance=5.7000000000000006E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVAR_to_AVBR_inh_syn (Type: gradedSynapse:  conductance=5.7000000000000006E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.7000000000000001 (SI time) amplitude=1.0E-12 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.7000000000000001 (SI time) amplitude=1.0E-12 (SI current))
    stim_AVAL_1 (Type: pulseGenerator:  delay=0.7000000000000001 (SI time) duration=1.5 (SI time) amplitude=1.5E-12 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=0.7000000000000001 (SI time) duration=1.5 (SI time) amplitude=1.5E-12 (SI current))
    stim_AVBL_2 (Type: pulseGenerator:  delay=1.5 (SI time) duration=1.9000000000000001 (SI time) amplitude=1.0E-12 (SI current))
    stim_AVBR_2 (Type: pulseGenerator:  delay=1.5 (SI time) duration=1.9000000000000001 (SI time) amplitude=1.0E-12 (SI current))
