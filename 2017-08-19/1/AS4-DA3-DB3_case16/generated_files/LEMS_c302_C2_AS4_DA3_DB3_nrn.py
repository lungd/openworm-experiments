...
Components:
    ...
    AVAR_to_AVBL_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    AVBL_to_AVAR_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    ...
    AVBL_to_AVAL_inh_syn (Type: gradedSynapse:  conductance=4.2E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBL_to_AVAR_inh_syn (Type: gradedSynapse:  conductance=4.2E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBR_to_AVAL_inh_syn (Type: gradedSynapse:  conductance=4.2E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBR_to_AVAR_inh_syn (Type: gradedSynapse:  conductance=4.2E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
