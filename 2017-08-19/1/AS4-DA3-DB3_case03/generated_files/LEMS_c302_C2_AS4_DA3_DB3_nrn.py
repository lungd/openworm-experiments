...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        h("objectvar syn_NC_DA3_DB3_Acetylcholine_neuron_to_neuron_exc_syn_post[1]")
        ...
        h("a_DB3[0].soma { syn_NC_DA3_DB3_Acetylcholine_neuron_to_neuron_exc_syn_post[0] = new neuron_to_neuron_exc_syn(0.500000) }")
        h("a_DA3[0].soma { syn_NC_DA3_DB3_Acetylcholine_silent_pre[0].weight = 2.0 }")
        h("a_DB3[0].soma { syn_NC_DA3_DB3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].weight = 2.0 }")
        h("setpointer syn_NC_DA3_DB3_Acetylcholine_silent_pre[0].vpeer, a_DB3[0].soma.v(0.500000)")
        h("setpointer syn_NC_DA3_DB3_Acetylcholine_neuron_to_neuron_exc_syn_post[0].vpeer, a_DA3[0].soma.v(0.500000)")
