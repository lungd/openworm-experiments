...
Components:
    ...
    AVBL_to_DB3_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    AVBR_to_DB3_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    ...
    DB3_to_AVBL_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    DB3_to_AVBR_elec_syn (Type: gapJunction:  conductance=2.52E-12 (SI conductance))
    ...
    AVAL_to_DA3_exc_syn (Type: gradedSynapse:  conductance=1.0000000000000002E-12 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    AVAR_to_DA3_exc_syn (Type: gradedSynapse:  conductance=1.0000000000000002E-12 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    DA3_to_DB3_exc_syn (Type: gradedSynapse:  conductance=1.2E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=1.0E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AS4_to_DA3_exc_syn (Type: gradedSynapse:  conductance=1.8000000000000002E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.0 (SI time) duration=1.0 (SI time) amplitude=1.0E-11 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.0 (SI time) duration=1.0 (SI time) amplitude=1.0E-11 (SI current))
    stim_AVAL_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=1.0E-11 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=1.0E-11 (SI current))
    stim_AVBL_2 (Type: pulseGenerator:  delay=2.0 (SI time) duration=0.9 (SI time) amplitude=1.0E-11 (SI current))
    stim_AVBR_2 (Type: pulseGenerator:  delay=2.0 (SI time) duration=0.9 (SI time) amplitude=1.0E-11 (SI current))
    stim_AS4_1 (Type: pulseGenerator:  delay=0.0 (SI time) duration=2.9 (SI time) amplitude=3.0E-12 (SI current))
