...
Components:
    ...
    DA3_to_DB3_exc_syn (Type: gradedSynapse:  conductance=5.0E-10 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
