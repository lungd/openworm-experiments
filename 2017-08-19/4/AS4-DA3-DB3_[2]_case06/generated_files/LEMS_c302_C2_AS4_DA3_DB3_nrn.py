...
Components:
    ...
    AVAL_to_DA3_elec_syn (Type: gapJunction:  conductance=1.5200000000000002E-12 (SI conductance))
    AVAR_to_DA3_elec_syn (Type: gapJunction:  conductance=1.5200000000000002E-12 (SI conductance))
    AVBL_to_DB3_elec_syn (Type: gapJunction:  conductance=1.5200000000000002E-12 (SI conductance))
    AVBR_to_DB3_elec_syn (Type: gapJunction:  conductance=1.5200000000000002E-12 (SI conductance))
    DA3_to_AVAL_elec_syn (Type: gapJunction:  conductance=1.5200000000000002E-12 (SI conductance))
    DA3_to_AVAR_elec_syn (Type: gapJunction:  conductance=1.5200000000000002E-12 (SI conductance))
    DB3_to_AVBL_elec_syn (Type: gapJunction:  conductance=1.5200000000000002E-12 (SI conductance))
    DB3_to_AVBR_elec_syn (Type: gapJunction:  conductance=1.5200000000000002E-12 (SI conductance))
    ...
    AVAL_to_AVBL_inh_syn (Type: gradedSynapse:  conductance=9.0E-12 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    ...
    AVAR_to_AVBL_inh_syn (Type: gradedSynapse:  conductance=9.0E-12 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVAR_to_AVBR_inh_syn (Type: gradedSynapse:  conductance=9.0E-12 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    ...
    AVBL_to_AVAL_inh_syn (Type: gradedSynapse:  conductance=9.0E-12 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBL_to_AVAR_inh_syn (Type: gradedSynapse:  conductance=9.0E-12 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBR_to_AVAL_inh_syn (Type: gradedSynapse:  conductance=9.0E-12 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AVBR_to_AVAR_inh_syn (Type: gradedSynapse:  conductance=9.0E-12 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    DA3_to_DB3_exc_syn (Type: gradedSynapse:  conductance=1.0E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=1.2E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    AS4_to_DA3_exc_syn (Type: gradedSynapse:  conductance=1.5000000000000002E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
