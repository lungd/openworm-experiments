...
Components:
    ...
    stim_AVAL_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=7.0E-12 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=1.0 (SI time) duration=1.0 (SI time) amplitude=7.0E-12 (SI current))
