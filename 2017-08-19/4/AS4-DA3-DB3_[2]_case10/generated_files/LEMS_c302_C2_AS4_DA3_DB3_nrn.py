...
Components:
    ...
    AVBL_to_DB3_elec_syn (Type: gapJunction:  conductance=4.52E-12 (SI conductance))
    AVBR_to_DB3_elec_syn (Type: gapJunction:  conductance=4.52E-12 (SI conductance))
    ...
    DB3_to_AVBL_elec_syn (Type: gapJunction:  conductance=4.52E-12 (SI conductance))
    DB3_to_AVBR_elec_syn (Type: gapJunction:  conductance=4.52E-12 (SI conductance))
    ...
    DA3_to_DB3_exc_syn (Type: gradedSynapse:  conductance=7.000000000000002E-11 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=8.000000000000001E-10 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
