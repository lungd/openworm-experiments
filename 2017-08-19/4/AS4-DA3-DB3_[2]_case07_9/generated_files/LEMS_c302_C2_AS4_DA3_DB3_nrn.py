...
Components:
    ...
    DA3_to_DB3_exc_syn (Type: gradedSynapse:  conductance=1.5000000000000002E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    stim_AS4_1 (Type: pulseGenerator:  delay=0.0 (SI time) duration=2.9 (SI time) amplitude=1.0E-11 (SI current))
