...
Components:
    ...
    DB3_to_AS4_inh_syn (Type: gradedSynapse:  conductance=3.0000000000000004E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
