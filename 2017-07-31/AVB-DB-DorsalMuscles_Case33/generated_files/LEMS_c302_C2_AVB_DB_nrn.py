...
Components:
    ...
    DB6_to_MDL20_exc_syn_2conns (Type: gradedSynapse:  conductance=2.52E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
