...
Components:
    ...
    DB6_to_AVBL_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.59356419388E-12 (SI conductance) sigma=540.309304721 (SI per_voltage) mu=-0.0262192802886 (SI voltage))
    DB6_to_AVBR_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=4.9908400056400004E-11 (SI conductance) sigma=128.433033088 (SI per_voltage) mu=-0.00518875443492 (SI voltage))
    ...
    DB7_to_AVBL_elec_syn_13conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.9109395875400004E-10 (SI conductance) sigma=733.655913612 (SI per_voltage) mu=-0.0642515469934 (SI voltage))
    DB7_to_AVBR_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=7.74182495472E-12 (SI conductance) sigma=386.916730813 (SI per_voltage) mu=8.969391093450001E-5 (SI voltage))
