...
Components:
    ...
    AVBL_to_DB6_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.41247522585E-11 (SI conductance) sigma=540.309304721 (SI per_voltage) mu=-0.0262192802886 (SI voltage))
