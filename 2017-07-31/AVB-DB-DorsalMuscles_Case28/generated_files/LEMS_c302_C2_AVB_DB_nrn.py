...
Components:
    ...
    DB3_to_MDL14_exc_syn_1conns (Type: gradedSynapse:  conductance=1.25E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB4_to_MDL15_exc_syn_3conns (Type: gradedSynapse:  conductance=2.34E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB7_to_MDL23_exc_syn_2conns (Type: gradedSynapse:  conductance=5.0E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
