...
Components:
    ...
    AVBL_to_DB7_elec_syn_13conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=7.00939587543E-11 (SI conductance) sigma=533.6559136120001 (SI per_voltage) mu=-0.0542515469934 (SI voltage))
    ...
    DB7_to_AVBL_elec_syn_13conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=3.10939587543E-11 (SI conductance) sigma=533.6559136120001 (SI per_voltage) mu=-0.0542515469934 (SI voltage))
    DB7_to_AVBR_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=4.74182495472E-12 (SI conductance) sigma=386.916730813 (SI per_voltage) mu=8.969391093450001E-5 (SI voltage))
