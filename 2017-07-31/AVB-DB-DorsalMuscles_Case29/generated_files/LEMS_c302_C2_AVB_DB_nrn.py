...
Components:
    ...
    DB2_to_MDL11_exc_syn_5conns (Type: gradedSynapse:  conductance=3.5E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB3_to_MDL14_exc_syn_1conns (Type: gradedSynapse:  conductance=1.3500000000000002E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB4_to_MDL16_exc_syn_3conns (Type: gradedSynapse:  conductance=1.3500000000000002E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB7_to_MDL23_exc_syn_2conns (Type: gradedSynapse:  conductance=4.8E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
