...
Components:
    ...
    DB4_to_MDL14_exc_syn_1conns (Type: gradedSynapse:  conductance=8.500000000000002E-11 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB6_to_MDL19_exc_syn_2conns (Type: gradedSynapse:  conductance=1.5200000000000002E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
