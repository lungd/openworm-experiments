...
Components:
    ...
    CASE2AVB_DB (Type: network)
    sim_CASE2AVB_DB (Type: Simulation:  length=1.0 (SI time) step=5.0E-5 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        '''
        Adding simulation Component(id=sim_CASE2AVB_DB type=Simulation) of network/component: CASE2AVB_DB (Type: network)
        ...
        # ######################   File to save: CASE2AVB_DB.activity.dat (neurons_activity)
        ...
        # ######################   File to save: CASE2AVB_DB.muscles.dat (muscles_v)
        ...
        # ######################   File to save: CASE2AVB_DB.muscles.activity.dat (muscles_activity)
        ...
        # ######################   File to save: CASE2AVB_DB.dat (neurons_v)
    ...
    def save_results(self):
        ...
        f_neurons_activity_f2 = open('CASE2AVB_DB.activity.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE2AVB_DB.activity.dat")
        ...
        f_muscles_v_f2 = open('CASE2AVB_DB.muscles.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE2AVB_DB.muscles.dat")
        ...
        f_muscles_activity_f2 = open('CASE2AVB_DB.muscles.activity.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE2AVB_DB.muscles.activity.dat")
        ...
        f_neurons_v_f2 = open('CASE2AVB_DB.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE2AVB_DB.dat")
