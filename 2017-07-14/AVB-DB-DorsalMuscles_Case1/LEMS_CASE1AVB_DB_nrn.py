...
Components:
    ...
    AVBL_to_DB2_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.34989138102E-10 (SI conductance) sigma=786.057776926 (SI per_voltage) mu=-0.0434989886627 (SI voltage))
    AVBL_to_DB3_elec_syn_9conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=4.93047731157E-10 (SI conductance) sigma=478.356327192 (SI per_voltage) mu=-0.0322070559644 (SI voltage))
    AVBL_to_DB4_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.9230686951600002E-10 (SI conductance) sigma=270.77841973200003 (SI per_voltage) mu=-0.0594949709473 (SI voltage))
    AVBL_to_DB5_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=8.208978306120001E-11 (SI conductance) sigma=567.561165677 (SI per_voltage) mu=-0.0142569307878 (SI voltage))
    AVBL_to_DB6_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=3.57127037951E-11 (SI conductance) sigma=342.00926990000005 (SI per_voltage) mu=-0.0130021378441 (SI voltage))
    AVBL_to_DB7_elec_syn_13conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.59236664033E-10 (SI conductance) sigma=575.972397973 (SI per_voltage) mu=-0.0401355664045 (SI voltage))
    AVBR_to_DB1_elec_syn_15conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=7.88905403637E-10 (SI conductance) sigma=570.249184192 (SI per_voltage) mu=-0.0589540180758 (SI voltage))
    AVBR_to_DB2_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.56E-12 (SI conductance) sigma=271.088858135 (SI per_voltage) mu=-0.0359195178106 (SI voltage))
    AVBR_to_DB3_elec_syn_2conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=9.316786671200001E-11 (SI conductance) sigma=639.6203804400001 (SI per_voltage) mu=-0.014371728822 (SI voltage))
    AVBR_to_DB4_elec_syn_5conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=3.93439476897E-11 (SI conductance) sigma=652.8834136840001 (SI per_voltage) mu=-0.0342826627887 (SI voltage))
    AVBR_to_DB5_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.1671586816000002E-10 (SI conductance) sigma=254.602598501 (SI per_voltage) mu=-0.0599573554467 (SI voltage))
    AVBR_to_DB6_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=9.928452481860002E-11 (SI conductance) sigma=900.0 (SI per_voltage) mu=-0.059383886331900004 (SI voltage))
    AVBR_to_DB7_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.2461491717200002E-10 (SI conductance) sigma=900.0 (SI per_voltage) mu=-0.0113022189598 (SI voltage))
    DB1_to_AVBR_elec_syn_15conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=6.689403206580001E-10 (SI conductance) sigma=526.594070017 (SI per_voltage) mu=-0.0209535532397 (SI voltage))
    DB1_to_DB2_elec_syn_5conns (Type: gapJunction:  conductance=5.6874805137000007E-11 (SI conductance))
    DB2_to_AVBL_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.3652939972E-10 (SI conductance) sigma=865.678122313 (SI per_voltage) mu=-0.0563007540542 (SI voltage))
    DB2_to_AVBR_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.02819766972E-10 (SI conductance) sigma=900.0 (SI per_voltage) mu=-0.0568593238422 (SI voltage))
    DB2_to_DB1_elec_syn_5conns (Type: gapJunction:  conductance=3.128250221340001E-11 (SI conductance))
    DB2_to_DB3_elec_syn_14conns (Type: gapJunction:  conductance=3.7179519275200004E-10 (SI conductance))
    DB3_to_AVBL_elec_syn_9conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=3.1265767969000004E-10 (SI conductance) sigma=272.068562218 (SI per_voltage) mu=-0.0598384987081 (SI voltage))
    DB3_to_AVBR_elec_syn_2conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=6.5422150618E-11 (SI conductance) sigma=257.477621158 (SI per_voltage) mu=-0.0329834172286 (SI voltage))
    DB3_to_DB2_elec_syn_14conns (Type: gapJunction:  conductance=2.7999999999999997E-13 (SI conductance))
    DB3_to_DB4_elec_syn_1conns (Type: gapJunction:  conductance=3.502299205670001E-11 (SI conductance))
    DB4_to_AVBL_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.97258486514E-10 (SI conductance) sigma=507.160954111 (SI per_voltage) mu=-0.0010728559691099999 (SI voltage))
    DB4_to_AVBR_elec_syn_5conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=3.598655926710001E-11 (SI conductance) sigma=868.401293844 (SI per_voltage) mu=-0.038634234191399996 (SI voltage))
    DB4_to_DB3_elec_syn_1conns (Type: gapJunction:  conductance=2.0000000000000003E-14 (SI conductance))
    DB4_to_DB5_elec_syn_5conns (Type: gapJunction:  conductance=1.0000000000000002E-13 (SI conductance))
    DB5_to_AVBL_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.8756000000000002E-10 (SI conductance) sigma=278.72466943399996 (SI per_voltage) mu=-0.0277093673228 (SI voltage))
    DB5_to_AVBR_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.60771683251E-10 (SI conductance) sigma=650.104083431 (SI per_voltage) mu=-0.0371210962258 (SI voltage))
    DB5_to_DB4_elec_syn_5conns (Type: gapJunction:  conductance=9.374897910700001E-11 (SI conductance))
    DB5_to_DB6_elec_syn_5conns (Type: gapJunction:  conductance=2.1260000000000002E-10 (SI conductance))
    DB6_to_AVBL_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.56E-12 (SI conductance) sigma=413.40446737300005 (SI per_voltage) mu=-0.0435335422061 (SI voltage))
    DB6_to_AVBR_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.08E-12 (SI conductance) sigma=100.0 (SI per_voltage) mu=-0.0477778469512 (SI voltage))
    DB6_to_DB5_elec_syn_5conns (Type: gapJunction:  conductance=9.352151144050001E-11 (SI conductance))
    DB6_to_DB7_elec_syn_5conns (Type: gapJunction:  conductance=1.72548869607E-10 (SI conductance))
    DB7_to_AVBL_elec_syn_13conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=5.82744574672E-10 (SI conductance) sigma=449.37370705300003 (SI per_voltage) mu=-0.0609334731408 (SI voltage))
    DB7_to_AVBR_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.56E-12 (SI conductance) sigma=100.0 (SI per_voltage) mu=-0.0450289218951 (SI voltage))
    DB7_to_DB6_elec_syn_5conns (Type: gapJunction:  conductance=3.16824968362E-11 (SI conductance))
    muscle_to_muscle_elec_syn_15conns (Type: gapJunction:  conductance=0.0 (SI conductance))
    MDL06_to_MDL07_elec_syn_15conns (Type: gapJunction:  conductance=5.6372635746800005E-12 (SI conductance))
    MDL07_to_MDL06_elec_syn_15conns (Type: gapJunction:  conductance=1.45565339109E-12 (SI conductance))
    MDL08_to_MDL09_elec_syn_15conns (Type: gapJunction:  conductance=2.78680930791E-12 (SI conductance))
    MDL09_to_MDL08_elec_syn_15conns (Type: gapJunction:  conductance=6.0890161839000006E-12 (SI conductance))
    MDL10_to_MDL11_elec_syn_15conns (Type: gapJunction:  conductance=7.5E-12 (SI conductance))
    MDL11_to_MDL10_elec_syn_15conns (Type: gapJunction:  conductance=2.8356843985900004E-12 (SI conductance))
    MDL11_to_MDL12_elec_syn_15conns (Type: gapJunction:  conductance=3.72635086442E-12 (SI conductance))
    MDL12_to_MDL11_elec_syn_15conns (Type: gapJunction:  conductance=2.99219714296E-12 (SI conductance))
    MDL12_to_MDL13_elec_syn_15conns (Type: gapJunction:  conductance=6.9394746433500006E-12 (SI conductance))
    MDL13_to_MDL12_elec_syn_15conns (Type: gapJunction:  conductance=6.11236746585E-12 (SI conductance))
    MDL13_to_MDL14_elec_syn_15conns (Type: gapJunction:  conductance=2.2990810577100004E-12 (SI conductance))
    MDL14_to_MDL13_elec_syn_15conns (Type: gapJunction:  conductance=4.69179386492E-12 (SI conductance))
    MDL14_to_MDL15_elec_syn_15conns (Type: gapJunction:  conductance=7.5E-12 (SI conductance))
    MDL15_to_MDL14_elec_syn_15conns (Type: gapJunction:  conductance=4.0995187473600005E-12 (SI conductance))
    MDL15_to_MDL16_elec_syn_15conns (Type: gapJunction:  conductance=6.5645280967200005E-12 (SI conductance))
    MDL16_to_MDL15_elec_syn_15conns (Type: gapJunction:  conductance=3.07276659819E-12 (SI conductance))
    MDL16_to_MDL17_elec_syn_15conns (Type: gapJunction:  conductance=2.95759113315E-12 (SI conductance))
    MDL17_to_MDL16_elec_syn_15conns (Type: gapJunction:  conductance=2.1556178789900002E-12 (SI conductance))
    MDL17_to_MDL18_elec_syn_15conns (Type: gapJunction:  conductance=1.0375709297300002E-12 (SI conductance))
    MDL18_to_MDL17_elec_syn_15conns (Type: gapJunction:  conductance=6.4956562359000005E-12 (SI conductance))
    MDL18_to_MDL19_elec_syn_15conns (Type: gapJunction:  conductance=5.8213907946E-12 (SI conductance))
    MDL19_to_MDL18_elec_syn_15conns (Type: gapJunction:  conductance=4.588566867590001E-12 (SI conductance))
    MDL20_to_MDL21_elec_syn_15conns (Type: gapJunction:  conductance=3.97177235668E-12 (SI conductance))
    MDL21_to_MDL20_elec_syn_15conns (Type: gapJunction:  conductance=2.3078967814700004E-12 (SI conductance))
    MDL22_to_MDL23_elec_syn_15conns (Type: gapJunction:  conductance=3.02975593236E-12 (SI conductance))
    MDL23_to_MDL22_elec_syn_15conns (Type: gapJunction:  conductance=3.0E-13 (SI conductance))
    MDR08_to_MDR09_elec_syn_15conns (Type: gapJunction:  conductance=4.082582739390001E-12 (SI conductance))
    MDR09_to_MDR08_elec_syn_15conns (Type: gapJunction:  conductance=4.46793525069E-12 (SI conductance))
    MDR10_to_MDR11_elec_syn_15conns (Type: gapJunction:  conductance=1.58117408213E-12 (SI conductance))
    MDR11_to_MDR10_elec_syn_15conns (Type: gapJunction:  conductance=7.5E-12 (SI conductance))
    MDR12_to_MDR13_elec_syn_15conns (Type: gapJunction:  conductance=2.95673475372E-12 (SI conductance))
    MDR13_to_MDR12_elec_syn_15conns (Type: gapJunction:  conductance=3.0E-13 (SI conductance))
    MDR14_to_MDR15_elec_syn_15conns (Type: gapJunction:  conductance=5.160559714680001E-12 (SI conductance))
    MDR15_to_MDR14_elec_syn_15conns (Type: gapJunction:  conductance=3.0E-13 (SI conductance))
    MDR16_to_MDR17_elec_syn_15conns (Type: gapJunction:  conductance=5.979200843080001E-12 (SI conductance))
    MDR17_to_MDR16_elec_syn_15conns (Type: gapJunction:  conductance=4.252779577350001E-12 (SI conductance))
    MDR18_to_MDR19_elec_syn_15conns (Type: gapJunction:  conductance=4.9832136702E-12 (SI conductance))
    MDR19_to_MDR18_elec_syn_15conns (Type: gapJunction:  conductance=1.7225532113100001E-12 (SI conductance))
    MDR20_to_MDR21_elec_syn_15conns (Type: gapJunction:  conductance=2.5636742261400004E-12 (SI conductance))
    MDR21_to_MDR20_elec_syn_15conns (Type: gapJunction:  conductance=3.51418863139E-12 (SI conductance))
    ...
    neuron_to_muscle_exc_syn_1conns (Type: gradedSynapse:  conductance=1.0000000000000002E-10 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB1_to_MDL06_exc_syn_3conns (Type: gradedSynapse:  conductance=3.17337541149E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB1_to_MDL08_exc_syn_3conns (Type: gradedSynapse:  conductance=4.68348236232E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB1_to_MDL09_exc_syn_6conns (Type: gradedSynapse:  conductance=2.33842111769E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB1_to_MDR08_exc_syn_6conns (Type: gradedSynapse:  conductance=7.82335754802E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB1_to_MDR09_exc_syn_2conns (Type: gradedSynapse:  conductance=2.5773258807400004E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB2_to_MDL09_exc_syn_2conns (Type: gradedSynapse:  conductance=2.38857202022E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB2_to_MDL10_exc_syn_4conns (Type: gradedSynapse:  conductance=6.030865655720001E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB2_to_MDL11_exc_syn_5conns (Type: gradedSynapse:  conductance=3.86611288104E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB2_to_MDL12_exc_syn_1conns (Type: gradedSynapse:  conductance=1.31374416531E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB2_to_MDR09_exc_syn_1conns (Type: gradedSynapse:  conductance=9.12307710335E-10 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB2_to_MDR10_exc_syn_6conns (Type: gradedSynapse:  conductance=7.573674737100001E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB2_to_MDR11_exc_syn_8conns (Type: gradedSynapse:  conductance=9.258949848400001E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB3_to_MDL11_exc_syn_6conns (Type: gradedSynapse:  conductance=1.2000000000000002E-8 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB3_to_MDL12_exc_syn_1conns (Type: gradedSynapse:  conductance=6.455836339340001E-10 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB3_to_MDL13_exc_syn_3conns (Type: gradedSynapse:  conductance=2.2332787562E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB3_to_MDL14_exc_syn_1conns (Type: gradedSynapse:  conductance=1.5704856937600002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB3_to_MDR11_exc_syn_2conns (Type: gradedSynapse:  conductance=4.0E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB3_to_MDR12_exc_syn_13conns (Type: gradedSynapse:  conductance=1.8007579923600004E-8 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB3_to_MDR13_exc_syn_1conns (Type: gradedSynapse:  conductance=1.11262479818E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB4_to_MDL13_exc_syn_4conns (Type: gradedSynapse:  conductance=5.1356497214E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB4_to_MDL14_exc_syn_1conns (Type: gradedSynapse:  conductance=1.11846871973E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB4_to_MDL15_exc_syn_3conns (Type: gradedSynapse:  conductance=1.4110831103100003E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB4_to_MDL16_exc_syn_3conns (Type: gradedSynapse:  conductance=5.743393061400001E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB4_to_MDR13_exc_syn_3conns (Type: gradedSynapse:  conductance=2.72333313627E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB4_to_MDR14_exc_syn_5conns (Type: gradedSynapse:  conductance=3.3205352413E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB4_to_MDR15_exc_syn_3conns (Type: gradedSynapse:  conductance=3.5014725052500002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB4_to_MDR16_exc_syn_3conns (Type: gradedSynapse:  conductance=4.737262500000001E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDL14_exc_syn_2conns (Type: gradedSynapse:  conductance=2.2043941266400003E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDL15_exc_syn_2conns (Type: gradedSynapse:  conductance=1.56287990244E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDL16_exc_syn_2conns (Type: gradedSynapse:  conductance=1.11000402212E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDL17_exc_syn_2conns (Type: gradedSynapse:  conductance=4.0E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDL18_exc_syn_2conns (Type: gradedSynapse:  conductance=2.8300499529399997E-10 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDL19_exc_syn_2conns (Type: gradedSynapse:  conductance=3.0531803426800005E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDR14_exc_syn_2conns (Type: gradedSynapse:  conductance=4.0E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDR15_exc_syn_2conns (Type: gradedSynapse:  conductance=2.6914100196800002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDR16_exc_syn_2conns (Type: gradedSynapse:  conductance=1.31746840133E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDR17_exc_syn_2conns (Type: gradedSynapse:  conductance=3.1229610350600003E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDR18_exc_syn_2conns (Type: gradedSynapse:  conductance=1.2231667157399999E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB5_to_MDR19_exc_syn_2conns (Type: gradedSynapse:  conductance=3.1010776964600002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDL16_exc_syn_2conns (Type: gradedSynapse:  conductance=2.27197464048E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDL17_exc_syn_2conns (Type: gradedSynapse:  conductance=1.6326521730200001E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDL18_exc_syn_2conns (Type: gradedSynapse:  conductance=2.90852794482E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDL19_exc_syn_2conns (Type: gradedSynapse:  conductance=2.28661269304E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDL20_exc_syn_2conns (Type: gradedSynapse:  conductance=1.6081546245800002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDL21_exc_syn_2conns (Type: gradedSynapse:  conductance=2.3839954592000002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDR16_exc_syn_2conns (Type: gradedSynapse:  conductance=3.89474918594E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDR17_exc_syn_2conns (Type: gradedSynapse:  conductance=8.63218455958E-10 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDR18_exc_syn_2conns (Type: gradedSynapse:  conductance=2.36992231314E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDR19_exc_syn_2conns (Type: gradedSynapse:  conductance=1.7739273703000002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDR20_exc_syn_2conns (Type: gradedSynapse:  conductance=1.27541759754E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB6_to_MDR21_exc_syn_2conns (Type: gradedSynapse:  conductance=2.9088593228600002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDL19_exc_syn_2conns (Type: gradedSynapse:  conductance=1.96898929624E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDL20_exc_syn_2conns (Type: gradedSynapse:  conductance=4.0000000000000004E-11 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDL21_exc_syn_2conns (Type: gradedSynapse:  conductance=1.4426065152000002E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDL22_exc_syn_2conns (Type: gradedSynapse:  conductance=2.01640348586E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDL23_exc_syn_2conns (Type: gradedSynapse:  conductance=7.23909812952E-10 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDL24_exc_syn_2conns (Type: gradedSynapse:  conductance=1.4635032562400003E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDR19_exc_syn_2conns (Type: gradedSynapse:  conductance=7.745512095680001E-10 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDR20_exc_syn_2conns (Type: gradedSynapse:  conductance=9.38608604228E-10 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDR21_exc_syn_2conns (Type: gradedSynapse:  conductance=1.08236188455E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDR22_exc_syn_2conns (Type: gradedSynapse:  conductance=4.0E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDR23_exc_syn_2conns (Type: gradedSynapse:  conductance=2.63046923802E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    DB7_to_MDR24_exc_syn_2conns (Type: gradedSynapse:  conductance=1.66956851037E-9 (SI conductance) delta=0.005 (SI voltage) k=1305.0 (SI per_time) Vth=0.01 (SI voltage) erev=0.02 (SI voltage))
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=0.9 (SI time) amplitude=1.5E-11 (SI current))
    CASE1AVB_DB (Type: network)
    sim_CASE1AVB_DB (Type: Simulation:  length=1.0 (SI time) step=5.0E-5 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        '''
        Adding simulation Component(id=sim_CASE1AVB_DB type=Simulation) of network/component: CASE1AVB_DB (Type: network)
        ...
        h("objectvar syn_NC_MDL06_MDL07_Generic_GJ_MDL06_to_MDL07_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL06_MDL07_Generic_GJ_MDL06_to_MDL07_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL06[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL07[0].soma], weight: 1.0
        h("a_MDL06[0].soma { syn_NC_MDL06_MDL07_Generic_GJ_MDL06_to_MDL07_elec_syn_15conns_A[0] = new MDL06_to_MDL07_elec_syn_15conns(0.5) }")
        h("a_MDL07[0].soma { syn_NC_MDL06_MDL07_Generic_GJ_MDL06_to_MDL07_elec_syn_15conns_B[0] = new MDL06_to_MDL07_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL06_MDL07_Generic_GJ_MDL06_to_MDL07_elec_syn_15conns_A[0].vpeer, a_MDL07[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL06_MDL07_Generic_GJ_MDL06_to_MDL07_elec_syn_15conns_B[0].vpeer, a_MDL06[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL07_MDL06_Generic_GJ_MDL07_to_MDL06_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL07_MDL06_Generic_GJ_MDL07_to_MDL06_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL07[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL06[0].soma], weight: 1.0
        h("a_MDL07[0].soma { syn_NC_MDL07_MDL06_Generic_GJ_MDL07_to_MDL06_elec_syn_15conns_A[0] = new MDL07_to_MDL06_elec_syn_15conns(0.5) }")
        h("a_MDL06[0].soma { syn_NC_MDL07_MDL06_Generic_GJ_MDL07_to_MDL06_elec_syn_15conns_B[0] = new MDL07_to_MDL06_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL07_MDL06_Generic_GJ_MDL07_to_MDL06_elec_syn_15conns_A[0].vpeer, a_MDL06[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL07_MDL06_Generic_GJ_MDL07_to_MDL06_elec_syn_15conns_B[0].vpeer, a_MDL07[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL08_MDL09_Generic_GJ_MDL08_to_MDL09_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL08_MDL09_Generic_GJ_MDL08_to_MDL09_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL09[0].soma], weight: 1.0
        h("a_MDL08[0].soma { syn_NC_MDL08_MDL09_Generic_GJ_MDL08_to_MDL09_elec_syn_15conns_A[0] = new MDL08_to_MDL09_elec_syn_15conns(0.5) }")
        h("a_MDL09[0].soma { syn_NC_MDL08_MDL09_Generic_GJ_MDL08_to_MDL09_elec_syn_15conns_B[0] = new MDL08_to_MDL09_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL08_MDL09_Generic_GJ_MDL08_to_MDL09_elec_syn_15conns_A[0].vpeer, a_MDL09[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL08_MDL09_Generic_GJ_MDL08_to_MDL09_elec_syn_15conns_B[0].vpeer, a_MDL08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL09_MDL08_Generic_GJ_MDL09_to_MDL08_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL09_MDL08_Generic_GJ_MDL09_to_MDL08_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL08[0].soma], weight: 1.0
        h("a_MDL09[0].soma { syn_NC_MDL09_MDL08_Generic_GJ_MDL09_to_MDL08_elec_syn_15conns_A[0] = new MDL09_to_MDL08_elec_syn_15conns(0.5) }")
        h("a_MDL08[0].soma { syn_NC_MDL09_MDL08_Generic_GJ_MDL09_to_MDL08_elec_syn_15conns_B[0] = new MDL09_to_MDL08_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL09_MDL08_Generic_GJ_MDL09_to_MDL08_elec_syn_15conns_A[0].vpeer, a_MDL08[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL09_MDL08_Generic_GJ_MDL09_to_MDL08_elec_syn_15conns_B[0].vpeer, a_MDL09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL10_MDL11_Generic_GJ_MDL10_to_MDL11_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL10_MDL11_Generic_GJ_MDL10_to_MDL11_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma], weight: 1.0
        h("a_MDL10[0].soma { syn_NC_MDL10_MDL11_Generic_GJ_MDL10_to_MDL11_elec_syn_15conns_A[0] = new MDL10_to_MDL11_elec_syn_15conns(0.5) }")
        h("a_MDL11[0].soma { syn_NC_MDL10_MDL11_Generic_GJ_MDL10_to_MDL11_elec_syn_15conns_B[0] = new MDL10_to_MDL11_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL10_MDL11_Generic_GJ_MDL10_to_MDL11_elec_syn_15conns_A[0].vpeer, a_MDL11[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL10_MDL11_Generic_GJ_MDL10_to_MDL11_elec_syn_15conns_B[0].vpeer, a_MDL10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL11_MDL10_Generic_GJ_MDL11_to_MDL10_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL11_MDL10_Generic_GJ_MDL11_to_MDL10_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL10[0].soma], weight: 1.0
        h("a_MDL11[0].soma { syn_NC_MDL11_MDL10_Generic_GJ_MDL11_to_MDL10_elec_syn_15conns_A[0] = new MDL11_to_MDL10_elec_syn_15conns(0.5) }")
        h("a_MDL10[0].soma { syn_NC_MDL11_MDL10_Generic_GJ_MDL11_to_MDL10_elec_syn_15conns_B[0] = new MDL11_to_MDL10_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL11_MDL10_Generic_GJ_MDL11_to_MDL10_elec_syn_15conns_A[0].vpeer, a_MDL10[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL11_MDL10_Generic_GJ_MDL11_to_MDL10_elec_syn_15conns_B[0].vpeer, a_MDL11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL11_MDL12_Generic_GJ_MDL11_to_MDL12_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL11_MDL12_Generic_GJ_MDL11_to_MDL12_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma], weight: 1.0
        h("a_MDL11[0].soma { syn_NC_MDL11_MDL12_Generic_GJ_MDL11_to_MDL12_elec_syn_15conns_A[0] = new MDL11_to_MDL12_elec_syn_15conns(0.5) }")
        h("a_MDL12[0].soma { syn_NC_MDL11_MDL12_Generic_GJ_MDL11_to_MDL12_elec_syn_15conns_B[0] = new MDL11_to_MDL12_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL11_MDL12_Generic_GJ_MDL11_to_MDL12_elec_syn_15conns_A[0].vpeer, a_MDL12[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL11_MDL12_Generic_GJ_MDL11_to_MDL12_elec_syn_15conns_B[0].vpeer, a_MDL11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL12_MDL11_Generic_GJ_MDL12_to_MDL11_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL12_MDL11_Generic_GJ_MDL12_to_MDL11_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL11[0].soma], weight: 1.0
        h("a_MDL12[0].soma { syn_NC_MDL12_MDL11_Generic_GJ_MDL12_to_MDL11_elec_syn_15conns_A[0] = new MDL12_to_MDL11_elec_syn_15conns(0.5) }")
        h("a_MDL11[0].soma { syn_NC_MDL12_MDL11_Generic_GJ_MDL12_to_MDL11_elec_syn_15conns_B[0] = new MDL12_to_MDL11_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL12_MDL11_Generic_GJ_MDL12_to_MDL11_elec_syn_15conns_A[0].vpeer, a_MDL11[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL12_MDL11_Generic_GJ_MDL12_to_MDL11_elec_syn_15conns_B[0].vpeer, a_MDL12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL12_MDL13_Generic_GJ_MDL12_to_MDL13_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL12_MDL13_Generic_GJ_MDL12_to_MDL13_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma], weight: 1.0
        h("a_MDL12[0].soma { syn_NC_MDL12_MDL13_Generic_GJ_MDL12_to_MDL13_elec_syn_15conns_A[0] = new MDL12_to_MDL13_elec_syn_15conns(0.5) }")
        h("a_MDL13[0].soma { syn_NC_MDL12_MDL13_Generic_GJ_MDL12_to_MDL13_elec_syn_15conns_B[0] = new MDL12_to_MDL13_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL12_MDL13_Generic_GJ_MDL12_to_MDL13_elec_syn_15conns_A[0].vpeer, a_MDL13[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL12_MDL13_Generic_GJ_MDL12_to_MDL13_elec_syn_15conns_B[0].vpeer, a_MDL12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL13_MDL12_Generic_GJ_MDL13_to_MDL12_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL13_MDL12_Generic_GJ_MDL13_to_MDL12_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL12[0].soma], weight: 1.0
        h("a_MDL13[0].soma { syn_NC_MDL13_MDL12_Generic_GJ_MDL13_to_MDL12_elec_syn_15conns_A[0] = new MDL13_to_MDL12_elec_syn_15conns(0.5) }")
        h("a_MDL12[0].soma { syn_NC_MDL13_MDL12_Generic_GJ_MDL13_to_MDL12_elec_syn_15conns_B[0] = new MDL13_to_MDL12_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL13_MDL12_Generic_GJ_MDL13_to_MDL12_elec_syn_15conns_A[0].vpeer, a_MDL12[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL13_MDL12_Generic_GJ_MDL13_to_MDL12_elec_syn_15conns_B[0].vpeer, a_MDL13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL13_MDL14_Generic_GJ_MDL13_to_MDL14_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL13_MDL14_Generic_GJ_MDL13_to_MDL14_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL14[0].soma], weight: 1.0
        h("a_MDL13[0].soma { syn_NC_MDL13_MDL14_Generic_GJ_MDL13_to_MDL14_elec_syn_15conns_A[0] = new MDL13_to_MDL14_elec_syn_15conns(0.5) }")
        h("a_MDL14[0].soma { syn_NC_MDL13_MDL14_Generic_GJ_MDL13_to_MDL14_elec_syn_15conns_B[0] = new MDL13_to_MDL14_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL13_MDL14_Generic_GJ_MDL13_to_MDL14_elec_syn_15conns_A[0].vpeer, a_MDL14[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL13_MDL14_Generic_GJ_MDL13_to_MDL14_elec_syn_15conns_B[0].vpeer, a_MDL13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL14_MDL13_Generic_GJ_MDL14_to_MDL13_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL14_MDL13_Generic_GJ_MDL14_to_MDL13_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL13[0].soma], weight: 1.0
        h("a_MDL14[0].soma { syn_NC_MDL14_MDL13_Generic_GJ_MDL14_to_MDL13_elec_syn_15conns_A[0] = new MDL14_to_MDL13_elec_syn_15conns(0.5) }")
        h("a_MDL13[0].soma { syn_NC_MDL14_MDL13_Generic_GJ_MDL14_to_MDL13_elec_syn_15conns_B[0] = new MDL14_to_MDL13_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL14_MDL13_Generic_GJ_MDL14_to_MDL13_elec_syn_15conns_A[0].vpeer, a_MDL13[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL14_MDL13_Generic_GJ_MDL14_to_MDL13_elec_syn_15conns_B[0].vpeer, a_MDL14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL14_MDL15_Generic_GJ_MDL14_to_MDL15_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL14_MDL15_Generic_GJ_MDL14_to_MDL15_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL15[0].soma], weight: 1.0
        h("a_MDL14[0].soma { syn_NC_MDL14_MDL15_Generic_GJ_MDL14_to_MDL15_elec_syn_15conns_A[0] = new MDL14_to_MDL15_elec_syn_15conns(0.5) }")
        h("a_MDL15[0].soma { syn_NC_MDL14_MDL15_Generic_GJ_MDL14_to_MDL15_elec_syn_15conns_B[0] = new MDL14_to_MDL15_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL14_MDL15_Generic_GJ_MDL14_to_MDL15_elec_syn_15conns_A[0].vpeer, a_MDL15[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL14_MDL15_Generic_GJ_MDL14_to_MDL15_elec_syn_15conns_B[0].vpeer, a_MDL14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL15_MDL14_Generic_GJ_MDL15_to_MDL14_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL15_MDL14_Generic_GJ_MDL15_to_MDL14_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL14[0].soma], weight: 1.0
        h("a_MDL15[0].soma { syn_NC_MDL15_MDL14_Generic_GJ_MDL15_to_MDL14_elec_syn_15conns_A[0] = new MDL15_to_MDL14_elec_syn_15conns(0.5) }")
        h("a_MDL14[0].soma { syn_NC_MDL15_MDL14_Generic_GJ_MDL15_to_MDL14_elec_syn_15conns_B[0] = new MDL15_to_MDL14_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL15_MDL14_Generic_GJ_MDL15_to_MDL14_elec_syn_15conns_A[0].vpeer, a_MDL14[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL15_MDL14_Generic_GJ_MDL15_to_MDL14_elec_syn_15conns_B[0].vpeer, a_MDL15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL15_MDL16_Generic_GJ_MDL15_to_MDL16_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL15_MDL16_Generic_GJ_MDL15_to_MDL16_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL16[0].soma], weight: 1.0
        h("a_MDL15[0].soma { syn_NC_MDL15_MDL16_Generic_GJ_MDL15_to_MDL16_elec_syn_15conns_A[0] = new MDL15_to_MDL16_elec_syn_15conns(0.5) }")
        h("a_MDL16[0].soma { syn_NC_MDL15_MDL16_Generic_GJ_MDL15_to_MDL16_elec_syn_15conns_B[0] = new MDL15_to_MDL16_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL15_MDL16_Generic_GJ_MDL15_to_MDL16_elec_syn_15conns_A[0].vpeer, a_MDL16[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL15_MDL16_Generic_GJ_MDL15_to_MDL16_elec_syn_15conns_B[0].vpeer, a_MDL15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL16_MDL15_Generic_GJ_MDL16_to_MDL15_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL16_MDL15_Generic_GJ_MDL16_to_MDL15_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL15[0].soma], weight: 1.0
        h("a_MDL16[0].soma { syn_NC_MDL16_MDL15_Generic_GJ_MDL16_to_MDL15_elec_syn_15conns_A[0] = new MDL16_to_MDL15_elec_syn_15conns(0.5) }")
        h("a_MDL15[0].soma { syn_NC_MDL16_MDL15_Generic_GJ_MDL16_to_MDL15_elec_syn_15conns_B[0] = new MDL16_to_MDL15_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL16_MDL15_Generic_GJ_MDL16_to_MDL15_elec_syn_15conns_A[0].vpeer, a_MDL15[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL16_MDL15_Generic_GJ_MDL16_to_MDL15_elec_syn_15conns_B[0].vpeer, a_MDL16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL16_MDL17_Generic_GJ_MDL16_to_MDL17_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL16_MDL17_Generic_GJ_MDL16_to_MDL17_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL17[0].soma], weight: 1.0
        h("a_MDL16[0].soma { syn_NC_MDL16_MDL17_Generic_GJ_MDL16_to_MDL17_elec_syn_15conns_A[0] = new MDL16_to_MDL17_elec_syn_15conns(0.5) }")
        h("a_MDL17[0].soma { syn_NC_MDL16_MDL17_Generic_GJ_MDL16_to_MDL17_elec_syn_15conns_B[0] = new MDL16_to_MDL17_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL16_MDL17_Generic_GJ_MDL16_to_MDL17_elec_syn_15conns_A[0].vpeer, a_MDL17[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL16_MDL17_Generic_GJ_MDL16_to_MDL17_elec_syn_15conns_B[0].vpeer, a_MDL16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL17_MDL16_Generic_GJ_MDL17_to_MDL16_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL17_MDL16_Generic_GJ_MDL17_to_MDL16_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL16[0].soma], weight: 1.0
        h("a_MDL17[0].soma { syn_NC_MDL17_MDL16_Generic_GJ_MDL17_to_MDL16_elec_syn_15conns_A[0] = new MDL17_to_MDL16_elec_syn_15conns(0.5) }")
        h("a_MDL16[0].soma { syn_NC_MDL17_MDL16_Generic_GJ_MDL17_to_MDL16_elec_syn_15conns_B[0] = new MDL17_to_MDL16_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL17_MDL16_Generic_GJ_MDL17_to_MDL16_elec_syn_15conns_A[0].vpeer, a_MDL16[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL17_MDL16_Generic_GJ_MDL17_to_MDL16_elec_syn_15conns_B[0].vpeer, a_MDL17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL17_MDL18_Generic_GJ_MDL17_to_MDL18_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL17_MDL18_Generic_GJ_MDL17_to_MDL18_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL18[0].soma], weight: 1.0
        h("a_MDL17[0].soma { syn_NC_MDL17_MDL18_Generic_GJ_MDL17_to_MDL18_elec_syn_15conns_A[0] = new MDL17_to_MDL18_elec_syn_15conns(0.5) }")
        h("a_MDL18[0].soma { syn_NC_MDL17_MDL18_Generic_GJ_MDL17_to_MDL18_elec_syn_15conns_B[0] = new MDL17_to_MDL18_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL17_MDL18_Generic_GJ_MDL17_to_MDL18_elec_syn_15conns_A[0].vpeer, a_MDL18[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL17_MDL18_Generic_GJ_MDL17_to_MDL18_elec_syn_15conns_B[0].vpeer, a_MDL17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL18_MDL17_Generic_GJ_MDL18_to_MDL17_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL18_MDL17_Generic_GJ_MDL18_to_MDL17_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL17[0].soma], weight: 1.0
        h("a_MDL18[0].soma { syn_NC_MDL18_MDL17_Generic_GJ_MDL18_to_MDL17_elec_syn_15conns_A[0] = new MDL18_to_MDL17_elec_syn_15conns(0.5) }")
        h("a_MDL17[0].soma { syn_NC_MDL18_MDL17_Generic_GJ_MDL18_to_MDL17_elec_syn_15conns_B[0] = new MDL18_to_MDL17_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL18_MDL17_Generic_GJ_MDL18_to_MDL17_elec_syn_15conns_A[0].vpeer, a_MDL17[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL18_MDL17_Generic_GJ_MDL18_to_MDL17_elec_syn_15conns_B[0].vpeer, a_MDL18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL18_MDL19_Generic_GJ_MDL18_to_MDL19_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL18_MDL19_Generic_GJ_MDL18_to_MDL19_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL19[0].soma], weight: 1.0
        h("a_MDL18[0].soma { syn_NC_MDL18_MDL19_Generic_GJ_MDL18_to_MDL19_elec_syn_15conns_A[0] = new MDL18_to_MDL19_elec_syn_15conns(0.5) }")
        h("a_MDL19[0].soma { syn_NC_MDL18_MDL19_Generic_GJ_MDL18_to_MDL19_elec_syn_15conns_B[0] = new MDL18_to_MDL19_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL18_MDL19_Generic_GJ_MDL18_to_MDL19_elec_syn_15conns_A[0].vpeer, a_MDL19[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL18_MDL19_Generic_GJ_MDL18_to_MDL19_elec_syn_15conns_B[0].vpeer, a_MDL18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL19_MDL18_Generic_GJ_MDL19_to_MDL18_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL19_MDL18_Generic_GJ_MDL19_to_MDL18_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL18[0].soma], weight: 1.0
        h("a_MDL19[0].soma { syn_NC_MDL19_MDL18_Generic_GJ_MDL19_to_MDL18_elec_syn_15conns_A[0] = new MDL19_to_MDL18_elec_syn_15conns(0.5) }")
        h("a_MDL18[0].soma { syn_NC_MDL19_MDL18_Generic_GJ_MDL19_to_MDL18_elec_syn_15conns_B[0] = new MDL19_to_MDL18_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL19_MDL18_Generic_GJ_MDL19_to_MDL18_elec_syn_15conns_A[0].vpeer, a_MDL18[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL19_MDL18_Generic_GJ_MDL19_to_MDL18_elec_syn_15conns_B[0].vpeer, a_MDL19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL20_MDL21_Generic_GJ_MDL20_to_MDL21_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL20_MDL21_Generic_GJ_MDL20_to_MDL21_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL21[0].soma], weight: 1.0
        h("a_MDL20[0].soma { syn_NC_MDL20_MDL21_Generic_GJ_MDL20_to_MDL21_elec_syn_15conns_A[0] = new MDL20_to_MDL21_elec_syn_15conns(0.5) }")
        h("a_MDL21[0].soma { syn_NC_MDL20_MDL21_Generic_GJ_MDL20_to_MDL21_elec_syn_15conns_B[0] = new MDL20_to_MDL21_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL20_MDL21_Generic_GJ_MDL20_to_MDL21_elec_syn_15conns_A[0].vpeer, a_MDL21[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL20_MDL21_Generic_GJ_MDL20_to_MDL21_elec_syn_15conns_B[0].vpeer, a_MDL20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL21_MDL20_Generic_GJ_MDL21_to_MDL20_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL21_MDL20_Generic_GJ_MDL21_to_MDL20_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL20[0].soma], weight: 1.0
        h("a_MDL21[0].soma { syn_NC_MDL21_MDL20_Generic_GJ_MDL21_to_MDL20_elec_syn_15conns_A[0] = new MDL21_to_MDL20_elec_syn_15conns(0.5) }")
        h("a_MDL20[0].soma { syn_NC_MDL21_MDL20_Generic_GJ_MDL21_to_MDL20_elec_syn_15conns_B[0] = new MDL21_to_MDL20_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL21_MDL20_Generic_GJ_MDL21_to_MDL20_elec_syn_15conns_A[0].vpeer, a_MDL20[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL21_MDL20_Generic_GJ_MDL21_to_MDL20_elec_syn_15conns_B[0].vpeer, a_MDL21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL22_MDL23_Generic_GJ_MDL22_to_MDL23_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL22_MDL23_Generic_GJ_MDL22_to_MDL23_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL22[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL23[0].soma], weight: 1.0
        h("a_MDL22[0].soma { syn_NC_MDL22_MDL23_Generic_GJ_MDL22_to_MDL23_elec_syn_15conns_A[0] = new MDL22_to_MDL23_elec_syn_15conns(0.5) }")
        h("a_MDL23[0].soma { syn_NC_MDL22_MDL23_Generic_GJ_MDL22_to_MDL23_elec_syn_15conns_B[0] = new MDL22_to_MDL23_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL22_MDL23_Generic_GJ_MDL22_to_MDL23_elec_syn_15conns_A[0].vpeer, a_MDL23[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL22_MDL23_Generic_GJ_MDL22_to_MDL23_elec_syn_15conns_B[0].vpeer, a_MDL22[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDL23_MDL22_Generic_GJ_MDL23_to_MDL22_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDL23_MDL22_Generic_GJ_MDL23_to_MDL22_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDL23[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDL22[0].soma], weight: 1.0
        h("a_MDL23[0].soma { syn_NC_MDL23_MDL22_Generic_GJ_MDL23_to_MDL22_elec_syn_15conns_A[0] = new MDL23_to_MDL22_elec_syn_15conns(0.5) }")
        h("a_MDL22[0].soma { syn_NC_MDL23_MDL22_Generic_GJ_MDL23_to_MDL22_elec_syn_15conns_B[0] = new MDL23_to_MDL22_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDL23_MDL22_Generic_GJ_MDL23_to_MDL22_elec_syn_15conns_A[0].vpeer, a_MDL22[0].soma.v(0.5)")
        h("setpointer syn_NC_MDL23_MDL22_Generic_GJ_MDL23_to_MDL22_elec_syn_15conns_B[0].vpeer, a_MDL23[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR08_MDR09_Generic_GJ_MDR08_to_MDR09_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR08_MDR09_Generic_GJ_MDR08_to_MDR09_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR08[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR09[0].soma], weight: 1.0
        h("a_MDR08[0].soma { syn_NC_MDR08_MDR09_Generic_GJ_MDR08_to_MDR09_elec_syn_15conns_A[0] = new MDR08_to_MDR09_elec_syn_15conns(0.5) }")
        h("a_MDR09[0].soma { syn_NC_MDR08_MDR09_Generic_GJ_MDR08_to_MDR09_elec_syn_15conns_B[0] = new MDR08_to_MDR09_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR08_MDR09_Generic_GJ_MDR08_to_MDR09_elec_syn_15conns_A[0].vpeer, a_MDR09[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR08_MDR09_Generic_GJ_MDR08_to_MDR09_elec_syn_15conns_B[0].vpeer, a_MDR08[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR09_MDR08_Generic_GJ_MDR09_to_MDR08_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR09_MDR08_Generic_GJ_MDR09_to_MDR08_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR09[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR08[0].soma], weight: 1.0
        h("a_MDR09[0].soma { syn_NC_MDR09_MDR08_Generic_GJ_MDR09_to_MDR08_elec_syn_15conns_A[0] = new MDR09_to_MDR08_elec_syn_15conns(0.5) }")
        h("a_MDR08[0].soma { syn_NC_MDR09_MDR08_Generic_GJ_MDR09_to_MDR08_elec_syn_15conns_B[0] = new MDR09_to_MDR08_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR09_MDR08_Generic_GJ_MDR09_to_MDR08_elec_syn_15conns_A[0].vpeer, a_MDR08[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR09_MDR08_Generic_GJ_MDR09_to_MDR08_elec_syn_15conns_B[0].vpeer, a_MDR09[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR10_MDR11_Generic_GJ_MDR10_to_MDR11_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR10_MDR11_Generic_GJ_MDR10_to_MDR11_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR10[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma], weight: 1.0
        h("a_MDR10[0].soma { syn_NC_MDR10_MDR11_Generic_GJ_MDR10_to_MDR11_elec_syn_15conns_A[0] = new MDR10_to_MDR11_elec_syn_15conns(0.5) }")
        h("a_MDR11[0].soma { syn_NC_MDR10_MDR11_Generic_GJ_MDR10_to_MDR11_elec_syn_15conns_B[0] = new MDR10_to_MDR11_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR10_MDR11_Generic_GJ_MDR10_to_MDR11_elec_syn_15conns_A[0].vpeer, a_MDR11[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR10_MDR11_Generic_GJ_MDR10_to_MDR11_elec_syn_15conns_B[0].vpeer, a_MDR10[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR11_MDR10_Generic_GJ_MDR11_to_MDR10_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR11_MDR10_Generic_GJ_MDR11_to_MDR10_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR11[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR10[0].soma], weight: 1.0
        h("a_MDR11[0].soma { syn_NC_MDR11_MDR10_Generic_GJ_MDR11_to_MDR10_elec_syn_15conns_A[0] = new MDR11_to_MDR10_elec_syn_15conns(0.5) }")
        h("a_MDR10[0].soma { syn_NC_MDR11_MDR10_Generic_GJ_MDR11_to_MDR10_elec_syn_15conns_B[0] = new MDR11_to_MDR10_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR11_MDR10_Generic_GJ_MDR11_to_MDR10_elec_syn_15conns_A[0].vpeer, a_MDR10[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR11_MDR10_Generic_GJ_MDR11_to_MDR10_elec_syn_15conns_B[0].vpeer, a_MDR11[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR12_MDR13_Generic_GJ_MDR12_to_MDR13_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR12_MDR13_Generic_GJ_MDR12_to_MDR13_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR13[0].soma], weight: 1.0
        h("a_MDR12[0].soma { syn_NC_MDR12_MDR13_Generic_GJ_MDR12_to_MDR13_elec_syn_15conns_A[0] = new MDR12_to_MDR13_elec_syn_15conns(0.5) }")
        h("a_MDR13[0].soma { syn_NC_MDR12_MDR13_Generic_GJ_MDR12_to_MDR13_elec_syn_15conns_B[0] = new MDR12_to_MDR13_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR12_MDR13_Generic_GJ_MDR12_to_MDR13_elec_syn_15conns_A[0].vpeer, a_MDR13[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR12_MDR13_Generic_GJ_MDR12_to_MDR13_elec_syn_15conns_B[0].vpeer, a_MDR12[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR13_MDR12_Generic_GJ_MDR13_to_MDR12_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR13_MDR12_Generic_GJ_MDR13_to_MDR12_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR13[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR12[0].soma], weight: 1.0
        h("a_MDR13[0].soma { syn_NC_MDR13_MDR12_Generic_GJ_MDR13_to_MDR12_elec_syn_15conns_A[0] = new MDR13_to_MDR12_elec_syn_15conns(0.5) }")
        h("a_MDR12[0].soma { syn_NC_MDR13_MDR12_Generic_GJ_MDR13_to_MDR12_elec_syn_15conns_B[0] = new MDR13_to_MDR12_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR13_MDR12_Generic_GJ_MDR13_to_MDR12_elec_syn_15conns_A[0].vpeer, a_MDR12[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR13_MDR12_Generic_GJ_MDR13_to_MDR12_elec_syn_15conns_B[0].vpeer, a_MDR13[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR14_MDR15_Generic_GJ_MDR14_to_MDR15_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR14_MDR15_Generic_GJ_MDR14_to_MDR15_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR14[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR15[0].soma], weight: 1.0
        h("a_MDR14[0].soma { syn_NC_MDR14_MDR15_Generic_GJ_MDR14_to_MDR15_elec_syn_15conns_A[0] = new MDR14_to_MDR15_elec_syn_15conns(0.5) }")
        h("a_MDR15[0].soma { syn_NC_MDR14_MDR15_Generic_GJ_MDR14_to_MDR15_elec_syn_15conns_B[0] = new MDR14_to_MDR15_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR14_MDR15_Generic_GJ_MDR14_to_MDR15_elec_syn_15conns_A[0].vpeer, a_MDR15[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR14_MDR15_Generic_GJ_MDR14_to_MDR15_elec_syn_15conns_B[0].vpeer, a_MDR14[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR15_MDR14_Generic_GJ_MDR15_to_MDR14_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR15_MDR14_Generic_GJ_MDR15_to_MDR14_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR15[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR14[0].soma], weight: 1.0
        h("a_MDR15[0].soma { syn_NC_MDR15_MDR14_Generic_GJ_MDR15_to_MDR14_elec_syn_15conns_A[0] = new MDR15_to_MDR14_elec_syn_15conns(0.5) }")
        h("a_MDR14[0].soma { syn_NC_MDR15_MDR14_Generic_GJ_MDR15_to_MDR14_elec_syn_15conns_B[0] = new MDR15_to_MDR14_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR15_MDR14_Generic_GJ_MDR15_to_MDR14_elec_syn_15conns_A[0].vpeer, a_MDR14[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR15_MDR14_Generic_GJ_MDR15_to_MDR14_elec_syn_15conns_B[0].vpeer, a_MDR15[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR16_MDR17_Generic_GJ_MDR16_to_MDR17_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR16_MDR17_Generic_GJ_MDR16_to_MDR17_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR16[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR17[0].soma], weight: 1.0
        h("a_MDR16[0].soma { syn_NC_MDR16_MDR17_Generic_GJ_MDR16_to_MDR17_elec_syn_15conns_A[0] = new MDR16_to_MDR17_elec_syn_15conns(0.5) }")
        h("a_MDR17[0].soma { syn_NC_MDR16_MDR17_Generic_GJ_MDR16_to_MDR17_elec_syn_15conns_B[0] = new MDR16_to_MDR17_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR16_MDR17_Generic_GJ_MDR16_to_MDR17_elec_syn_15conns_A[0].vpeer, a_MDR17[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR16_MDR17_Generic_GJ_MDR16_to_MDR17_elec_syn_15conns_B[0].vpeer, a_MDR16[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR17_MDR16_Generic_GJ_MDR17_to_MDR16_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR17_MDR16_Generic_GJ_MDR17_to_MDR16_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR17[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR16[0].soma], weight: 1.0
        h("a_MDR17[0].soma { syn_NC_MDR17_MDR16_Generic_GJ_MDR17_to_MDR16_elec_syn_15conns_A[0] = new MDR17_to_MDR16_elec_syn_15conns(0.5) }")
        h("a_MDR16[0].soma { syn_NC_MDR17_MDR16_Generic_GJ_MDR17_to_MDR16_elec_syn_15conns_B[0] = new MDR17_to_MDR16_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR17_MDR16_Generic_GJ_MDR17_to_MDR16_elec_syn_15conns_A[0].vpeer, a_MDR16[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR17_MDR16_Generic_GJ_MDR17_to_MDR16_elec_syn_15conns_B[0].vpeer, a_MDR17[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR18_MDR19_Generic_GJ_MDR18_to_MDR19_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR18_MDR19_Generic_GJ_MDR18_to_MDR19_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR18[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR19[0].soma], weight: 1.0
        h("a_MDR18[0].soma { syn_NC_MDR18_MDR19_Generic_GJ_MDR18_to_MDR19_elec_syn_15conns_A[0] = new MDR18_to_MDR19_elec_syn_15conns(0.5) }")
        h("a_MDR19[0].soma { syn_NC_MDR18_MDR19_Generic_GJ_MDR18_to_MDR19_elec_syn_15conns_B[0] = new MDR18_to_MDR19_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR18_MDR19_Generic_GJ_MDR18_to_MDR19_elec_syn_15conns_A[0].vpeer, a_MDR19[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR18_MDR19_Generic_GJ_MDR18_to_MDR19_elec_syn_15conns_B[0].vpeer, a_MDR18[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR19_MDR18_Generic_GJ_MDR19_to_MDR18_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR19_MDR18_Generic_GJ_MDR19_to_MDR18_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR19[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR18[0].soma], weight: 1.0
        h("a_MDR19[0].soma { syn_NC_MDR19_MDR18_Generic_GJ_MDR19_to_MDR18_elec_syn_15conns_A[0] = new MDR19_to_MDR18_elec_syn_15conns(0.5) }")
        h("a_MDR18[0].soma { syn_NC_MDR19_MDR18_Generic_GJ_MDR19_to_MDR18_elec_syn_15conns_B[0] = new MDR19_to_MDR18_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR19_MDR18_Generic_GJ_MDR19_to_MDR18_elec_syn_15conns_A[0].vpeer, a_MDR18[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR19_MDR18_Generic_GJ_MDR19_to_MDR18_elec_syn_15conns_B[0].vpeer, a_MDR19[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR20_MDR21_Generic_GJ_MDR20_to_MDR21_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR20_MDR21_Generic_GJ_MDR20_to_MDR21_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR20[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR21[0].soma], weight: 1.0
        h("a_MDR20[0].soma { syn_NC_MDR20_MDR21_Generic_GJ_MDR20_to_MDR21_elec_syn_15conns_A[0] = new MDR20_to_MDR21_elec_syn_15conns(0.5) }")
        h("a_MDR21[0].soma { syn_NC_MDR20_MDR21_Generic_GJ_MDR20_to_MDR21_elec_syn_15conns_B[0] = new MDR20_to_MDR21_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR20_MDR21_Generic_GJ_MDR20_to_MDR21_elec_syn_15conns_A[0].vpeer, a_MDR21[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR20_MDR21_Generic_GJ_MDR20_to_MDR21_elec_syn_15conns_B[0].vpeer, a_MDR20[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_MDR21_MDR20_Generic_GJ_MDR21_to_MDR20_elec_syn_15conns_A[1]")
        h("objectvar syn_NC_MDR21_MDR20_Generic_GJ_MDR21_to_MDR20_elec_syn_15conns_B[1]")

        # Elect Connection 0: cell 0, seg 0 (0.5) [0.5 on a_MDR21[0].soma] -> cell 0, seg 0 (0.5) [0.5 on a_MDR20[0].soma], weight: 1.0
        h("a_MDR21[0].soma { syn_NC_MDR21_MDR20_Generic_GJ_MDR21_to_MDR20_elec_syn_15conns_A[0] = new MDR21_to_MDR20_elec_syn_15conns(0.5) }")
        h("a_MDR20[0].soma { syn_NC_MDR21_MDR20_Generic_GJ_MDR21_to_MDR20_elec_syn_15conns_B[0] = new MDR21_to_MDR20_elec_syn_15conns(0.5) }")
        h("setpointer syn_NC_MDR21_MDR20_Generic_GJ_MDR21_to_MDR20_elec_syn_15conns_A[0].vpeer, a_MDR20[0].soma.v(0.5)")
        h("setpointer syn_NC_MDR21_MDR20_Generic_GJ_MDR21_to_MDR20_elec_syn_15conns_B[0].vpeer, a_MDR21[0].soma.v(0.5)")
        ...
        h("objectvar syn_NC_DB3_MDL12_Acetylcholine_DB3_to_MDL12_exc_syn_1conns_post[1]")
        ...
        h("a_MDL12[0].soma { syn_NC_DB3_MDL12_Acetylcholine_DB3_to_MDL12_exc_syn_1conns_post[0] = new DB3_to_MDL12_exc_syn_1conns(0.500000) }")
        h("setpointer syn_NC_DB3_MDL12_Acetylcholine_silent_pre[0].vpeer, a_MDL12[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDL12_Acetylcholine_DB3_to_MDL12_exc_syn_1conns_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDR11_Acetylcholine_DB3_to_MDR11_exc_syn_2conns_post[1]")
        ...
        h("a_MDR11[0].soma { syn_NC_DB3_MDR11_Acetylcholine_DB3_to_MDR11_exc_syn_2conns_post[0] = new DB3_to_MDR11_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB3_MDR11_Acetylcholine_silent_pre[0].vpeer, a_MDR11[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDR11_Acetylcholine_DB3_to_MDR11_exc_syn_2conns_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDR12_Acetylcholine_DB3_to_MDR12_exc_syn_13conns_post[1]")
        ...
        h("a_MDR12[0].soma { syn_NC_DB3_MDR12_Acetylcholine_DB3_to_MDR12_exc_syn_13conns_post[0] = new DB3_to_MDR12_exc_syn_13conns(0.500000) }")
        h("setpointer syn_NC_DB3_MDR12_Acetylcholine_silent_pre[0].vpeer, a_MDR12[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDR12_Acetylcholine_DB3_to_MDR12_exc_syn_13conns_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB3_MDR13_Acetylcholine_DB3_to_MDR13_exc_syn_1conns_post[1]")
        ...
        h("a_MDR13[0].soma { syn_NC_DB3_MDR13_Acetylcholine_DB3_to_MDR13_exc_syn_1conns_post[0] = new DB3_to_MDR13_exc_syn_1conns(0.500000) }")
        h("setpointer syn_NC_DB3_MDR13_Acetylcholine_silent_pre[0].vpeer, a_MDR13[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB3_MDR13_Acetylcholine_DB3_to_MDR13_exc_syn_1conns_post[0].vpeer, a_DB3[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB4_MDR13_Acetylcholine_DB4_to_MDR13_exc_syn_3conns_post[1]")
        ...
        h("a_MDR13[0].soma { syn_NC_DB4_MDR13_Acetylcholine_DB4_to_MDR13_exc_syn_3conns_post[0] = new DB4_to_MDR13_exc_syn_3conns(0.500000) }")
        h("setpointer syn_NC_DB4_MDR13_Acetylcholine_silent_pre[0].vpeer, a_MDR13[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB4_MDR13_Acetylcholine_DB4_to_MDR13_exc_syn_3conns_post[0].vpeer, a_DB4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB4_MDR14_Acetylcholine_DB4_to_MDR14_exc_syn_5conns_post[1]")
        ...
        h("a_MDR14[0].soma { syn_NC_DB4_MDR14_Acetylcholine_DB4_to_MDR14_exc_syn_5conns_post[0] = new DB4_to_MDR14_exc_syn_5conns(0.500000) }")
        h("setpointer syn_NC_DB4_MDR14_Acetylcholine_silent_pre[0].vpeer, a_MDR14[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB4_MDR14_Acetylcholine_DB4_to_MDR14_exc_syn_5conns_post[0].vpeer, a_DB4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB4_MDR15_Acetylcholine_DB4_to_MDR15_exc_syn_3conns_post[1]")
        ...
        h("a_MDR15[0].soma { syn_NC_DB4_MDR15_Acetylcholine_DB4_to_MDR15_exc_syn_3conns_post[0] = new DB4_to_MDR15_exc_syn_3conns(0.500000) }")
        h("setpointer syn_NC_DB4_MDR15_Acetylcholine_silent_pre[0].vpeer, a_MDR15[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB4_MDR15_Acetylcholine_DB4_to_MDR15_exc_syn_3conns_post[0].vpeer, a_DB4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB4_MDR16_Acetylcholine_DB4_to_MDR16_exc_syn_3conns_post[1]")
        ...
        h("a_MDR16[0].soma { syn_NC_DB4_MDR16_Acetylcholine_DB4_to_MDR16_exc_syn_3conns_post[0] = new DB4_to_MDR16_exc_syn_3conns(0.500000) }")
        h("setpointer syn_NC_DB4_MDR16_Acetylcholine_silent_pre[0].vpeer, a_MDR16[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB4_MDR16_Acetylcholine_DB4_to_MDR16_exc_syn_3conns_post[0].vpeer, a_DB4[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB5_MDL14_Acetylcholine_DB5_to_MDL14_exc_syn_2conns_post[1]")
        ...
        h("a_MDL14[0].soma { syn_NC_DB5_MDL14_Acetylcholine_DB5_to_MDL14_exc_syn_2conns_post[0] = new DB5_to_MDL14_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB5_MDL14_Acetylcholine_silent_pre[0].vpeer, a_MDL14[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB5_MDL14_Acetylcholine_DB5_to_MDL14_exc_syn_2conns_post[0].vpeer, a_DB5[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB5_MDL15_Acetylcholine_DB5_to_MDL15_exc_syn_2conns_post[1]")
        ...
        h("a_MDL15[0].soma { syn_NC_DB5_MDL15_Acetylcholine_DB5_to_MDL15_exc_syn_2conns_post[0] = new DB5_to_MDL15_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB5_MDL15_Acetylcholine_silent_pre[0].vpeer, a_MDL15[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB5_MDL15_Acetylcholine_DB5_to_MDL15_exc_syn_2conns_post[0].vpeer, a_DB5[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB5_MDR14_Acetylcholine_DB5_to_MDR14_exc_syn_2conns_post[1]")
        ...
        h("a_MDR14[0].soma { syn_NC_DB5_MDR14_Acetylcholine_DB5_to_MDR14_exc_syn_2conns_post[0] = new DB5_to_MDR14_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB5_MDR14_Acetylcholine_silent_pre[0].vpeer, a_MDR14[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB5_MDR14_Acetylcholine_DB5_to_MDR14_exc_syn_2conns_post[0].vpeer, a_DB5[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB5_MDR15_Acetylcholine_DB5_to_MDR15_exc_syn_2conns_post[1]")
        ...
        h("a_MDR15[0].soma { syn_NC_DB5_MDR15_Acetylcholine_DB5_to_MDR15_exc_syn_2conns_post[0] = new DB5_to_MDR15_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB5_MDR15_Acetylcholine_silent_pre[0].vpeer, a_MDR15[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB5_MDR15_Acetylcholine_DB5_to_MDR15_exc_syn_2conns_post[0].vpeer, a_DB5[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB5_MDR16_Acetylcholine_DB5_to_MDR16_exc_syn_2conns_post[1]")
        ...
        h("a_MDR16[0].soma { syn_NC_DB5_MDR16_Acetylcholine_DB5_to_MDR16_exc_syn_2conns_post[0] = new DB5_to_MDR16_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB5_MDR16_Acetylcholine_silent_pre[0].vpeer, a_MDR16[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB5_MDR16_Acetylcholine_DB5_to_MDR16_exc_syn_2conns_post[0].vpeer, a_DB5[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB5_MDR17_Acetylcholine_DB5_to_MDR17_exc_syn_2conns_post[1]")
        ...
        h("a_MDR17[0].soma { syn_NC_DB5_MDR17_Acetylcholine_DB5_to_MDR17_exc_syn_2conns_post[0] = new DB5_to_MDR17_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB5_MDR17_Acetylcholine_silent_pre[0].vpeer, a_MDR17[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB5_MDR17_Acetylcholine_DB5_to_MDR17_exc_syn_2conns_post[0].vpeer, a_DB5[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB5_MDR18_Acetylcholine_DB5_to_MDR18_exc_syn_2conns_post[1]")
        ...
        h("a_MDR18[0].soma { syn_NC_DB5_MDR18_Acetylcholine_DB5_to_MDR18_exc_syn_2conns_post[0] = new DB5_to_MDR18_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB5_MDR18_Acetylcholine_silent_pre[0].vpeer, a_MDR18[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB5_MDR18_Acetylcholine_DB5_to_MDR18_exc_syn_2conns_post[0].vpeer, a_DB5[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB5_MDR19_Acetylcholine_DB5_to_MDR19_exc_syn_2conns_post[1]")
        ...
        h("a_MDR19[0].soma { syn_NC_DB5_MDR19_Acetylcholine_DB5_to_MDR19_exc_syn_2conns_post[0] = new DB5_to_MDR19_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB5_MDR19_Acetylcholine_silent_pre[0].vpeer, a_MDR19[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB5_MDR19_Acetylcholine_DB5_to_MDR19_exc_syn_2conns_post[0].vpeer, a_DB5[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDL16_Acetylcholine_DB6_to_MDL16_exc_syn_2conns_post[1]")
        ...
        h("a_MDL16[0].soma { syn_NC_DB6_MDL16_Acetylcholine_DB6_to_MDL16_exc_syn_2conns_post[0] = new DB6_to_MDL16_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDL16_Acetylcholine_silent_pre[0].vpeer, a_MDL16[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDL16_Acetylcholine_DB6_to_MDL16_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDL17_Acetylcholine_DB6_to_MDL17_exc_syn_2conns_post[1]")
        ...
        h("a_MDL17[0].soma { syn_NC_DB6_MDL17_Acetylcholine_DB6_to_MDL17_exc_syn_2conns_post[0] = new DB6_to_MDL17_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDL17_Acetylcholine_silent_pre[0].vpeer, a_MDL17[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDL17_Acetylcholine_DB6_to_MDL17_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDL18_Acetylcholine_DB6_to_MDL18_exc_syn_2conns_post[1]")
        ...
        h("a_MDL18[0].soma { syn_NC_DB6_MDL18_Acetylcholine_DB6_to_MDL18_exc_syn_2conns_post[0] = new DB6_to_MDL18_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDL18_Acetylcholine_silent_pre[0].vpeer, a_MDL18[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDL18_Acetylcholine_DB6_to_MDL18_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDR16_Acetylcholine_DB6_to_MDR16_exc_syn_2conns_post[1]")
        ...
        h("a_MDR16[0].soma { syn_NC_DB6_MDR16_Acetylcholine_DB6_to_MDR16_exc_syn_2conns_post[0] = new DB6_to_MDR16_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDR16_Acetylcholine_silent_pre[0].vpeer, a_MDR16[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDR16_Acetylcholine_DB6_to_MDR16_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDR17_Acetylcholine_DB6_to_MDR17_exc_syn_2conns_post[1]")
        ...
        h("a_MDR17[0].soma { syn_NC_DB6_MDR17_Acetylcholine_DB6_to_MDR17_exc_syn_2conns_post[0] = new DB6_to_MDR17_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDR17_Acetylcholine_silent_pre[0].vpeer, a_MDR17[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDR17_Acetylcholine_DB6_to_MDR17_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDR18_Acetylcholine_DB6_to_MDR18_exc_syn_2conns_post[1]")
        ...
        h("a_MDR18[0].soma { syn_NC_DB6_MDR18_Acetylcholine_DB6_to_MDR18_exc_syn_2conns_post[0] = new DB6_to_MDR18_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDR18_Acetylcholine_silent_pre[0].vpeer, a_MDR18[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDR18_Acetylcholine_DB6_to_MDR18_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDR19_Acetylcholine_DB6_to_MDR19_exc_syn_2conns_post[1]")
        ...
        h("a_MDR19[0].soma { syn_NC_DB6_MDR19_Acetylcholine_DB6_to_MDR19_exc_syn_2conns_post[0] = new DB6_to_MDR19_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDR19_Acetylcholine_silent_pre[0].vpeer, a_MDR19[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDR19_Acetylcholine_DB6_to_MDR19_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDR20_Acetylcholine_DB6_to_MDR20_exc_syn_2conns_post[1]")
        ...
        h("a_MDR20[0].soma { syn_NC_DB6_MDR20_Acetylcholine_DB6_to_MDR20_exc_syn_2conns_post[0] = new DB6_to_MDR20_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDR20_Acetylcholine_silent_pre[0].vpeer, a_MDR20[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDR20_Acetylcholine_DB6_to_MDR20_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB6_MDR21_Acetylcholine_DB6_to_MDR21_exc_syn_2conns_post[1]")
        ...
        h("a_MDR21[0].soma { syn_NC_DB6_MDR21_Acetylcholine_DB6_to_MDR21_exc_syn_2conns_post[0] = new DB6_to_MDR21_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB6_MDR21_Acetylcholine_silent_pre[0].vpeer, a_MDR21[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB6_MDR21_Acetylcholine_DB6_to_MDR21_exc_syn_2conns_post[0].vpeer, a_DB6[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDL19_Acetylcholine_DB7_to_MDL19_exc_syn_2conns_post[1]")
        ...
        h("a_MDL19[0].soma { syn_NC_DB7_MDL19_Acetylcholine_DB7_to_MDL19_exc_syn_2conns_post[0] = new DB7_to_MDL19_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDL19_Acetylcholine_silent_pre[0].vpeer, a_MDL19[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDL19_Acetylcholine_DB7_to_MDL19_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDL20_Acetylcholine_DB7_to_MDL20_exc_syn_2conns_post[1]")
        ...
        h("a_MDL20[0].soma { syn_NC_DB7_MDL20_Acetylcholine_DB7_to_MDL20_exc_syn_2conns_post[0] = new DB7_to_MDL20_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDL20_Acetylcholine_silent_pre[0].vpeer, a_MDL20[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDL20_Acetylcholine_DB7_to_MDL20_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDL21_Acetylcholine_DB7_to_MDL21_exc_syn_2conns_post[1]")
        ...
        h("a_MDL21[0].soma { syn_NC_DB7_MDL21_Acetylcholine_DB7_to_MDL21_exc_syn_2conns_post[0] = new DB7_to_MDL21_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDL21_Acetylcholine_silent_pre[0].vpeer, a_MDL21[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDL21_Acetylcholine_DB7_to_MDL21_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDR19_Acetylcholine_DB7_to_MDR19_exc_syn_2conns_post[1]")
        ...
        h("a_MDR19[0].soma { syn_NC_DB7_MDR19_Acetylcholine_DB7_to_MDR19_exc_syn_2conns_post[0] = new DB7_to_MDR19_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDR19_Acetylcholine_silent_pre[0].vpeer, a_MDR19[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDR19_Acetylcholine_DB7_to_MDR19_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDR20_Acetylcholine_DB7_to_MDR20_exc_syn_2conns_post[1]")
        ...
        h("a_MDR20[0].soma { syn_NC_DB7_MDR20_Acetylcholine_DB7_to_MDR20_exc_syn_2conns_post[0] = new DB7_to_MDR20_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDR20_Acetylcholine_silent_pre[0].vpeer, a_MDR20[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDR20_Acetylcholine_DB7_to_MDR20_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDR21_Acetylcholine_DB7_to_MDR21_exc_syn_2conns_post[1]")
        ...
        h("a_MDR21[0].soma { syn_NC_DB7_MDR21_Acetylcholine_DB7_to_MDR21_exc_syn_2conns_post[0] = new DB7_to_MDR21_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDR21_Acetylcholine_silent_pre[0].vpeer, a_MDR21[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDR21_Acetylcholine_DB7_to_MDR21_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDR22_Acetylcholine_DB7_to_MDR22_exc_syn_2conns_post[1]")
        ...
        h("a_MDR22[0].soma { syn_NC_DB7_MDR22_Acetylcholine_DB7_to_MDR22_exc_syn_2conns_post[0] = new DB7_to_MDR22_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDR22_Acetylcholine_silent_pre[0].vpeer, a_MDR22[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDR22_Acetylcholine_DB7_to_MDR22_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDR23_Acetylcholine_DB7_to_MDR23_exc_syn_2conns_post[1]")
        ...
        h("a_MDR23[0].soma { syn_NC_DB7_MDR23_Acetylcholine_DB7_to_MDR23_exc_syn_2conns_post[0] = new DB7_to_MDR23_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDR23_Acetylcholine_silent_pre[0].vpeer, a_MDR23[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDR23_Acetylcholine_DB7_to_MDR23_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        h("objectvar syn_NC_DB7_MDR24_Acetylcholine_DB7_to_MDR24_exc_syn_2conns_post[1]")
        ...
        h("a_MDR24[0].soma { syn_NC_DB7_MDR24_Acetylcholine_DB7_to_MDR24_exc_syn_2conns_post[0] = new DB7_to_MDR24_exc_syn_2conns(0.500000) }")
        h("setpointer syn_NC_DB7_MDR24_Acetylcholine_silent_pre[0].vpeer, a_MDR24[0].soma.v(0.500000)")
        h("setpointer syn_NC_DB7_MDR24_Acetylcholine_DB7_to_MDR24_exc_syn_2conns_post[0].vpeer, a_DB7[0].soma.v(0.500000)")
        ...
        # ######################   File to save: CASE1AVB_DB.activity.dat (neurons_activity)
        ...
        # ######################   File to save: CASE1AVB_DB.muscles.dat (muscles_v)
        ...
        # ######################   File to save: CASE1AVB_DB.muscles.activity.dat (muscles_activity)
        ...
        # ######################   File to save: CASE1AVB_DB.dat (neurons_v)
    ...
    def save_results(self):
        ...
        f_neurons_activity_f2 = open('CASE1AVB_DB.activity.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE1AVB_DB.activity.dat")
        ...
        f_muscles_v_f2 = open('CASE1AVB_DB.muscles.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE1AVB_DB.muscles.dat")
        ...
        f_muscles_activity_f2 = open('CASE1AVB_DB.muscles.activity.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE1AVB_DB.muscles.activity.dat")
        ...
        f_neurons_v_f2 = open('CASE1AVB_DB.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE1AVB_DB.dat")
