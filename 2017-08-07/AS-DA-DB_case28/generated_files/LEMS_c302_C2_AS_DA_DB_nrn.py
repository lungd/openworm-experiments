...
Components:
    ...
    neuron_to_neuron_exc_syn_1conns (Type: gradedSynapse:  conductance=3.2000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_exc_syn_2conns (Type: gradedSynapse:  conductance=6.400000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_inh_syn_28conns (Type: gradedSynapse:  conductance=1.736E-7 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_4conns (Type: gradedSynapse:  conductance=2.4800000000000004E-8 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_3conns (Type: gradedSynapse:  conductance=1.86E-8 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_2conns (Type: gradedSynapse:  conductance=1.2400000000000002E-8 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_1conns (Type: gradedSynapse:  conductance=6.200000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_exc_syn_8conns (Type: gradedSynapse:  conductance=2.5600000000000004E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_exc_syn_3conns (Type: gradedSynapse:  conductance=9.6E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
