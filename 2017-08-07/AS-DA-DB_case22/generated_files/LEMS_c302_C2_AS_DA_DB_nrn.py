...
Components:
    ...
    neuron_to_neuron_exc_syn_1conns (Type: gradedSynapse:  conductance=2.2000000000000003E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_exc_syn_2conns (Type: gradedSynapse:  conductance=4.4000000000000005E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    neuron_to_neuron_exc_syn_8conns (Type: gradedSynapse:  conductance=1.7600000000000002E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_exc_syn_3conns (Type: gradedSynapse:  conductance=6.6E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
