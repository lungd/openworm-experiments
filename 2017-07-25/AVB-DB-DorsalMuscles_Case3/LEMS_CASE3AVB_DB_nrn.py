...
Components:
    ...
    AVBL_to_DB6_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.12475225851E-12 (SI conductance) sigma=540.309304721 (SI per_voltage) mu=-0.0262192802886 (SI voltage))
    AVBL_to_DB7_elec_syn_13conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.9109395875400004E-10 (SI conductance) sigma=733.655913612 (SI per_voltage) mu=-0.0642515469934 (SI voltage))
    ...
    AVBR_to_DB6_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=3.74313000423E-11 (SI conductance) sigma=128.433033088 (SI per_voltage) mu=-0.00518875443492 (SI voltage))
    AVBR_to_DB7_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=7.74182495472E-12 (SI conductance) sigma=386.916730813 (SI per_voltage) mu=8.969391093450001E-5 (SI voltage))
    DB1_to_AVBR_elec_syn_15conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=8.860205785170001E-10 (SI conductance) sigma=900.0 (SI per_voltage) mu=-0.0650201808539 (SI voltage))
    DB1_to_DB2_elec_syn_5conns (Type: gapJunction:  conductance=1.8262076585E-11 (SI conductance))
    DB2_to_AVBL_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.4138947378E-10 (SI conductance) sigma=728.4458882419999 (SI per_voltage) mu=-0.0704530293802 (SI voltage))
    DB2_to_AVBR_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.2842431437400002E-10 (SI conductance) sigma=359.36909000099996 (SI per_voltage) mu=-0.052385364802 (SI voltage))
    DB2_to_DB1_elec_syn_5conns (Type: gapJunction:  conductance=7.239276380400001E-11 (SI conductance))
    DB2_to_DB3_elec_syn_14conns (Type: gapJunction:  conductance=2.7999999999999997E-13 (SI conductance))
    DB3_to_AVBL_elec_syn_9conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=4.33747744316E-10 (SI conductance) sigma=432.595228808 (SI per_voltage) mu=-0.0593532406385 (SI voltage))
    DB3_to_AVBR_elec_syn_2conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=1.2527912773099999E-12 (SI conductance) sigma=73.4442903966 (SI per_voltage) mu=-0.0243835271055 (SI voltage))
    DB3_to_DB2_elec_syn_14conns (Type: gapJunction:  conductance=4.5368446432E-10 (SI conductance))
    DB3_to_DB4_elec_syn_1conns (Type: gapJunction:  conductance=1.2313305082200001E-11 (SI conductance))
    DB4_to_AVBL_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=8.760034450440001E-11 (SI conductance) sigma=313.62780659400005 (SI per_voltage) mu=-0.052771417774200004 (SI voltage))
    DB4_to_AVBR_elec_syn_5conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=6.628889598E-12 (SI conductance) sigma=20.1041478559 (SI per_voltage) mu=-0.0158045154593 (SI voltage))
    DB4_to_DB3_elec_syn_1conns (Type: gapJunction:  conductance=1.06306786191E-11 (SI conductance))
    DB4_to_DB5_elec_syn_5conns (Type: gapJunction:  conductance=1.0000000000000002E-13 (SI conductance))
    DB5_to_AVBL_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=5.955202106670001E-11 (SI conductance) sigma=615.7151722579999 (SI per_voltage) mu=-0.0319856684989 (SI voltage))
    DB5_to_AVBR_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.0658723137200004E-11 (SI conductance) sigma=658.583427411 (SI per_voltage) mu=-0.0601309694108 (SI voltage))
    DB5_to_DB4_elec_syn_5conns (Type: gapJunction:  conductance=2.0375089517800001E-10 (SI conductance))
    DB5_to_DB6_elec_syn_5conns (Type: gapJunction:  conductance=2.0565968948100003E-11 (SI conductance))
    DB6_to_AVBL_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=2.13202562348E-12 (SI conductance) sigma=851.692451899 (SI per_voltage) mu=-0.036072209737199996 (SI voltage))
    DB6_to_AVBR_elec_syn_4conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=8.969763331360001E-11 (SI conductance) sigma=316.42838667 (SI per_voltage) mu=0.00565950614683 (SI voltage))
    DB6_to_DB5_elec_syn_5conns (Type: gapJunction:  conductance=8.10751388775E-12 (SI conductance))
    DB6_to_DB7_elec_syn_5conns (Type: gapJunction:  conductance=9.28533304E-11 (SI conductance))
    DB7_to_AVBL_elec_syn_13conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=7.25080894552E-11 (SI conductance) sigma=539.666539475 (SI per_voltage) mu=-0.0588683249668 (SI voltage))
    DB7_to_AVBR_elec_syn_3conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=3.380403294510001E-11 (SI conductance) sigma=405.187611216 (SI per_voltage) mu=-0.038196735332000006 (SI voltage))
    DB7_to_DB6_elec_syn_5conns (Type: gapJunction:  conductance=1.0213037168100002E-10 (SI conductance))
    ...
    DB1_to_MDL06_exc_syn_3conns (Type: gradedSynapse:  conductance=5.01359981133E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB1_to_MDL08_exc_syn_3conns (Type: gradedSynapse:  conductance=5.75500136742E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB1_to_MDL09_exc_syn_6conns (Type: gradedSynapse:  conductance=1.5693111440800002E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB1_to_MDR08_exc_syn_6conns (Type: gradedSynapse:  conductance=5.23818537791E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB1_to_MDR09_exc_syn_2conns (Type: gradedSynapse:  conductance=2.00719415888E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB2_to_MDL09_exc_syn_2conns (Type: gradedSynapse:  conductance=1.74197826284E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB2_to_MDL10_exc_syn_4conns (Type: gradedSynapse:  conductance=5.17168895176E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB2_to_MDR09_exc_syn_1conns (Type: gradedSynapse:  conductance=1.28770661736E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB2_to_MDR10_exc_syn_6conns (Type: gradedSynapse:  conductance=4.840533817900001E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    CASE3AVB_DB (Type: network)
    sim_CASE3AVB_DB (Type: Simulation:  length=1.0 (SI time) step=5.0E-5 (SI time))
...
class NeuronSimulation():
    ...
    def __init__(self, tstop, dt, seed=123456789):
        ...
        '''
        Adding simulation Component(id=sim_CASE3AVB_DB type=Simulation) of network/component: CASE3AVB_DB (Type: network)
        ...
        # ######################   File to save: CASE3AVB_DB.activity.dat (neurons_activity)
        ...
        # ######################   File to save: CASE3AVB_DB.muscles.dat (muscles_v)
        ...
        # ######################   File to save: CASE3AVB_DB.muscles.activity.dat (muscles_activity)
        ...
        # ######################   File to save: CASE3AVB_DB.dat (neurons_v)
    ...
    def save_results(self):
        ...
        f_neurons_activity_f2 = open('CASE3AVB_DB.activity.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE3AVB_DB.activity.dat")
        ...
        f_muscles_v_f2 = open('CASE3AVB_DB.muscles.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE3AVB_DB.muscles.dat")
        ...
        f_muscles_activity_f2 = open('CASE3AVB_DB.muscles.activity.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE3AVB_DB.muscles.activity.dat")
        ...
        f_neurons_v_f2 = open('CASE3AVB_DB.dat', 'w')
        num_points = len(py_v_time)  # Simulation may have been stopped before tstop...
        ...
        print("Saved data to: CASE3AVB_DB.dat")
