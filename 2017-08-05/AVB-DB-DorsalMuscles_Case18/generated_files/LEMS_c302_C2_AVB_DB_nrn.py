...
Components:
    ...
    DB6_to_MDL20_exc_syn_2conns (Type: gradedSynapse:  conductance=2.4600000000000003E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB6_to_MDL21_exc_syn_2conns (Type: gradedSynapse:  conductance=2.5E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB7_to_MDL24_exc_syn_2conns (Type: gradedSynapse:  conductance=4.5600000000000003E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
