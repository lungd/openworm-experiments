...
Components:
    ...
    muscle_to_muscle_elec_syn_15conns (Type: gapJunction:  conductance=1.05E-12 (SI conductance))
    muscle_to_muscle_elec_syn_2conns (Type: gapJunction:  conductance=1.3999999999999998E-13 (SI conductance))
    ...
    DB6_to_MDL21_exc_syn_2conns (Type: gradedSynapse:  conductance=2.44E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB7_to_MDL23_exc_syn_2conns (Type: gradedSynapse:  conductance=4.34E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB7_to_MDL24_exc_syn_2conns (Type: gradedSynapse:  conductance=4.28E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=6.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=6.9 (SI time) amplitude=1.5E-11 (SI current))
    c302_C2_AVB_DB (Type: network)
    sim_c302_C2_AVB_DB (Type: Simulation:  length=7.0 (SI time) step=5.0E-5 (SI time))
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=7000, dt=0.05, seed=123456789)
