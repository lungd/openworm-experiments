...
Components:
    ...
    DB2_to_MDL12_exc_syn_1conns (Type: gradedSynapse:  conductance=3.1230000000000005E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB3_to_MDL14_exc_syn_1conns (Type: gradedSynapse:  conductance=1.445E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB4_to_MDL15_exc_syn_3conns (Type: gradedSynapse:  conductance=2.2860000000000002E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
