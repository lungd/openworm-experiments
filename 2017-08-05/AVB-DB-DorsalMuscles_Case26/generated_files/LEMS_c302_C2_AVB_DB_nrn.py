...
Components:
    ...
    muscle_to_muscle_elec_syn_15conns (Type: gapJunction:  conductance=1.95E-12 (SI conductance))
    muscle_to_muscle_elec_syn_2conns (Type: gapJunction:  conductance=2.6E-13 (SI conductance))
