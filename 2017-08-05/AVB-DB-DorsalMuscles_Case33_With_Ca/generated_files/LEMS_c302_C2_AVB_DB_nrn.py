...
Components:
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=3.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=3.9 (SI time) amplitude=1.5E-11 (SI current))
    c302_C2_AVB_DB (Type: network)
    sim_c302_C2_AVB_DB (Type: Simulation:  length=4.0 (SI time) step=5.0E-5 (SI time))
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=4000, dt=0.05, seed=123456789)
