...
Components:
    ...
    DB2_to_MDL10_exc_syn_4conns (Type: gradedSynapse:  conductance=4.14E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
