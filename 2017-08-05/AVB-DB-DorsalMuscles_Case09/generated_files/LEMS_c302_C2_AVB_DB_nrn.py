...
Components:
    ...
    DB2_to_MDL12_exc_syn_1conns (Type: gradedSynapse:  conductance=3.127E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB3_to_MDL13_exc_syn_3conns (Type: gradedSynapse:  conductance=2.574E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
