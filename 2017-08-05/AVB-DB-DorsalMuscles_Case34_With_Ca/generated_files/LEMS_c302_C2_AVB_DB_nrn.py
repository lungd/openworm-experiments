...
Components:
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=9.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=9.9 (SI time) amplitude=1.5E-11 (SI current))
    c302_C2_AVB_DB (Type: network)
    sim_c302_C2_AVB_DB (Type: Simulation:  length=10.0 (SI time) step=5.0E-5 (SI time))
