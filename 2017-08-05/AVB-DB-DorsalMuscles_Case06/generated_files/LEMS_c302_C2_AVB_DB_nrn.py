...
Components:
    ...
    DB2_to_MDL12_exc_syn_1conns (Type: gradedSynapse:  conductance=3.1430000000000004E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
