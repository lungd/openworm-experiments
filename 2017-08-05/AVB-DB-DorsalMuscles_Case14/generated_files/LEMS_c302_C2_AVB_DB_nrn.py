...
Components:
    ...
    DB4_to_MDL16_exc_syn_3conns (Type: gradedSynapse:  conductance=1.7100000000000003E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB5_to_MDL17_exc_syn_2conns (Type: gradedSynapse:  conductance=2.2000000000000002E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
