...
Components:
    ...
    DB1_to_MDL09_exc_syn_6conns (Type: gradedSynapse:  conductance=2.2800000000000001E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB2_to_MDL10_exc_syn_4conns (Type: gradedSynapse:  conductance=4.2E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB2_to_MDL11_exc_syn_5conns (Type: gradedSynapse:  conductance=3.25E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB2_to_MDL12_exc_syn_1conns (Type: gradedSynapse:  conductance=3.2000000000000003E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
