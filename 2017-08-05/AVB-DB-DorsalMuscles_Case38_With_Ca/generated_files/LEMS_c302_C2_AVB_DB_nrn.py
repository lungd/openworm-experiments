...
Components:
    ...
    null (Type: notes)
    CaPool (Type: fixedFactorConcentrationModel:  restingConc=0.0 (SI concentration) decayConstant=0.2 (SI time) rho=2.38919E-4 (SI rho_factor))
    ...
    muscle_to_muscle_elec_syn_15conns (Type: gapJunction:  conductance=2.25E-12 (SI conductance))
    muscle_to_muscle_elec_syn_2conns (Type: gapJunction:  conductance=3.0E-13 (SI conductance))
