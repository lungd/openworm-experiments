...
Components:
    ...
    DB6_to_MDL21_exc_syn_2conns (Type: gradedSynapse:  conductance=2.52E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB7_to_MDL22_exc_syn_2conns (Type: gradedSynapse:  conductance=4.5000000000000005E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB7_to_MDL23_exc_syn_2conns (Type: gradedSynapse:  conductance=4.46E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB7_to_MDL24_exc_syn_2conns (Type: gradedSynapse:  conductance=4.44E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
