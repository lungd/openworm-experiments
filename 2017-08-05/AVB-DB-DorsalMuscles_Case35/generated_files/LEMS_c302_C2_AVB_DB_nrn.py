...
Components:
    ...
    AVBL_to_DB7_elec_syn_13conns (Type: delayedGapJunction:  weight=1.0 (dimensionless) conductance=3.10939587543E-11 (SI conductance) sigma=533.6559136120001 (SI per_voltage) mu=-0.0442515469934 (SI voltage))
    ...
    muscle_to_muscle_elec_syn_15conns (Type: gapJunction:  conductance=7.5E-13 (SI conductance))
    muscle_to_muscle_elec_syn_2conns (Type: gapJunction:  conductance=1.0000000000000002E-13 (SI conductance))
    ...
    DB1_to_MDL06_exc_syn_3conns (Type: gradedSynapse:  conductance=4.5000000000000005E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB1_to_MDL08_exc_syn_3conns (Type: gradedSynapse:  conductance=4.3500000000000005E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB1_to_MDL09_exc_syn_6conns (Type: gradedSynapse:  conductance=2.22E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB2_to_MDL10_exc_syn_4conns (Type: gradedSynapse:  conductance=4.148E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB2_to_MDL11_exc_syn_5conns (Type: gradedSynapse:  conductance=3.235E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB2_to_MDL12_exc_syn_1conns (Type: gradedSynapse:  conductance=3.115E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB3_to_MDL13_exc_syn_3conns (Type: gradedSynapse:  conductance=2.5950000000000003E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB3_to_MDL14_exc_syn_1conns (Type: gradedSynapse:  conductance=1.443E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB4_to_MDL13_exc_syn_4conns (Type: gradedSynapse:  conductance=1.6000000000000002E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB4_to_MDL14_exc_syn_1conns (Type: gradedSynapse:  conductance=8.000000000000001E-11 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB4_to_MDL15_exc_syn_3conns (Type: gradedSynapse:  conductance=2.256E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB4_to_MDL16_exc_syn_3conns (Type: gradedSynapse:  conductance=1.5E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    DB5_to_MDL16_exc_syn_2conns (Type: gradedSynapse:  conductance=9.0E-11 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB5_to_MDL17_exc_syn_2conns (Type: gradedSynapse:  conductance=2.4E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB5_to_MDL18_exc_syn_2conns (Type: gradedSynapse:  conductance=2.36E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB5_to_MDL19_exc_syn_2conns (Type: gradedSynapse:  conductance=1.0600000000000001E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB6_to_MDL19_exc_syn_2conns (Type: gradedSynapse:  conductance=1.4000000000000003E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB6_to_MDL20_exc_syn_2conns (Type: gradedSynapse:  conductance=2.5E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB6_to_MDL21_exc_syn_2conns (Type: gradedSynapse:  conductance=2.48E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB7_to_MDL22_exc_syn_2conns (Type: gradedSynapse:  conductance=4.4800000000000006E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB7_to_MDL23_exc_syn_2conns (Type: gradedSynapse:  conductance=4.44E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    DB7_to_MDL24_exc_syn_2conns (Type: gradedSynapse:  conductance=4.42E-10 (SI conductance) delta=0.019 (SI voltage) k=1205.0 (SI per_time) Vth=0.027 (SI voltage) erev=0.037 (SI voltage))
    ...
    stim_AVBL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=12.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AVBR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=12.9 (SI time) amplitude=1.5E-11 (SI current))
    c302_C2_AVB_DB (Type: network)
    sim_c302_C2_AVB_DB (Type: Simulation:  length=13.0 (SI time) step=5.0E-5 (SI time))
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=13000, dt=0.05, seed=123456789)
