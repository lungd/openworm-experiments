...
Components:
    ...
    neuron_to_neuron_inh_syn_28conns (Type: gradedSynapse:  conductance=7.0E-8 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_4conns (Type: gradedSynapse:  conductance=1.0E-8 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_3conns (Type: gradedSynapse:  conductance=7.500000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_2conns (Type: gradedSynapse:  conductance=5.0E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_1conns (Type: gradedSynapse:  conductance=2.5E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
