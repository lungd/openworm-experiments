...
Components:
    ...
    stim_AS1_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS2_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS3_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS4_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS5_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS6_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS7_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS8_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS9_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS10_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    stim_AS11_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=7.9 (SI time) amplitude=1.5E-11 (SI current))
    c302_C2_AS_DA_DB (Type: network)
    sim_c302_C2_AS_DA_DB (Type: Simulation:  length=8.0 (SI time) step=5.0E-5 (SI time))
...
if __name__ == '__main__':
    ...
    ns = NeuronSimulation(tstop=8000, dt=0.05, seed=123456789)
