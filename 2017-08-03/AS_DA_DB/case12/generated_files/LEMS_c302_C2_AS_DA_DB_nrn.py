...
Components:
    ...
    neuron_to_neuron_exc_syn_6conns (Type: gradedSynapse:  conductance=7.200000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    neuron_to_neuron_exc_syn_12conns (Type: gradedSynapse:  conductance=1.4400000000000002E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    neuron_to_neuron_exc_syn_5conns (Type: gradedSynapse:  conductance=6.000000000000001E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    ...
    neuron_to_neuron_exc_syn_8conns (Type: gradedSynapse:  conductance=9.6E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_exc_syn_20conns (Type: gradedSynapse:  conductance=2.4000000000000003E-8 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_exc_syn_1conns (Type: gradedSynapse:  conductance=1.2E-9 (SI conductance) delta=0.005 (SI voltage) k=500.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.01 (SI voltage))
    neuron_to_neuron_inh_syn_28conns (Type: gradedSynapse:  conductance=2.52E-8 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_4conns (Type: gradedSynapse:  conductance=3.6000000000000004E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_3conns (Type: gradedSynapse:  conductance=2.7E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_2conns (Type: gradedSynapse:  conductance=1.8000000000000002E-9 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    neuron_to_neuron_inh_syn_1conns (Type: gradedSynapse:  conductance=9.000000000000001E-10 (SI conductance) delta=0.005 (SI voltage) k=15.0 (SI per_time) Vth=0.0 (SI voltage) erev=-0.07 (SI voltage))
    ...
    stim_AVAL_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=1.9000000000000001 (SI time) amplitude=5.0E-12 (SI current))
    stim_AVAR_1 (Type: pulseGenerator:  delay=0.05 (SI time) duration=1.9000000000000001 (SI time) amplitude=5.0E-12 (SI current))
